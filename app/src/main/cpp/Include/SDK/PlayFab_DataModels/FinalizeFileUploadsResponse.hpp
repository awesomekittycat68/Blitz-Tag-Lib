...
namespace PlayFab_DataModels {
    struct FinalizeFileUploadsResponse : ::PlayFab_SharedModels::PlayFabResultCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.DataModels", "FinalizeFileUploadsResponse");
            return clazz;
        }
