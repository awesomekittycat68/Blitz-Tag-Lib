...
namespace Photon_Pun {
    struct PhotonAnimatorView_$$c__DisplayClass19_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("Photon.Pun", "PhotonAnimatorView").GetInnerClass("<>c__DisplayClass19_0");
            return clazz;
        }
