...
namespace BoingKit {
    struct BoingWorkAsynchronous_ReactorJob : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("BoingKit", "BoingWorkAsynchronous").GetInnerClass("ReactorJob");
            return clazz;
        }
        ...
        void* GetEffectors() {
            static BNM::Field<void*> _field = GetClass().GetField(O("Effectors"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
