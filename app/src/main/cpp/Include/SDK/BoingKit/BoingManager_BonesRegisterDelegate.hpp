...
namespace BoingKit {
    struct BoingManager_BonesRegisterDelegate : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("BoingKit", "BoingManager").GetInnerClass("BonesRegisterDelegate");
            return clazz;
        }
