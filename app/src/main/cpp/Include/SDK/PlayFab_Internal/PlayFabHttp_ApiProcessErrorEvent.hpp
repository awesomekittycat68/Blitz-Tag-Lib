...
namespace PlayFab_Internal {
    struct PlayFabHttp_ApiProcessErrorEvent : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.Internal", "PlayFabHttp").GetInnerClass("ApiProcessErrorEvent");
            return clazz;
        }
