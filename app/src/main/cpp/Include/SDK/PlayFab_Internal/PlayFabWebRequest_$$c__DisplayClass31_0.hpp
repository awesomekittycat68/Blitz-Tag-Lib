...
namespace PlayFab_Internal {
    struct PlayFabWebRequest_$$c__DisplayClass31_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.Internal", "PlayFabWebRequest").GetInnerClass("<>c__DisplayClass31_0");
            return clazz;
        }
