...
namespace GorillaTagScripts_UI_ModIO {
    struct CustomMapsRoomMapDisplay_$UpdateRoomMap$d__18 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaTagScripts.UI.ModIO", "CustomMapsRoomMapDisplay").GetInnerClass("<UpdateRoomMap>d__18");
            return clazz;
        }
