...
namespace GorillaNetworking {
    struct CosmeticsController_CosmeticSet_$$c__DisplayClass33_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaNetworking", "CosmeticsController").GetInnerClass("CosmeticSet").GetInnerClass("<>c__DisplayClass33_0");
            return clazz;
        }
