...
namespace GorillaNetworking {
    struct GorillaComputer_$UpdateSession$d__487 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaNetworking", "GorillaComputer").GetInnerClass("<UpdateSession>d__487");
            return clazz;
        }
