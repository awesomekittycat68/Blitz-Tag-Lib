...
namespace GorillaNetworking {
    struct BroadcastMyRoomRequest : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaNetworking", "BroadcastMyRoomRequest");
            return clazz;
        }
        ...
        bool GetSet() {
            static BNM::Field<bool> _field = GetClass().GetField(O("Set"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
