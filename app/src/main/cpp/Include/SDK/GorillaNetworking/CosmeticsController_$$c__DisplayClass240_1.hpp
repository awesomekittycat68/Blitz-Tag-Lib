...
namespace GorillaNetworking {
    struct CosmeticsController_$$c__DisplayClass240_1 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaNetworking", "CosmeticsController").GetInnerClass("<>c__DisplayClass240_1");
            return clazz;
        }
