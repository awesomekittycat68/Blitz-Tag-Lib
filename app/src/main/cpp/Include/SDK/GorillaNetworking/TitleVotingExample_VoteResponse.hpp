...
namespace GorillaNetworking {
    struct TitleVotingExample_VoteResponse : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaNetworking", "TitleVotingExample").GetInnerClass("VoteResponse");
            return clazz;
        }
