...
namespace GorillaNetworking {
    struct CosmeticsController_IAPRequestBody : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaNetworking", "CosmeticsController").GetInnerClass("IAPRequestBody");
            return clazz;
        }
