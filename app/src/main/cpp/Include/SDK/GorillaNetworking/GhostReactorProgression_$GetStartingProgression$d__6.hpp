...
namespace GorillaNetworking {
    struct GhostReactorProgression_$GetStartingProgression$d__6 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaNetworking", "GhostReactorProgression").GetInnerClass("<GetStartingProgression>d__6");
            return clazz;
        }
