...
namespace GorillaNetworking {
    struct TitleVotingExample_FetchPollsRequest : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaNetworking", "TitleVotingExample").GetInnerClass("FetchPollsRequest");
            return clazz;
        }
