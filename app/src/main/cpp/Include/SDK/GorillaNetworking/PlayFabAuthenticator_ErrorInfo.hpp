...
namespace GorillaNetworking {
    struct PlayFabAuthenticator_ErrorInfo : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaNetworking", "PlayFabAuthenticator").GetInnerClass("ErrorInfo");
            return clazz;
        }
