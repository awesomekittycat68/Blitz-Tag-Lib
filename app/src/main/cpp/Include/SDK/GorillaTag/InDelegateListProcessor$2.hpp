...
namespace GorillaTag {
    ...
    struct InDelegateListProcessor$2 : ::GorillaTag::DelegateListProcessorPlusMinus$2<::GorillaTag::InDelegateListProcessor$2<T1, T2>*, ::GorillaTag::InAction$2<T1, T2>*> {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaTag", "InDelegateListProcessor`2");
            return clazz;
        }
