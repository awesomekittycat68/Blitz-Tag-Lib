...
namespace PlayFab_CloudScriptModels {
    ...
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.CloudScriptModels", "MembershipModel");
            return clazz;
        }
        ...
        ::BNM::Structures::Mono::List<::PlayFab_CloudScriptModels::SubscriptionModel*>* GetSubscriptions() {
            static BNM::Field<::BNM::Structures::Mono::List<::PlayFab_CloudScriptModels::SubscriptionModel*>*> _field = GetClass().GetField(O("Subscriptions"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetSubscriptions(::BNM::Structures::Mono::List<::PlayFab_CloudScriptModels::SubscriptionModel*>* value) {
            static BNM::Field<::BNM::Structures::Mono::List<::PlayFab_CloudScriptModels::SubscriptionModel*>*> _field = GetClass().GetField(O("Subscriptions"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
