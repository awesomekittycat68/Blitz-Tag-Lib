...
namespace PlayFab_CloudScriptModels {
    ...
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.CloudScriptModels", "ExecuteCloudScriptResult");
            return clazz;
        }
        ...
        ::PlayFab_CloudScriptModels::ScriptExecutionError* GetError() {
            static BNM::Field<::PlayFab_CloudScriptModels::ScriptExecutionError*> _field = GetClass().GetField(O("Error"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        ::BNM::Structures::Mono::List<::PlayFab_CloudScriptModels::LogStatement*>* GetLogs() {
            static BNM::Field<::BNM::Structures::Mono::List<::PlayFab_CloudScriptModels::LogStatement*>*> _field = GetClass().GetField(O("Logs"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetError(::PlayFab_CloudScriptModels::ScriptExecutionError* value) {
            static BNM::Field<::PlayFab_CloudScriptModels::ScriptExecutionError*> _field = GetClass().GetField(O("Error"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        void SetLogs(::BNM::Structures::Mono::List<::PlayFab_CloudScriptModels::LogStatement*>* value) {
            static BNM::Field<::BNM::Structures::Mono::List<::PlayFab_CloudScriptModels::LogStatement*>*> _field = GetClass().GetField(O("Logs"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
