...
namespace PlayFab_CloudScriptModels {
    struct ExecuteFunctionRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.CloudScriptModels", "ExecuteFunctionRequest");
            return clazz;
        }
