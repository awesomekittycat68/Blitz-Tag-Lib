...
namespace PlayFab_CloudScriptModels {
    struct RegisterQueuedFunctionRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.CloudScriptModels", "RegisterQueuedFunctionRequest");
            return clazz;
        }
