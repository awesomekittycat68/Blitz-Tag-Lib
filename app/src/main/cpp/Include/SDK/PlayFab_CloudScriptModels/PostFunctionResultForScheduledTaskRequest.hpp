...
namespace PlayFab_CloudScriptModels {
    struct PostFunctionResultForScheduledTaskRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.CloudScriptModels", "PostFunctionResultForScheduledTaskRequest");
            return clazz;
        }
        ...
        ::PlayFab_CloudScriptModels::NameIdentifier* GetScheduledTaskId() {
            static BNM::Field<::PlayFab_CloudScriptModels::NameIdentifier*> _field = GetClass().GetField(O("ScheduledTaskId"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetScheduledTaskId(::PlayFab_CloudScriptModels::NameIdentifier* value) {
            static BNM::Field<::PlayFab_CloudScriptModels::NameIdentifier*> _field = GetClass().GetField(O("ScheduledTaskId"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
