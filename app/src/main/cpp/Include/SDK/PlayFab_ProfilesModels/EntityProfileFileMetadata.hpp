...
namespace PlayFab_ProfilesModels {
    struct EntityProfileFileMetadata : ::PlayFab_SharedModels::PlayFabBaseModel {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ProfilesModels", "EntityProfileFileMetadata");
            return clazz;
        }
