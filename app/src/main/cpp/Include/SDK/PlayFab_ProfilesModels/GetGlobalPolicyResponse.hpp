...
namespace PlayFab_ProfilesModels {
    struct GetGlobalPolicyResponse : ::PlayFab_SharedModels::PlayFabResultCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ProfilesModels", "GetGlobalPolicyResponse");
            return clazz;
        }
