...
#include "DeviceEnumeratorBase.hpp"

namespace Photon_Voice {
    struct DeviceEnumeratorNotSupported : ::Photon_Voice::DeviceEnumeratorBase {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("Photon.Voice", "DeviceEnumeratorNotSupported");
            return clazz;
        }
