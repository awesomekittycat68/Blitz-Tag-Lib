...
namespace Photon_Voice {
    template <typename T>
    struct RawCodec_Encoder$1 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("Photon.Voice", "RawCodec").GetInnerClass("Encoder`1");
            return clazz;
        }
        ...
        ::BNM::Structures::Mono::Array<uint8_t>* GetByteBuf() {
            static BNM::Field<::BNM::Structures::Mono::Array<uint8_t>*> _field = GetClass().GetField(O("byteBuf"));
        ...
        void SetByteBuf(::BNM::Structures::Mono::Array<uint8_t>* value) {
            static BNM::Field<::BNM::Structures::Mono::Array<uint8_t>*> _field = GetClass().GetField(O("byteBuf"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
