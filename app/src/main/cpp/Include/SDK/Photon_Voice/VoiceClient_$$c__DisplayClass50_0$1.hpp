...
namespace Photon_Voice {
    template <typename T>
    struct VoiceClient_$$c__DisplayClass50_0$1 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("Photon.Voice", "VoiceClient").GetInnerClass("<>c__DisplayClass50_0`1");
            return clazz;
        }
