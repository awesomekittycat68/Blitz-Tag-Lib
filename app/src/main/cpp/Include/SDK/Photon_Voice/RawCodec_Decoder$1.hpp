...
namespace Photon_Voice {
    template <typename T>
    struct RawCodec_Decoder$1 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("Photon.Voice", "RawCodec").GetInnerClass("Decoder`1");
            return clazz;
        }
        ...
        void Input(::Photon_Voice::FrameBuffer& byteBuf) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("Input"), {"byteBuf"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(&byteBuf);
        }
        void Open(::Photon_Voice::VoiceInfo info) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("Open"), {"info"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(info);
        }
