...
namespace ExitGames_Client_Photon {
    struct SocketUdpAsync : ::ExitGames_Client_Photon::IPhotonSocket {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("ExitGames.Client.Photon", "SocketUdpAsync");
            return clazz;
        }
        ...
        void OnReceive(TP0 ar) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("OnReceive"), {"ar"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(ar);
        }
        ...
        void StartReceive() {
            static BNM::Method<void> _m = GetClass().GetMethod(O("StartReceive"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call();
        }
    };
