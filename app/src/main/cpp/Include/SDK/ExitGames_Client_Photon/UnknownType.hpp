...
namespace ExitGames_Client_Photon {
    struct UnknownType : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("ExitGames.Client.Photon", "UnknownType");
            return clazz;
        }
        ...
        uint8_t GetTypeCode() {
            static BNM::Field<uint8_t> _field = GetClass().GetField(O("TypeCode"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetTypeCode(uint8_t value) {
            static BNM::Field<uint8_t> _field = GetClass().GetField(O("TypeCode"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
