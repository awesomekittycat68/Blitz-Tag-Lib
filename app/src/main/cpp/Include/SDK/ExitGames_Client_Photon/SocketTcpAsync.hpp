...
namespace ExitGames_Client_Photon {
    struct SocketTcpAsync : ::ExitGames_Client_Photon::IPhotonSocket {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("ExitGames.Client.Photon", "SocketTcpAsync");
            return clazz;
        }
        ...
        void ReceiveAsync(::ExitGames_Client_Photon::SocketTcpAsync_ReceiveContext* context) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("ReceiveAsync"), {"context"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(context);
        }
        template <typename TP0 = void*>
        void ReceiveAsync(TP0 ar) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("ReceiveAsync"), {"ar"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(ar);
        }
