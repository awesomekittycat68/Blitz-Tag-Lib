...
namespace Fusion_CodeGen {
    struct ReaderWriter$Fusion_NetworkString$1$Fusion__128$ : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("Fusion.CodeGen", "ReaderWriter@Fusion_NetworkString`1<Fusion__128>");
            return clazz;
        }
