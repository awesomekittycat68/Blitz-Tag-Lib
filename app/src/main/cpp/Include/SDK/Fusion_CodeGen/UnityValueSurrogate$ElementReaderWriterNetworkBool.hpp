...
namespace Fusion_CodeGen {
    struct UnityValueSurrogate$ElementReaderWriterNetworkBool : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("Fusion.CodeGen", "UnityValueSurrogate@ElementReaderWriterNetworkBool");
            return clazz;
        }
