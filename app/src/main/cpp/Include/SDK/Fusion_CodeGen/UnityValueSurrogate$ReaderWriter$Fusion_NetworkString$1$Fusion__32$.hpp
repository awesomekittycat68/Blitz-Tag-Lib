...
namespace Fusion_CodeGen {
    struct UnityValueSurrogate$ReaderWriter$Fusion_NetworkString$1$Fusion__32$ : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("Fusion.CodeGen", "UnityValueSurrogate@ReaderWriter@Fusion_NetworkString`1<Fusion__32>");
            return clazz;
        }
