...
namespace Fusion_CodeGen {
    struct UnityLinkedListSurrogate$ElementReaderWriterInt32 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("Fusion.CodeGen", "UnityLinkedListSurrogate@ElementReaderWriterInt32");
            return clazz;
        }
