...
namespace Fusion_CodeGen {
    struct UnityDictionarySurrogate$ElementReaderWriterInt32$ElementReaderWriterInt32 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("Fusion.CodeGen", "UnityDictionarySurrogate@ElementReaderWriterInt32@ElementReaderWriterInt32");
            return clazz;
        }
