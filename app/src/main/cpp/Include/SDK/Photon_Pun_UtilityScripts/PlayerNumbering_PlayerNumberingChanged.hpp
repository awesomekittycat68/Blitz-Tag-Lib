...
namespace Photon_Pun_UtilityScripts {
    struct PlayerNumbering_PlayerNumberingChanged : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("Photon.Pun.UtilityScripts", "PlayerNumbering").GetInnerClass("PlayerNumberingChanged");
            return clazz;
        }
