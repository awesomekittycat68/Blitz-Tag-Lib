...
namespace Photon_Pun_UtilityScripts {
    struct CountdownTimer_CountdownTimerHasExpired : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("Photon.Pun.UtilityScripts", "CountdownTimer").GetInnerClass("CountdownTimerHasExpired");
            return clazz;
        }
