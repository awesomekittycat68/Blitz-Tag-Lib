...
namespace Oculus_Platform {
    struct ApplicationOptions : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("Oculus.Platform", "ApplicationOptions");
            return clazz;
        }
        ...
        void SetDeeplinkMessage(::BNM::Structures::Mono::String* value) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("SetDeeplinkMessage"), {"value"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(value);
        }
        ...
        void SetRoomId(uint64_t value) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("SetRoomId"), {"value"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(value);
        }
    };
