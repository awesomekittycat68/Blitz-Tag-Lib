...
namespace Oculus_Platform {
    struct MessageWithPartyUnderCurrentParty : ::Oculus_Platform::Message$1<::Oculus_Platform_Models::Party*> {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("Oculus.Platform", "MessageWithPartyUnderCurrentParty");
            return clazz;
        }
