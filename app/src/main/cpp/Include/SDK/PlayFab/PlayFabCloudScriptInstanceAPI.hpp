...
namespace PlayFab {
    struct PlayFabCloudScriptInstanceAPI : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab", "PlayFabCloudScriptInstanceAPI");
            return clazz;
        }
        ...
        template <typename TP3 = void*>
        void ExecuteFunction(::PlayFab_CloudScriptModels::ExecuteFunctionRequest* request, ::BNM::Structures::Mono::Action<::PlayFab_CloudScriptModels::ExecuteFunctionResult*>* resultCallback, ::BNM::Structures::Mono::Action<::PlayFab::PlayFabError*>* errorCallback, TP3 customData, ::BNM::Structures::Mono::Dictionary<::BNM::Structures::Mono::String*, ::BNM::Structures::Mono::String*>* extraHeaders) {
        ...
        template <typename TP3 = void*>
        void PostFunctionResultForEntityTriggeredAction(::PlayFab_CloudScriptModels::PostFunctionResultForEntityTriggeredActionRequest* request, ::BNM::Structures::Mono::Action<::PlayFab_CloudScriptModels::EmptyResult*>* resultCallback, ::BNM::Structures::Mono::Action<::PlayFab::PlayFabError*>* errorCallback, TP3 customData, ::BNM::Structures::Mono::Dictionary<::BNM::Structures::Mono::String*, ::BNM::Structures::Mono::String*>* extraHeaders) {
        ...
        template <typename TP3 = void*>
        void PostFunctionResultForPlayerTriggeredAction(::PlayFab_CloudScriptModels::PostFunctionResultForPlayerTriggeredActionRequest* request, ::BNM::Structures::Mono::Action<::PlayFab_CloudScriptModels::EmptyResult*>* resultCallback, ::BNM::Structures::Mono::Action<::PlayFab::PlayFabError*>* errorCallback, TP3 customData, ::BNM::Structures::Mono::Dictionary<::BNM::Structures::Mono::String*, ::BNM::Structures::Mono::String*>* extraHeaders) {
        ...
        template <typename TP3 = void*>
        void PostFunctionResultForScheduledTask(::PlayFab_CloudScriptModels::PostFunctionResultForScheduledTaskRequest* request, ::BNM::Structures::Mono::Action<::PlayFab_CloudScriptModels::EmptyResult*>* resultCallback, ::BNM::Structures::Mono::Action<::PlayFab::PlayFabError*>* errorCallback, TP3 customData, ::BNM::Structures::Mono::Dictionary<::BNM::Structures::Mono::String*, ::BNM::Structures::Mono::String*>* extraHeaders) {
        ...
        template <typename TP3 = void*>
        void UnregisterFunction(::PlayFab_CloudScriptModels::UnregisterFunctionRequest* request, ::BNM::Structures::Mono::Action<::PlayFab_CloudScriptModels::EmptyResult*>* resultCallback, ::BNM::Structures::Mono::Action<::PlayFab::PlayFabError*>* errorCallback, TP3 customData, ::BNM::Structures::Mono::Dictionary<::BNM::Structures::Mono::String*, ::BNM::Structures::Mono::String*>* extraHeaders) {
