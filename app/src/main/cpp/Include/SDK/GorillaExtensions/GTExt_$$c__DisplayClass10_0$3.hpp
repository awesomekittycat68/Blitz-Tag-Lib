...
namespace GorillaExtensions {
    ...
    struct GTExt_$$c__DisplayClass10_0$3 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaExtensions", "GTExt").GetInnerClass("<>c__DisplayClass10_0`3");
            return clazz;
        }
