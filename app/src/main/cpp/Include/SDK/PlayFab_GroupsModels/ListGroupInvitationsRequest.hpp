...
namespace PlayFab_GroupsModels {
    struct ListGroupInvitationsRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.GroupsModels", "ListGroupInvitationsRequest");
            return clazz;
        }
