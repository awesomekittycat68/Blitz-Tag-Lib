...
namespace Oculus_Platform_Models {
    struct UserCapability : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("Oculus.Platform.Models", "UserCapability");
            return clazz;
        }
        ...
        ::BNM::Structures::Mono::String* GetReasonCode() {
            static BNM::Field<::BNM::Structures::Mono::String*> _field = GetClass().GetField(O("ReasonCode"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
    };
