...
namespace Oculus_Platform_Models {
    struct LeaderboardEntry : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("Oculus.Platform.Models", "LeaderboardEntry");
            return clazz;
        }
        ...
        ::Oculus_Platform_Models::SupplementaryMetric* GetSupplementaryMetric() {
            static BNM::Field<::Oculus_Platform_Models::SupplementaryMetric*> _field = GetClass().GetField(O("SupplementaryMetric"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ::Oculus_Platform_Models::SupplementaryMetric* GetSupplementaryMetricOptional() {
            static BNM::Field<::Oculus_Platform_Models::SupplementaryMetric*> _field = GetClass().GetField(O("SupplementaryMetricOptional"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        void* GetTimestamp() {
