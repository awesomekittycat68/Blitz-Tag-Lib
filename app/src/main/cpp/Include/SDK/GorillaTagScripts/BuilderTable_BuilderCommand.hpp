...
#include "BuilderTable_BuilderCommandType.hpp"

namespace GorillaTagScripts {
    struct BuilderTable_BuilderCommand : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaTagScripts", "BuilderTable").GetInnerClass("BuilderCommand");
            return clazz;
        }
        ...
        int GetAttachPieceId() {
            static BNM::Field<int> _field = GetClass().GetField(O("attachPieceId"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        bool GetCanRollback() {
            static BNM::Field<bool> _field = GetClass().GetField(O("canRollback"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        bool GetIsLeft() {
        ...
        bool GetIsQueued() {
            static BNM::Field<bool> _field = GetClass().GetField(O("isQueued"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        int GetServerTimeStamp() {
            static BNM::Field<int> _field = GetClass().GetField(O("serverTimeStamp"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        ::GorillaTagScripts::BuilderTable_BuilderCommandType GetType_f() {
            static BNM::Field<::GorillaTagScripts::BuilderTable_BuilderCommandType> _field = GetClass().GetField(O("type"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetAttachPieceId(int value) {
            static BNM::Field<int> _field = GetClass().GetField(O("attachPieceId"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        void SetCanRollback(bool value) {
            static BNM::Field<bool> _field = GetClass().GetField(O("canRollback"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        void SetServerTimeStamp(int value) {
            static BNM::Field<int> _field = GetClass().GetField(O("serverTimeStamp"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        void SetType(::GorillaTagScripts::BuilderTable_BuilderCommandType value) {
            static BNM::Field<::GorillaTagScripts::BuilderTable_BuilderCommandType> _field = GetClass().GetField(O("type"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
