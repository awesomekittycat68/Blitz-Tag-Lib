...
namespace GorillaTagScripts {
    struct BuilderPotentialPlacementData : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaTagScripts", "BuilderPotentialPlacementData");
            return clazz;
        }
        ...
        ::GorillaTagScripts::BuilderPotentialPlacement ToPotentialPlacement(::GorillaTagScripts::BuilderTable* table) {
            static BNM::Method<::GorillaTagScripts::BuilderPotentialPlacement> _m = GetClass().GetMethod(O("ToPotentialPlacement"), {"table"});
