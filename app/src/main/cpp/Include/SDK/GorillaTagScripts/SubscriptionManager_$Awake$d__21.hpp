...
namespace GorillaTagScripts {
    struct SubscriptionManager_$Awake$d__21 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaTagScripts", "SubscriptionManager").GetInnerClass("<Awake>d__21");
            return clazz;
        }
