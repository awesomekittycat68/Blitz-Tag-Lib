...
namespace GorillaTagScripts_Builder {
    struct SharedBlocksManager_$WaitForMothership$d__145 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaTagScripts.Builder", "SharedBlocksManager").GetInnerClass("<WaitForMothership>d__145");
            return clazz;
        }
