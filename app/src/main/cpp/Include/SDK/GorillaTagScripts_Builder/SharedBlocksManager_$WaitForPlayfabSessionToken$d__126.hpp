...
namespace GorillaTagScripts_Builder {
    struct SharedBlocksManager_$WaitForPlayfabSessionToken$d__126 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaTagScripts.Builder", "SharedBlocksManager").GetInnerClass("<WaitForPlayfabSessionToken>d__126");
            return clazz;
        }
