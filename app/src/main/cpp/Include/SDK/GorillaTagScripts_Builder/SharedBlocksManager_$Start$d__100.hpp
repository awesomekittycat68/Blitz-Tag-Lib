...
namespace GorillaTagScripts_Builder {
    struct SharedBlocksManager_$Start$d__100 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaTagScripts.Builder", "SharedBlocksManager").GetInnerClass("<Start>d__100");
            return clazz;
        }
