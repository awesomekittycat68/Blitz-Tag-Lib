...
namespace GorillaTagScripts_Builder {
    struct BuilderMovingSnapPiece : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaTagScripts.Builder", "BuilderMovingSnapPiece");
            return clazz;
        }

        static BNM::MonoType* GetType() { return GetClass().GetMonoType(); }

        static constexpr int MAX_MOVING_CHILDREN = 5;
        static constexpr uint8_t MOVING_STATE = 0;
        bool GetActivated() {
            static BNM::Field<bool> _field = GetClass().GetField(O("activated"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        uint8_t GetCurrentPauseNode() {
            static BNM::Field<uint8_t> _field = GetClass().GetField(O("currentPauseNode"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        bool GetMoving() {
            static BNM::Field<bool> _field = GetClass().GetField(O("moving"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ::BNM::Structures::Mono::List<::GorillaTagScripts_Builder::BuilderMovingPart*>* GetMovingParts() {
            static BNM::Field<::BNM::Structures::Mono::List<::GorillaTagScripts_Builder::BuilderMovingPart*>*> _field = GetClass().GetField(O("MovingParts"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        ::GameObject* GetStartMovingFX() {
            static BNM::Field<::GameObject*> _field = GetClass().GetField(O("startMovingFX"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ::GameObject* GetStopMovingFX() {
            static BNM::Field<::GameObject*> _field = GetClass().GetField(O("stopMovingFX"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetCurrentPauseNode(uint8_t value) {
            static BNM::Field<uint8_t> _field = GetClass().GetField(O("currentPauseNode"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        void SetMovingParts(::BNM::Structures::Mono::List<::GorillaTagScripts_Builder::BuilderMovingPart*>* value) {
            static BNM::Field<::BNM::Structures::Mono::List<::GorillaTagScripts_Builder::BuilderMovingPart*>*> _field = GetClass().GetField(O("MovingParts"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        void SetStartMovingFX(::GameObject* value) {
            static BNM::Field<::GameObject*> _field = GetClass().GetField(O("startMovingFX"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        void SetStopMovingFX(::GameObject* value) {
            static BNM::Field<::GameObject*> _field = GetClass().GetField(O("stopMovingFX"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        int GetTimeOffset() {
            static BNM::Method<int> _m = GetClass().GetMethod(O("GetTimeOffset"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call();
        }
        ...
        void UpdateMaster() {
            static BNM::Method<void> _m = GetClass().GetMethod(O("UpdateMaster"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call();
        }
    };
