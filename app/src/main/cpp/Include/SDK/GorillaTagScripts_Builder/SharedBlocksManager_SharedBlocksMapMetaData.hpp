...
namespace GorillaTagScripts_Builder {
    struct SharedBlocksManager_SharedBlocksMapMetaData : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaTagScripts.Builder", "SharedBlocksManager").GetInnerClass("SharedBlocksMapMetaData");
            return clazz;
        }
        ...
        ::BNM::Structures::Mono::String* GetCreatedTime() {
            static BNM::Field<::BNM::Structures::Mono::String*> _field = GetClass().GetField(O("createdTime"));
        ...
        ::BNM::Structures::Mono::String* GetUpdatedTime() {
            static BNM::Field<::BNM::Structures::Mono::String*> _field = GetClass().GetField(O("updatedTime"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        int GetVoteCount() {
            static BNM::Field<int> _field = GetClass().GetField(O("voteCount"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetUpdatedTime(::BNM::Structures::Mono::String* value) {
            static BNM::Field<::BNM::Structures::Mono::String*> _field = GetClass().GetField(O("updatedTime"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
