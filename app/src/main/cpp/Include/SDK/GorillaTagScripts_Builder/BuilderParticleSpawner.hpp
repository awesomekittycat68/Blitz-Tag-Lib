...
namespace GorillaTagScripts_Builder {
    struct BuilderParticleSpawner : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaTagScripts.Builder", "BuilderParticleSpawner");
            return clazz;
        }
        ...
        bool GetSpawnOnEnter() {
            static BNM::Field<bool> _field = GetClass().GetField(O("spawnOnEnter"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        bool GetSpawnOnExit() {
            static BNM::Field<bool> _field = GetClass().GetField(O("spawnOnExit"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ::GorillaTagScripts_Builder::BuilderSmallMonkeTrigger* GetSpawnTrigger() {
            static BNM::Field<::GorillaTagScripts_Builder::BuilderSmallMonkeTrigger*> _field = GetClass().GetField(O("spawnTrigger"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetSpawnOnEnter(bool value) {
            static BNM::Field<bool> _field = GetClass().GetField(O("spawnOnEnter"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        void SetSpawnOnExit(bool value) {
            static BNM::Field<bool> _field = GetClass().GetField(O("spawnOnExit"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        void SetSpawnTrigger(::GorillaTagScripts_Builder::BuilderSmallMonkeTrigger* value) {
            static BNM::Field<::GorillaTagScripts_Builder::BuilderSmallMonkeTrigger*> _field = GetClass().GetField(O("spawnTrigger"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        void TrySpawning() {
            static BNM::Method<void> _m = GetClass().GetMethod(O("TrySpawning"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call();
        }
    };
