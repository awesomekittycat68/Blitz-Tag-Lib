...
namespace GorillaTagScripts_Builder {
    struct SharedBlocksManager_SharedBlocksRequestBase : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaTagScripts.Builder", "SharedBlocksManager").GetInnerClass("SharedBlocksRequestBase");
            return clazz;
        }
