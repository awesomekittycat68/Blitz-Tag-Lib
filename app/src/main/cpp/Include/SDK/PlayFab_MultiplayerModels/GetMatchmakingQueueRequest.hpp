...
namespace PlayFab_MultiplayerModels {
    struct GetMatchmakingQueueRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "GetMatchmakingQueueRequest");
            return clazz;
        }
