...
namespace PlayFab_MultiplayerModels {
    struct GetMatchRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "GetMatchRequest");
            return clazz;
        }
        ...
        bool GetReturnMemberAttributes() {
            static BNM::Field<bool> _field = GetClass().GetField(O("ReturnMemberAttributes"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
