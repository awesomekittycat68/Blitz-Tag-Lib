...
namespace PlayFab_MultiplayerModels {
    struct ListQosServersForTitleResponse : ::PlayFab_SharedModels::PlayFabResultCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "ListQosServersForTitleResponse");
            return clazz;
        }
