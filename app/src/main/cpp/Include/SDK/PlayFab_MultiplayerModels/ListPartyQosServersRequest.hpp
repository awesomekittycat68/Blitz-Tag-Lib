...
namespace PlayFab_MultiplayerModels {
    struct ListPartyQosServersRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "ListPartyQosServersRequest");
            return clazz;
        }
