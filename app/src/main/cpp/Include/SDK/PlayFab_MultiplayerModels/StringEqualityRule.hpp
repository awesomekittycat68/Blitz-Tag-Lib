...
namespace PlayFab_MultiplayerModels {
    struct StringEqualityRule : ::PlayFab_SharedModels::PlayFabBaseModel {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "StringEqualityRule");
            return clazz;
        }
        ...
        ::BNM::Structures::Mono::String* GetDefaultAttributeValue() {
            static BNM::Field<::BNM::Structures::Mono::String*> _field = GetClass().GetField(O("DefaultAttributeValue"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ::PlayFab_MultiplayerModels::StringEqualityRuleExpansion* GetExpansion() {
            static BNM::Field<::PlayFab_MultiplayerModels::StringEqualityRuleExpansion*> _field = GetClass().GetField(O("Expansion"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetDefaultAttributeValue(::BNM::Structures::Mono::String* value) {
            static BNM::Field<::BNM::Structures::Mono::String*> _field = GetClass().GetField(O("DefaultAttributeValue"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        void SetExpansion(::PlayFab_MultiplayerModels::StringEqualityRuleExpansion* value) {
            static BNM::Field<::PlayFab_MultiplayerModels::StringEqualityRuleExpansion*> _field = GetClass().GetField(O("Expansion"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
