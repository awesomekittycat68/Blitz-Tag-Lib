...
namespace PlayFab_MultiplayerModels {
    struct CreateBuildWithCustomContainerRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "CreateBuildWithCustomContainerRequest");
            return clazz;
        }
        ...
        ::PlayFab_MultiplayerModels::ContainerImageReference* GetContainerImageReference() {
            static BNM::Field<::PlayFab_MultiplayerModels::ContainerImageReference*> _field = GetClass().GetField(O("ContainerImageReference"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetContainerImageReference(::PlayFab_MultiplayerModels::ContainerImageReference* value) {
            static BNM::Field<::PlayFab_MultiplayerModels::ContainerImageReference*> _field = GetClass().GetField(O("ContainerImageReference"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
