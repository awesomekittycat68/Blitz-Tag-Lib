...
namespace PlayFab_MultiplayerModels {
    struct GetMatchmakingTicketRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "GetMatchmakingTicketRequest");
            return clazz;
        }
