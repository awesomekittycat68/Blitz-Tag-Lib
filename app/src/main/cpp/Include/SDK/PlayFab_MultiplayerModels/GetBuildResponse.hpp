...
namespace PlayFab_MultiplayerModels {
    struct GetBuildResponse : ::PlayFab_SharedModels::PlayFabResultCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "GetBuildResponse");
            return clazz;
        }
        ...
        ::BNM::Structures::Mono::String* GetBuildStatus() {
            static BNM::Field<::BNM::Structures::Mono::String*> _field = GetClass().GetField(O("BuildStatus"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        ::BNM::Structures::Mono::String* GetContainerRunCommand() {
            static BNM::Field<::BNM::Structures::Mono::String*> _field = GetClass().GetField(O("ContainerRunCommand"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        ::PlayFab_MultiplayerModels::ContainerImageReference* GetCustomGameContainerImage() {
            static BNM::Field<::PlayFab_MultiplayerModels::ContainerImageReference*> _field = GetClass().GetField(O("CustomGameContainerImage"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetBuildStatus(::BNM::Structures::Mono::String* value) {
            static BNM::Field<::BNM::Structures::Mono::String*> _field = GetClass().GetField(O("BuildStatus"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        void SetContainerRunCommand(::BNM::Structures::Mono::String* value) {
            static BNM::Field<::BNM::Structures::Mono::String*> _field = GetClass().GetField(O("ContainerRunCommand"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        void SetCustomGameContainerImage(::PlayFab_MultiplayerModels::ContainerImageReference* value) {
            static BNM::Field<::PlayFab_MultiplayerModels::ContainerImageReference*> _field = GetClass().GetField(O("CustomGameContainerImage"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
