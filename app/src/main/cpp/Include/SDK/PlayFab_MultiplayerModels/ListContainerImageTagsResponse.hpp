...
namespace PlayFab_MultiplayerModels {
    struct ListContainerImageTagsResponse : ::PlayFab_SharedModels::PlayFabResultCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "ListContainerImageTagsResponse");
            return clazz;
        }
