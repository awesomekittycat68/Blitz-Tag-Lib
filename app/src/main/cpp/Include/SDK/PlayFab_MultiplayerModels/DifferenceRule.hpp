...
#include "AttributeMergeFunction.hpp"
#include "AttributeNotSpecifiedBehavior.hpp"
#include "../PlayFab_SharedModels/PlayFabBaseModel.hpp"

namespace PlayFab_MultiplayerModels {
    struct DifferenceRule : ::PlayFab_SharedModels::PlayFabBaseModel {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "DifferenceRule");
            return clazz;
        }
        ...
        ::PlayFab_MultiplayerModels::CustomDifferenceRuleExpansion* GetCustomExpansion() {
            static BNM::Field<::PlayFab_MultiplayerModels::CustomDifferenceRuleExpansion*> _field = GetClass().GetField(O("CustomExpansion"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        void* GetDefaultAttributeValue() {
            static BNM::Field<void*> _field = GetClass().GetField(O("DefaultAttributeValue"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        ::PlayFab_MultiplayerModels::LinearDifferenceRuleExpansion* GetLinearExpansion() {
            static BNM::Field<::PlayFab_MultiplayerModels::LinearDifferenceRuleExpansion*> _field = GetClass().GetField(O("LinearExpansion"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ::PlayFab_MultiplayerModels::AttributeMergeFunction GetMergeFunction() {
            static BNM::Field<::PlayFab_MultiplayerModels::AttributeMergeFunction> _field = GetClass().GetField(O("MergeFunction"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetCustomExpansion(::PlayFab_MultiplayerModels::CustomDifferenceRuleExpansion* value) {
            static BNM::Field<::PlayFab_MultiplayerModels::CustomDifferenceRuleExpansion*> _field = GetClass().GetField(O("CustomExpansion"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        void SetDefaultAttributeValue(void* value) {
            static BNM::Field<void*> _field = GetClass().GetField(O("DefaultAttributeValue"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        void SetLinearExpansion(::PlayFab_MultiplayerModels::LinearDifferenceRuleExpansion* value) {
            static BNM::Field<::PlayFab_MultiplayerModels::LinearDifferenceRuleExpansion*> _field = GetClass().GetField(O("LinearExpansion"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        void SetMergeFunction(::PlayFab_MultiplayerModels::AttributeMergeFunction value) {
            static BNM::Field<::PlayFab_MultiplayerModels::AttributeMergeFunction> _field = GetClass().GetField(O("MergeFunction"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
