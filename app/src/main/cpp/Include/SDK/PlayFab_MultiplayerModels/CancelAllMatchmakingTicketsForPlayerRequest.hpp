...
namespace PlayFab_MultiplayerModels {
    struct CancelAllMatchmakingTicketsForPlayerRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "CancelAllMatchmakingTicketsForPlayerRequest");
            return clazz;
        }
