...
namespace PlayFab_MultiplayerModels {
    struct CancelMatchmakingTicketRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "CancelMatchmakingTicketRequest");
            return clazz;
        }
