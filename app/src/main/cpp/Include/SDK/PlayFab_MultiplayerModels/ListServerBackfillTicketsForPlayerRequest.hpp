...
namespace PlayFab_MultiplayerModels {
    struct ListServerBackfillTicketsForPlayerRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "ListServerBackfillTicketsForPlayerRequest");
            return clazz;
        }
