...
namespace PlayFab_MultiplayerModels {
    struct CreateMatchmakingTicketResult : ::PlayFab_SharedModels::PlayFabResultCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "CreateMatchmakingTicketResult");
            return clazz;
        }
