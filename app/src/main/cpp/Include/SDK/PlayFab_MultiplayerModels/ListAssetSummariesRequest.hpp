...
namespace PlayFab_MultiplayerModels {
    struct ListAssetSummariesRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "ListAssetSummariesRequest");
            return clazz;
        }
