...
namespace PlayFab_MultiplayerModels {
    struct MatchmakingPlayerWithTeamAssignment : ::PlayFab_SharedModels::PlayFabBaseModel {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "MatchmakingPlayerWithTeamAssignment");
            return clazz;
        }
        ...
        ::BNM::Structures::Mono::String* GetTeamId() {
            static BNM::Field<::BNM::Structures::Mono::String*> _field = GetClass().GetField(O("TeamId"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetTeamId(::BNM::Structures::Mono::String* value) {
            static BNM::Field<::BNM::Structures::Mono::String*> _field = GetClass().GetField(O("TeamId"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
