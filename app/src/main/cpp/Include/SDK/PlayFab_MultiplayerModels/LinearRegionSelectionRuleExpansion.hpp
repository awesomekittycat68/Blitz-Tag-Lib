...
namespace PlayFab_MultiplayerModels {
    struct LinearRegionSelectionRuleExpansion : ::PlayFab_SharedModels::PlayFabBaseModel {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "LinearRegionSelectionRuleExpansion");
            return clazz;
        }
        ...
        uint32_t GetLimit() {
            static BNM::Field<uint32_t> _field = GetClass().GetField(O("Limit"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
