...
namespace PlayFab_MultiplayerModels {
    struct ShutdownMultiplayerServerRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "ShutdownMultiplayerServerRequest");
            return clazz;
        }
