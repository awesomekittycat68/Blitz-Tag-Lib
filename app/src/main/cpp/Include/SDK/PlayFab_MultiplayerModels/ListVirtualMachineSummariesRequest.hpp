...
namespace PlayFab_MultiplayerModels {
    struct ListVirtualMachineSummariesRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "ListVirtualMachineSummariesRequest");
            return clazz;
        }
