...
namespace PlayFab_MultiplayerModels {
    struct GetMultiplayerSessionLogsBySessionIdRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "GetMultiplayerSessionLogsBySessionIdRequest");
            return clazz;
        }
