...
namespace PlayFab_MultiplayerModels {
    struct CancelAllServerBackfillTicketsForPlayerRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "CancelAllServerBackfillTicketsForPlayerRequest");
            return clazz;
        }
