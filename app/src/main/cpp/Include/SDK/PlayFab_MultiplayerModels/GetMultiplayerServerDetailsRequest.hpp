...
namespace PlayFab_MultiplayerModels {
    struct GetMultiplayerServerDetailsRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "GetMultiplayerServerDetailsRequest");
            return clazz;
        }
