...
namespace PlayFab_MultiplayerModels {
    struct TeamTicketSizeSimilarityRule : ::PlayFab_SharedModels::PlayFabBaseModel {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "TeamTicketSizeSimilarityRule");
            return clazz;
        }
