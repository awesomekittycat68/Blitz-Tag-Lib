...
namespace PlayFab_MultiplayerModels {
    struct LinearDifferenceRuleExpansion : ::PlayFab_SharedModels::PlayFabBaseModel {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "LinearDifferenceRuleExpansion");
            return clazz;
        }
        ...
        double GetDelta() {
            static BNM::Field<double> _field = GetClass().GetField(O("Delta"));
