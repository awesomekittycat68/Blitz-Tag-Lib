...
namespace PlayFab_MultiplayerModels {
    struct DeleteRemoteUserRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "DeleteRemoteUserRequest");
            return clazz;
        }
