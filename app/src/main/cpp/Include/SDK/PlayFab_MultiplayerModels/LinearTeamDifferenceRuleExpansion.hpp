...
namespace PlayFab_MultiplayerModels {
    struct LinearTeamDifferenceRuleExpansion : ::PlayFab_SharedModels::PlayFabBaseModel {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "LinearTeamDifferenceRuleExpansion");
            return clazz;
        }
