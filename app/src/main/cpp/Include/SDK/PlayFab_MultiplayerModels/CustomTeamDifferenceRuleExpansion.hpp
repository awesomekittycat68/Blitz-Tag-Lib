...
namespace PlayFab_MultiplayerModels {
    struct CustomTeamDifferenceRuleExpansion : ::PlayFab_SharedModels::PlayFabBaseModel {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "CustomTeamDifferenceRuleExpansion");
            return clazz;
        }
