...
namespace PlayFab_MultiplayerModels {
    struct ListContainerImagesRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "ListContainerImagesRequest");
            return clazz;
        }
