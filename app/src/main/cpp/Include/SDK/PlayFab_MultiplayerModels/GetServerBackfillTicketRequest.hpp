...
namespace PlayFab_MultiplayerModels {
    struct GetServerBackfillTicketRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "GetServerBackfillTicketRequest");
            return clazz;
        }

        static BNM::MonoType* GetType() { return GetClass().GetMonoType(); }

        bool GetEscapeObject() {
            static BNM::Field<bool> _field = GetClass().GetField(O("EscapeObject"));
