...
namespace PlayFab_MultiplayerModels {
    struct CancelServerBackfillTicketRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "CancelServerBackfillTicketRequest");
            return clazz;
        }
