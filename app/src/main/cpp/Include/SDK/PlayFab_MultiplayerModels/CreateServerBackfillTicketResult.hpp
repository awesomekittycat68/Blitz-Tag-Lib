...
namespace PlayFab_MultiplayerModels {
    struct CreateServerBackfillTicketResult : ::PlayFab_SharedModels::PlayFabResultCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "CreateServerBackfillTicketResult");
            return clazz;
        }
