...
namespace PlayFab_MultiplayerModels {
    struct GetRemoteLoginEndpointRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "GetRemoteLoginEndpointRequest");
            return clazz;
        }
