...
namespace PlayFab_MultiplayerModels {
    struct ListPartyQosServersResponse : ::PlayFab_SharedModels::PlayFabResultCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "ListPartyQosServersResponse");
            return clazz;
        }
