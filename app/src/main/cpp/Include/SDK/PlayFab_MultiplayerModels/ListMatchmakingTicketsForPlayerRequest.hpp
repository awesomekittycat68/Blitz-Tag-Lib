...
namespace PlayFab_MultiplayerModels {
    struct ListMatchmakingTicketsForPlayerRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.MultiplayerModels", "ListMatchmakingTicketsForPlayerRequest");
            return clazz;
        }
