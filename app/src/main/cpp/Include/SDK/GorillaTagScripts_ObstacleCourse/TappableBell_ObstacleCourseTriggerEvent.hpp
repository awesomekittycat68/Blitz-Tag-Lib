...
namespace GorillaTagScripts_ObstacleCourse {
    struct TappableBell_ObstacleCourseTriggerEvent : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaTagScripts.ObstacleCourse", "TappableBell").GetInnerClass("ObstacleCourseTriggerEvent");
            return clazz;
        }
