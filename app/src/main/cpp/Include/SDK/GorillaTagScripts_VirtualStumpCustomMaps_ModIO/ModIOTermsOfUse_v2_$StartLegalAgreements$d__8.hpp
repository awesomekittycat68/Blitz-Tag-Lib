...
namespace GorillaTagScripts_VirtualStumpCustomMaps_ModIO {
    struct ModIOTermsOfUse_v2_$StartLegalAgreements$d__8 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaTagScripts.VirtualStumpCustomMaps.ModIO", "ModIOTermsOfUse_v2").GetInnerClass("<StartLegalAgreements>d__8");
            return clazz;
        }
