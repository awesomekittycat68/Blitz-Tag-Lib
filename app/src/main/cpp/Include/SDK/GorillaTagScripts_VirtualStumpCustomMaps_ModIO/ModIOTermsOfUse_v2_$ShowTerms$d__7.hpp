...
namespace GorillaTagScripts_VirtualStumpCustomMaps_ModIO {
    struct ModIOTermsOfUse_v2_$ShowTerms$d__7 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaTagScripts.VirtualStumpCustomMaps.ModIO", "ModIOTermsOfUse_v2").GetInnerClass("<ShowTerms>d__7");
            return clazz;
        }
