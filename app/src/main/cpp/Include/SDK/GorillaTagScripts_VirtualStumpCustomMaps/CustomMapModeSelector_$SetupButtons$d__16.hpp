...
namespace GorillaTagScripts_VirtualStumpCustomMaps {
    struct CustomMapModeSelector_$SetupButtons$d__16 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaTagScripts.VirtualStumpCustomMaps", "CustomMapModeSelector").GetInnerClass("<SetupButtons>d__16");
            return clazz;
        }
