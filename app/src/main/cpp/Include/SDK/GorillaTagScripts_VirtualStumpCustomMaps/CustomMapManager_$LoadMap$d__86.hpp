...
namespace GorillaTagScripts_VirtualStumpCustomMaps {
    struct CustomMapManager_$LoadMap$d__86 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaTagScripts.VirtualStumpCustomMaps", "CustomMapManager").GetInnerClass("<LoadMap>d__86");
            return clazz;
        }
