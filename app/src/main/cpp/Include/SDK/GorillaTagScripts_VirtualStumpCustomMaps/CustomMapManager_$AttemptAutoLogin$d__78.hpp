...
namespace GorillaTagScripts_VirtualStumpCustomMaps {
    struct CustomMapManager_$AttemptAutoLogin$d__78 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaTagScripts.VirtualStumpCustomMaps", "CustomMapManager").GetInnerClass("<AttemptAutoLogin>d__78");
            return clazz;
        }
