...
namespace PlayFab_ExperimentationModels {
    struct CreateExperimentResult : ::PlayFab_SharedModels::PlayFabResultCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ExperimentationModels", "CreateExperimentResult");
            return clazz;
        }
