...
namespace GorillaTag_GuidedRefs {
    struct GuidedRefTargetMonoComponent : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaTag.GuidedRefs", "GuidedRefTargetMonoComponent");
            return clazz;
        }
        ...
        ::Component* GetTargetComponent() {
            static BNM::Field<::Component*> _field = GetClass().GetField(O("targetComponent"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
