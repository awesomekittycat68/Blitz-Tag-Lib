...
#include "../GlobalNamespace/HandEffectsOverrideCosmetic_HandEffectType.hpp"
#include "IHandEffectsTrigger_Mode.hpp"
#include "TagEffectsLibrary_EffectType.hpp"

namespace TagEffects {
    struct HandEffectsTrigger : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("TagEffects", "HandEffectsTrigger");
            return clazz;
        }
        ...
        ::BNM::Structures::Mono::Array<::GameObject*>* GetDebugVisuals() {
            static BNM::Field<::BNM::Structures::Mono::Array<::GameObject*>*> _field = GetClass().GetField(O("debugVisuals"));
        ...
        static ::BNM::Structures::Mono::Array<::GlobalNamespace::HandEffectsOverrideCosmetic_HandEffectType>* GetMappingArray() {
            static BNM::Field<::BNM::Structures::Mono::Array<::GlobalNamespace::HandEffectsOverrideCosmetic_HandEffectType>*> _field = GetClass().GetField(O("mappingArray"));
            return _field.Get();
        }
        ...
        bool GetRightHand() {
            static BNM::Field<bool> _field = GetClass().GetField(O("rightHand"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetDebugVisuals(::BNM::Structures::Mono::Array<::GameObject*>* value) {
            static BNM::Field<::BNM::Structures::Mono::Array<::GameObject*>*> _field = GetClass().GetField(O("debugVisuals"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        static void SetMappingArray(::BNM::Structures::Mono::Array<::GlobalNamespace::HandEffectsOverrideCosmetic_HandEffectType>* value) {
            static BNM::Field<::BNM::Structures::Mono::Array<::GlobalNamespace::HandEffectsOverrideCosmetic_HandEffectType>*> _field = GetClass().GetField(O("mappingArray"));
            _field.Set(value);
        }
        ...
        ::GlobalNamespace::HandEffectsOverrideCosmetic_HandEffectType MapEnum(::TagEffects::TagEffectsLibrary_EffectType oldEnum) {
            static BNM::Method<::GlobalNamespace::HandEffectsOverrideCosmetic_HandEffectType> _m = GetClass().GetMethod(O("MapEnum"), {"oldEnum"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call(oldEnum);
        }
        void OnDisable() {
        ...
        void PlayHandEffects(::TagEffects::TagEffectsLibrary_EffectType effectType, TP1 other) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("PlayHandEffects"), {"effectType", "other"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(effectType, other);
        }
