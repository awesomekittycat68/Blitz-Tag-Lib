...
namespace GorillaTagScripts_GhostReactor {
    struct GRKiosk_$Start$d__16 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GorillaTagScripts.GhostReactor", "GRKiosk").GetInnerClass("<Start>d__16");
            return clazz;
        }
