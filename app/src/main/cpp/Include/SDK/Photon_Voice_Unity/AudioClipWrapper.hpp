...
namespace Photon_Voice_Unity {
    struct AudioClipWrapper : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("Photon.Voice.Unity", "AudioClipWrapper");
            return clazz;
        }
        ...
        bool GetPlaying() {
            static BNM::Field<bool> _field = GetClass().GetField(O("playing"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        int GetReadPos() {
            static BNM::Field<int> _field = GetClass().GetField(O("readPos"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        float GetStartTime() {
