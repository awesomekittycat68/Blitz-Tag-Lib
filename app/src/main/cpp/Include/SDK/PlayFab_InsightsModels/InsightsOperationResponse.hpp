...
namespace PlayFab_InsightsModels {
    struct InsightsOperationResponse : ::PlayFab_SharedModels::PlayFabResultCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.InsightsModels", "InsightsOperationResponse");
            return clazz;
        }
