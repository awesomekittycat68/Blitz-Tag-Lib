...
namespace PlayFab_InsightsModels {
    struct InsightsGetPendingOperationsRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.InsightsModels", "InsightsGetPendingOperationsRequest");
            return clazz;
        }
