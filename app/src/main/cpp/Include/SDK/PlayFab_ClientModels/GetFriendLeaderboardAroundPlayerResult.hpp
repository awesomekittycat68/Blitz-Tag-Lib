...
namespace PlayFab_ClientModels {
    struct GetFriendLeaderboardAroundPlayerResult : ::PlayFab_SharedModels::PlayFabResultCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ClientModels", "GetFriendLeaderboardAroundPlayerResult");
            return clazz;
        }
