...
namespace PlayFab_ClientModels {
    struct GetSharedGroupDataRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ClientModels", "GetSharedGroupDataRequest");
            return clazz;
        }
        ...
        void* GetGetMembers() {
            static BNM::Field<void*> _field = GetClass().GetField(O("GetMembers"));
