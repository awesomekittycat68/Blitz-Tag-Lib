...
namespace PlayFab_ClientModels {
    struct GetPlayerStatisticVersionsRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ClientModels", "GetPlayerStatisticVersionsRequest");
            return clazz;
        }
