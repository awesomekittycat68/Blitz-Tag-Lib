...
namespace PlayFab_ClientModels {
    struct GetPlayerCombinedInfoResult : ::PlayFab_SharedModels::PlayFabResultCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ClientModels", "GetPlayerCombinedInfoResult");
            return clazz;
        }
