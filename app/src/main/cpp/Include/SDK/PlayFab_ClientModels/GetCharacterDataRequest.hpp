...
namespace PlayFab_ClientModels {
    struct GetCharacterDataRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ClientModels", "GetCharacterDataRequest");
            return clazz;
        }
        ...
        void* GetIfChangedFromDataVersion() {
            static BNM::Field<void*> _field = GetClass().GetField(O("IfChangedFromDataVersion"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetIfChangedFromDataVersion(void* value) {
            static BNM::Field<void*> _field = GetClass().GetField(O("IfChangedFromDataVersion"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
