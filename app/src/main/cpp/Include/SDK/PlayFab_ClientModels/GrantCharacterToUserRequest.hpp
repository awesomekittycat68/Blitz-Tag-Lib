...
namespace PlayFab_ClientModels {
    struct GrantCharacterToUserRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ClientModels", "GrantCharacterToUserRequest");
            return clazz;
        }
