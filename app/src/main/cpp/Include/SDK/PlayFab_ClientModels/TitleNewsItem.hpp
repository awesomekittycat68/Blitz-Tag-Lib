...
namespace PlayFab_ClientModels {
    struct TitleNewsItem : ::PlayFab_SharedModels::PlayFabBaseModel {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ClientModels", "TitleNewsItem");
            return clazz;
        }
        ...
        ::BNM::Structures::Mono::String* GetNewsId() {
            static BNM::Field<::BNM::Structures::Mono::String*> _field = GetClass().GetField(O("NewsId"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        void* GetTimestamp() {
        ...
        void SetNewsId(::BNM::Structures::Mono::String* value) {
            static BNM::Field<::BNM::Structures::Mono::String*> _field = GetClass().GetField(O("NewsId"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
