...
namespace PlayFab_ClientModels {
    struct GetLeaderboardAroundCharacterRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ClientModels", "GetLeaderboardAroundCharacterRequest");
            return clazz;
        }
