...
namespace PlayFab_ClientModels {
    struct ConsumeXboxEntitlementsRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ClientModels", "ConsumeXboxEntitlementsRequest");
            return clazz;
        }
