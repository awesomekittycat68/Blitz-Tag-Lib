...
namespace PlayFab_ClientModels {
    struct SharedGroupDataRecord : ::PlayFab_SharedModels::PlayFabBaseModel {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ClientModels", "SharedGroupDataRecord");
            return clazz;
        }
        ...
        ::BNM::Structures::Mono::String* GetLastUpdatedBy() {
            static BNM::Field<::BNM::Structures::Mono::String*> _field = GetClass().GetField(O("LastUpdatedBy"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        void* GetPermission() {
