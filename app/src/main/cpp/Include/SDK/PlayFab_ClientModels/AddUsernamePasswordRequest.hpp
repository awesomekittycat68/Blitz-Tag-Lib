...
namespace PlayFab_ClientModels {
    struct AddUsernamePasswordRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ClientModels", "AddUsernamePasswordRequest");
            return clazz;
        }
