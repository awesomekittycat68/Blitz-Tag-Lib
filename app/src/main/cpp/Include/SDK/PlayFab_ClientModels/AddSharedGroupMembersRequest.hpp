...
namespace PlayFab_ClientModels {
    struct AddSharedGroupMembersRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ClientModels", "AddSharedGroupMembersRequest");
            return clazz;
        }
