...
namespace PlayFab_ClientModels {
    struct GetCharacterLeaderboardResult : ::PlayFab_SharedModels::PlayFabResultCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ClientModels", "GetCharacterLeaderboardResult");
            return clazz;
        }
