...
namespace PlayFab_ClientModels {
    struct GetLeaderboardForUsersCharactersResult : ::PlayFab_SharedModels::PlayFabResultCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ClientModels", "GetLeaderboardForUsersCharactersResult");
            return clazz;
        }
