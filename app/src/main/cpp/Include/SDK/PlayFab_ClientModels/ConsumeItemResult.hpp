...
namespace PlayFab_ClientModels {
    struct ConsumeItemResult : ::PlayFab_SharedModels::PlayFabResultCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ClientModels", "ConsumeItemResult");
            return clazz;
        }
        ...
        int GetRemainingUses() {
            static BNM::Field<int> _field = GetClass().GetField(O("RemainingUses"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
