...
namespace PlayFab_ClientModels {
    struct UpdateUserTitleDisplayNameRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ClientModels", "UpdateUserTitleDisplayNameRequest");
            return clazz;
        }
