...
namespace PlayFab_ClientModels {
    struct GetCharacterLeaderboardRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ClientModels", "GetCharacterLeaderboardRequest");
            return clazz;
        }
