...
namespace PlayFab_ClientModels {
    struct GetCharacterInventoryResult : ::PlayFab_SharedModels::PlayFabResultCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ClientModels", "GetCharacterInventoryResult");
            return clazz;
        }
