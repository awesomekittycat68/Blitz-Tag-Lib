...
namespace PlayFab_ClientModels {
    struct GetCharacterInventoryRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ClientModels", "GetCharacterInventoryRequest");
            return clazz;
        }
