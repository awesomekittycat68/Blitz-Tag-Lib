...
namespace PlayFab_ClientModels {
    struct RemoveSharedGroupMembersRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ClientModels", "RemoveSharedGroupMembersRequest");
            return clazz;
        }
