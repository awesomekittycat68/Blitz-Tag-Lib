...
namespace PlayFab_ClientModels {
    struct RestoreIOSPurchasesResult : ::PlayFab_SharedModels::PlayFabResultCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ClientModels", "RestoreIOSPurchasesResult");
            return clazz;
        }
