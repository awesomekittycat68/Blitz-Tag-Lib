...
namespace PlayFab_ClientModels {
    struct UpdateCharacterDataRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ClientModels", "UpdateCharacterDataRequest");
            return clazz;
        }
