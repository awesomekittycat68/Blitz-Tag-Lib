...
namespace PlayFab_ClientModels {
    struct StoreMarketingModel : ::PlayFab_SharedModels::PlayFabBaseModel {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ClientModels", "StoreMarketingModel");
            return clazz;
        }
        ...
        void* GetMetadata() {
            static BNM::Field<void*> _field = GetClass().GetField(O("Metadata"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
