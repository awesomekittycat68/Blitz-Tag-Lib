...
namespace PlayFab_ClientModels {
    struct RegisterForIOSPushNotificationRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ClientModels", "RegisterForIOSPushNotificationRequest");
            return clazz;
        }
