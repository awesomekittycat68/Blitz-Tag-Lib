...
namespace PlayFab_ClientModels {
    struct ListUsersCharactersRequest : ::PlayFab_SharedModels::PlayFabRequestCommon {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("PlayFab.ClientModels", "ListUsersCharactersRequest");
            return clazz;
        }
