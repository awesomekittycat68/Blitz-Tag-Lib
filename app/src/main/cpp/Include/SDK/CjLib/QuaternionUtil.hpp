...
namespace CjLib {
    ...
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("CjLib", "QuaternionUtil");
            return clazz;
        }

        static BNM::MonoType* GetType() { return GetClass().GetMonoType(); }

        static ::BNM::Structures::Unity::Quaternion AngularVector(::BNM::Structures::Unity::Vector3 v) {
            static BNM::Method<::BNM::Structures::Unity::Quaternion> _m = GetClass().GetMethod(O("AngularVector"), {"v"});
            return _m.Call(v);
        }
        ...
        static ::BNM::Structures::Unity::Quaternion Sterp(::BNM::Structures::Unity::Quaternion a, ::BNM::Structures::Unity::Quaternion b, ::BNM::Structures::Unity::Vector3 twistAxis, float t, ::CjLib::QuaternionUtil_SterpMode mode) {
        ...
        static ::BNM::Structures::Unity::Quaternion Sterp(::BNM::Structures::Unity::Quaternion a, ::BNM::Structures::Unity::Quaternion b, ::BNM::Structures::Unity::Vector3 twistAxis, float tSwing, float tTwist, ::CjLib::QuaternionUtil_SterpMode mode) {
        ...
        static ::BNM::Structures::Unity::Quaternion Sterp(::BNM::Structures::Unity::Quaternion a, ::BNM::Structures::Unity::Quaternion b, ::BNM::Structures::Unity::Vector3 twistAxis, float t, ::BNM::Structures::Unity::Quaternion& swing, ::BNM::Structures::Unity::Quaternion& twist, ::CjLib::QuaternionUtil_SterpMode mode) {
        ...
        static ::BNM::Structures::Unity::Quaternion Sterp(::BNM::Structures::Unity::Quaternion a, ::BNM::Structures::Unity::Quaternion b, ::BNM::Structures::Unity::Vector3 twistAxis, float tSwing, float tTwist, ::BNM::Structures::Unity::Quaternion& swing, ::BNM::Structures::Unity::Quaternion& twist, ::CjLib::QuaternionUtil_SterpMode mode) {
