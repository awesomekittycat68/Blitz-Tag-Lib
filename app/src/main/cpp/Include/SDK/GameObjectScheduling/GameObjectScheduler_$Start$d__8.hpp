...
namespace GameObjectScheduling {
    struct GameObjectScheduler_$Start$d__8 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("GameObjectScheduling", "GameObjectScheduler").GetInnerClass("<Start>d__8");
            return clazz;
        }
