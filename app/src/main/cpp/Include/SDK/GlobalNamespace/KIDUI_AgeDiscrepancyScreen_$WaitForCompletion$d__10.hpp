...
namespace GlobalNamespace {
    struct KIDUI_AgeDiscrepancyScreen_$WaitForCompletion$d__10 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "KIDUI_AgeDiscrepancyScreen").GetInnerClass("<WaitForCompletion>d__10");
            return clazz;
        }
