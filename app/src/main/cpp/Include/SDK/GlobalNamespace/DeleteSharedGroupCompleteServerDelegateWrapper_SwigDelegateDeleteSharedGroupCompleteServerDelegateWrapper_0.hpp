...
namespace GlobalNamespace {
    struct DeleteSharedGroupCompleteServerDelegateWrapper_SwigDelegateDeleteSharedGroupCompleteServerDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteSharedGroupCompleteServerDelegateWrapper").GetInnerClass("SwigDelegateDeleteSharedGroupCompleteServerDelegateWrapper_0");
            return clazz;
        }
