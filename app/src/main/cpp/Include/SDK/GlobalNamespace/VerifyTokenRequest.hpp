...
namespace GlobalNamespace {
    struct VerifyTokenRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "VerifyTokenRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::VerifyTokenRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::VerifyTokenRequest* obj) {
