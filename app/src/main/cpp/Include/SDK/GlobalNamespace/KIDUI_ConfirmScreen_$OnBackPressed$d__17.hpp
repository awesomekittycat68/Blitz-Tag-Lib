...
namespace GlobalNamespace {
    struct KIDUI_ConfirmScreen_$OnBackPressed$d__17 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "KIDUI_ConfirmScreen").GetInnerClass("<OnBackPressed>d__17");
            return clazz;
        }
