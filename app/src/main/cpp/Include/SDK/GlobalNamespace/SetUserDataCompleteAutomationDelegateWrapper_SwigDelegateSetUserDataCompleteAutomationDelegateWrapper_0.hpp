...
namespace GlobalNamespace {
    struct SetUserDataCompleteAutomationDelegateWrapper_SwigDelegateSetUserDataCompleteAutomationDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "SetUserDataCompleteAutomationDelegateWrapper").GetInnerClass("SwigDelegateSetUserDataCompleteAutomationDelegateWrapper_0");
            return clazz;
        }
