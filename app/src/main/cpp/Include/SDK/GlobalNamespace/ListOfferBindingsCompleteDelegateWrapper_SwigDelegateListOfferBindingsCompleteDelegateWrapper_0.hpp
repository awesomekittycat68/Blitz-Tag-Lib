...
namespace GlobalNamespace {
    struct ListOfferBindingsCompleteDelegateWrapper_SwigDelegateListOfferBindingsCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListOfferBindingsCompleteDelegateWrapper").GetInnerClass("SwigDelegateListOfferBindingsCompleteDelegateWrapper_0");
            return clazz;
        }
