...
namespace GlobalNamespace {
    struct Bindings_QuatFunctions_FromEuler_0000490A$PostfixBurstDelegate : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "Bindings").GetInnerClass("QuatFunctions").GetInnerClass("FromEuler_0000490A$PostfixBurstDelegate");
            return clazz;
        }
