...
namespace GlobalNamespace {
    struct CustomMapsListScreen_$OnGetFeaturedModsTitleData$d__102 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CustomMapsListScreen").GetInnerClass("<OnGetFeaturedModsTitleData>d__102");
            return clazz;
        }
