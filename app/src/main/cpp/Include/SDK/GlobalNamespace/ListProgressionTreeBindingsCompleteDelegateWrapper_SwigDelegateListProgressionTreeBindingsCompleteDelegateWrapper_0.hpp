...
namespace GlobalNamespace {
    struct ListProgressionTreeBindingsCompleteDelegateWrapper_SwigDelegateListProgressionTreeBindingsCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListProgressionTreeBindingsCompleteDelegateWrapper").GetInnerClass("SwigDelegateListProgressionTreeBindingsCompleteDelegateWrapper_0");
            return clazz;
        }
