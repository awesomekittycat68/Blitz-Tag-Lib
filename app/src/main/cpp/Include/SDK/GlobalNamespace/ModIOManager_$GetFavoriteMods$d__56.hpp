...
namespace GlobalNamespace {
    struct ModIOManager_$GetFavoriteMods$d__56 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ModIOManager").GetInnerClass("<GetFavoriteMods>d__56");
            return clazz;
        }
