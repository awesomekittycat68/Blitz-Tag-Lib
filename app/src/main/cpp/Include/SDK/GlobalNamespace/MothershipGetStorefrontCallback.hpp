...
#include "GetStorefrontRequestCompleteDelegateWrapper.hpp"

namespace GlobalNamespace {
    struct MothershipGetStorefrontCallback : ::GlobalNamespace::GetStorefrontRequestCompleteDelegateWrapper {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipGetStorefrontCallback");
            return clazz;
        }
