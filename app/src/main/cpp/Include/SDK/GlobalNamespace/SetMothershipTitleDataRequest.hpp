...
namespace GlobalNamespace {
    struct SetMothershipTitleDataRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "SetMothershipTitleDataRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::SetMothershipTitleDataRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::SetMothershipTitleDataRequest* obj) {
