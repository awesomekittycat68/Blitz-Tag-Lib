...
namespace GlobalNamespace {
    struct ListTransactionCatalogItemsRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListTransactionCatalogItemsRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::ListTransactionCatalogItemsRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::ListTransactionCatalogItemsRequest* obj) {
