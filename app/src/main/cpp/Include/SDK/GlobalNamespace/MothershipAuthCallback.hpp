...
#include "LoginCompleteDelegateWrapper.hpp"

namespace GlobalNamespace {
    struct MothershipAuthCallback : ::GlobalNamespace::LoginCompleteDelegateWrapper {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipAuthCallback");
            return clazz;
        }
