...
namespace GlobalNamespace {
    struct ListAccountAssociationsCompleteDelegateWrapper_SwigDelegateListAccountAssociationsCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListAccountAssociationsCompleteDelegateWrapper").GetInnerClass("SwigDelegateListAccountAssociationsCompleteDelegateWrapper_0");
            return clazz;
        }
