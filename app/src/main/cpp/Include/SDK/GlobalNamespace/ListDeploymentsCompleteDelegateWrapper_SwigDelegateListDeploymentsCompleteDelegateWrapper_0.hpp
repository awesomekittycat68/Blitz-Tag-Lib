...
namespace GlobalNamespace {
    struct ListDeploymentsCompleteDelegateWrapper_SwigDelegateListDeploymentsCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListDeploymentsCompleteDelegateWrapper").GetInnerClass("SwigDelegateListDeploymentsCompleteDelegateWrapper_0");
            return clazz;
        }
