...
namespace GlobalNamespace {
    struct GetReportRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetReportRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::GetReportRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::GetReportRequest* obj) {
