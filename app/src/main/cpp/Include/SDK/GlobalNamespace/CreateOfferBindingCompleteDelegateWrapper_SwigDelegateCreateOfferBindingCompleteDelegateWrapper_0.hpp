...
namespace GlobalNamespace {
    struct CreateOfferBindingCompleteDelegateWrapper_SwigDelegateCreateOfferBindingCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateOfferBindingCompleteDelegateWrapper").GetInnerClass("SwigDelegateCreateOfferBindingCompleteDelegateWrapper_0");
            return clazz;
        }
