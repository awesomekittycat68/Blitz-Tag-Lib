...
namespace GlobalNamespace {
    struct LogInWithInsecure2Request : ::GlobalNamespace::LoginRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "LogInWithInsecure2Request");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::LogInWithInsecure2Request* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::LogInWithInsecure2Request* obj) {
