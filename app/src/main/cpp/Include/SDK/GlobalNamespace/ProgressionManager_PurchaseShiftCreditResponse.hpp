...
namespace GlobalNamespace {
    struct ProgressionManager_PurchaseShiftCreditResponse : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ProgressionManager").GetInnerClass("PurchaseShiftCreditResponse");
            return clazz;
        }
