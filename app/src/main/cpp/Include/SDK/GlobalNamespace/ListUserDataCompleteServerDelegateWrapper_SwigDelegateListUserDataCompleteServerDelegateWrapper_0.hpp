...
namespace GlobalNamespace {
    struct ListUserDataCompleteServerDelegateWrapper_SwigDelegateListUserDataCompleteServerDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListUserDataCompleteServerDelegateWrapper").GetInnerClass("SwigDelegateListUserDataCompleteServerDelegateWrapper_0");
            return clazz;
        }
