...
namespace GlobalNamespace {
    struct GorillaTagger_$IsXRSubsystemActive$d__147 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GorillaTagger").GetInnerClass("<IsXRSubsystemActive>d__147");
            return clazz;
        }
