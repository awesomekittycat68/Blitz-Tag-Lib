...
namespace GlobalNamespace {
    struct MonkeBallBallEjectZone : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MonkeBallBallEjectZone");
            return clazz;
        }
        ...
        float GetEjectVelocity() {
            static BNM::Field<float> _field = GetClass().GetField(O("ejectVelocity"));
        ...
        void SetEjectVelocity(float value) {
            static BNM::Field<float> _field = GetClass().GetField(O("ejectVelocity"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
