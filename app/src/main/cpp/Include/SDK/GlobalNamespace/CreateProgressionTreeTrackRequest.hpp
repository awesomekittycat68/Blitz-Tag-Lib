...
namespace GlobalNamespace {
    struct CreateProgressionTreeTrackRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateProgressionTreeTrackRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::CreateProgressionTreeTrackRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::CreateProgressionTreeTrackRequest* obj) {
