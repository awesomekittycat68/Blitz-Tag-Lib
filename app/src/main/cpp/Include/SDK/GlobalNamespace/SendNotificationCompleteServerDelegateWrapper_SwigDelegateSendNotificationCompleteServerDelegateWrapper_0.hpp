...
namespace GlobalNamespace {
    struct SendNotificationCompleteServerDelegateWrapper_SwigDelegateSendNotificationCompleteServerDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "SendNotificationCompleteServerDelegateWrapper").GetInnerClass("SwigDelegateSendNotificationCompleteServerDelegateWrapper_0");
            return clazz;
        }
