...
namespace GlobalNamespace {
    struct KIDUI_AgeDiscrepancyScreen_$ShowAgeDiscrepancyScreenWithAwait$d__8 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "KIDUI_AgeDiscrepancyScreen").GetInnerClass("<ShowAgeDiscrepancyScreenWithAwait>d__8");
            return clazz;
        }
