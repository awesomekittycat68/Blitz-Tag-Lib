...
namespace GlobalNamespace {
    struct CreateEnvironmentCompleteDelegateWrapper_SwigDelegateCreateEnvironmentCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateEnvironmentCompleteDelegateWrapper").GetInnerClass("SwigDelegateCreateEnvironmentCompleteDelegateWrapper_0");
            return clazz;
        }
