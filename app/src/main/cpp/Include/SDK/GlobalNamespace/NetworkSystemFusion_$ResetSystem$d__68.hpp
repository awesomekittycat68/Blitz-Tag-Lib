...
namespace GlobalNamespace {
    struct NetworkSystemFusion_$ResetSystem$d__68 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "NetworkSystemFusion").GetInnerClass("<ResetSystem>d__68");
            return clazz;
        }
