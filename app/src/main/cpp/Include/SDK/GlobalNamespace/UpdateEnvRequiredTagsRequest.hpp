...
namespace GlobalNamespace {
    struct UpdateEnvRequiredTagsRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateEnvRequiredTagsRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::UpdateEnvRequiredTagsRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::UpdateEnvRequiredTagsRequest* obj) {
