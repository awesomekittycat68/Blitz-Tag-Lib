...
namespace GlobalNamespace {
    struct DeleteTrackLevelCompleteDelegateWrapper_SwigDelegateDeleteTrackLevelCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteTrackLevelCompleteDelegateWrapper").GetInnerClass("SwigDelegateDeleteTrackLevelCompleteDelegateWrapper_0");
            return clazz;
        }
