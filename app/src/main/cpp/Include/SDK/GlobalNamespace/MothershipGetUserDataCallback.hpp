...
#include "GetUserDataCompleteClientDelegateWrapper.hpp"

namespace GlobalNamespace {
    struct MothershipGetUserDataCallback : ::GlobalNamespace::GetUserDataCompleteClientDelegateWrapper {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipGetUserDataCallback");
            return clazz;
        }
