...
namespace GlobalNamespace {
    struct MonkeVoteController_FetchPollsRequest : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MonkeVoteController").GetInnerClass("FetchPollsRequest");
            return clazz;
        }
