...
#include "GREnemyChaser_Behavior.hpp"
#include "GREnemyChaser_BodyState.hpp"

namespace GlobalNamespace {
    struct GREnemyChaser : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GREnemyChaser");
            return clazz;
        }

        static BNM::MonoType* GetType() { return GetClass().GetMonoType(); }

        ::GlobalNamespace::GRAbilityAttackSwipe* GetAbilityAttackSwipe() {
            static BNM::Field<::GlobalNamespace::GRAbilityAttackSwipe*> _field = GetClass().GetField(O("abilityAttackSwipe"));
        ...
        ::GlobalNamespace::SoundBankPlayer* GetChaseSoundBank() {
            static BNM::Field<::GlobalNamespace::SoundBankPlayer*> _field = GetClass().GetField(O("chaseSoundBank"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        ::GlobalNamespace::GREnemyChaser_Behavior GetCurrBehavior() {
            static BNM::Field<::GlobalNamespace::GREnemyChaser_Behavior> _field = GetClass().GetField(O("currBehavior"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ::GlobalNamespace::GREnemyChaser_BodyState GetCurrBodyState() {
            static BNM::Field<::GlobalNamespace::GREnemyChaser_BodyState> _field = GetClass().GetField(O("currBodyState"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetAbilityAttackSwipe(::GlobalNamespace::GRAbilityAttackSwipe* value) {
            static BNM::Field<::GlobalNamespace::GRAbilityAttackSwipe*> _field = GetClass().GetField(O("abilityAttackSwipe"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        void SetChaseSoundBank(::GlobalNamespace::SoundBankPlayer* value) {
            static BNM::Field<::GlobalNamespace::SoundBankPlayer*> _field = GetClass().GetField(O("chaseSoundBank"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        void SetCurrBehavior(::GlobalNamespace::GREnemyChaser_Behavior value) {
            static BNM::Field<::GlobalNamespace::GREnemyChaser_Behavior> _field = GetClass().GetField(O("currBehavior"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        void SetCurrBodyState(::GlobalNamespace::GREnemyChaser_BodyState value) {
            static BNM::Field<::GlobalNamespace::GREnemyChaser_BodyState> _field = GetClass().GetField(O("currBodyState"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        void SetBehavior(::GlobalNamespace::GREnemyChaser_Behavior newBehavior, bool force) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("SetBehavior"), {"newBehavior", "force"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(newBehavior, force);
        }
        void SetBodyState(::GlobalNamespace::GREnemyChaser_BodyState newBodyState, bool force) {
        ...
        void SetNextPatrolNode(int nextPatrolNode) {
        ...
        bool TrySetBehavior(::GlobalNamespace::GREnemyChaser_Behavior newBehavior) {
