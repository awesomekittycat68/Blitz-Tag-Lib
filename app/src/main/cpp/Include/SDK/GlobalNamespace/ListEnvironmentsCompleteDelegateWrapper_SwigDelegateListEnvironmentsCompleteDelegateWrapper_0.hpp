...
namespace GlobalNamespace {
    struct ListEnvironmentsCompleteDelegateWrapper_SwigDelegateListEnvironmentsCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListEnvironmentsCompleteDelegateWrapper").GetInnerClass("SwigDelegateListEnvironmentsCompleteDelegateWrapper_0");
            return clazz;
        }
