...
namespace GlobalNamespace {
    struct KIDAgeAppeal_$OnNewAgeConfirmed$d__6 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "KIDAgeAppeal").GetInnerClass("<OnNewAgeConfirmed>d__6");
            return clazz;
        }
