...
#include "SIGadgetAirGrab_EState.hpp"
#include "SIUpgradeSet.hpp"

namespace GlobalNamespace {
    struct SIGadgetAirGrab : ::GlobalNamespace::SIGadget {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "SIGadgetAirGrab");
            return clazz;
        }

        static BNM::MonoType* GetType() { return GetClass().GetMonoType(); }

        static constexpr const char* preLog = "[SIGadgetAirGrab]  ";
        static constexpr const char* preErr = "[SIGadgetAirGrab]  ERROR!!!  ";
        int GetHandIndex() {
        ...
        ::GlobalNamespace::SIGadgetAirGrab_EState GetState() {
            static BNM::Field<::GlobalNamespace::SIGadgetAirGrab_EState> _field = GetClass().GetField(O("_state"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetState(::GlobalNamespace::SIGadgetAirGrab_EState value) {
            static BNM::Field<::GlobalNamespace::SIGadgetAirGrab_EState> _field = GetClass().GetField(O("_state"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        void _SetStateShared(::GlobalNamespace::SIGadgetAirGrab_EState newState) {
        ...
        void SetStateAuthority(::GlobalNamespace::SIGadgetAirGrab_EState newState) {
