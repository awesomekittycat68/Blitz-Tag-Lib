...
namespace GlobalNamespace {
    struct ProgressionController_GetQuestsStatusRequest : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ProgressionController").GetInnerClass("GetQuestsStatusRequest");
            return clazz;
        }
