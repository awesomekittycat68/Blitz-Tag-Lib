...
namespace GlobalNamespace {
    struct BuilderZoneRenderers : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "BuilderZoneRenderers");
            return clazz;
        }
        ...
        ::BNM::Structures::Mono::List<::Canvas*>* GetCanvases() {
            static BNM::Field<::BNM::Structures::Mono::List<::Canvas*>*> _field = GetClass().GetField(O("canvases"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        ::BNM::Structures::Mono::List<::GameObject*>* GetRootObjects() {
            static BNM::Field<::BNM::Structures::Mono::List<::GameObject*>*> _field = GetClass().GetField(O("rootObjects"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetCanvases(::BNM::Structures::Mono::List<::Canvas*>* value) {
            static BNM::Field<::BNM::Structures::Mono::List<::Canvas*>*> _field = GetClass().GetField(O("canvases"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        void SetRootObjects(::BNM::Structures::Mono::List<::GameObject*>* value) {
            static BNM::Field<::BNM::Structures::Mono::List<::GameObject*>*> _field = GetClass().GetField(O("rootObjects"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
