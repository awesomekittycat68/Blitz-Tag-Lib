...
namespace GlobalNamespace {
    struct ModIOManager_$GetOculusAccessToken$d__86 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ModIOManager").GetInnerClass("<GetOculusAccessToken>d__86");
            return clazz;
        }
