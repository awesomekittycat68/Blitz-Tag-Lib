...
namespace GlobalNamespace {
    struct OfferBinding : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "OfferBinding");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::OfferBinding* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::OfferBinding* obj) {
