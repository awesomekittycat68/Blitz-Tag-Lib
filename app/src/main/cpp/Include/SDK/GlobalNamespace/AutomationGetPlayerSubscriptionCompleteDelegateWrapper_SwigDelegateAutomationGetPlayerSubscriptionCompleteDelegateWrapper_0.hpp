...
namespace GlobalNamespace {
    struct AutomationGetPlayerSubscriptionCompleteDelegateWrapper_SwigDelegateAutomationGetPlayerSubscriptionCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "AutomationGetPlayerSubscriptionCompleteDelegateWrapper").GetInnerClass("SwigDelegateAutomationGetPlayerSubscriptionCompleteDelegateWrapper_0");
            return clazz;
        }
