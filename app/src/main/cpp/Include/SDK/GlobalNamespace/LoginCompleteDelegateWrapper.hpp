...
namespace GlobalNamespace {
    struct LoginCompleteDelegateWrapper : ::GlobalNamespace::MothershipRequestCompleteDelegateWrapper {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "LoginCompleteDelegateWrapper");
            return clazz;
        }

        static BNM::MonoType* GetType() { return GetClass().GetMonoType(); }

        static ::GlobalNamespace::LoginCompleteDelegateWrapper* GetSelfInstance() {
            static BNM::Field<::GlobalNamespace::LoginCompleteDelegateWrapper*> _field = GetClass().GetField(O("selfInstance"));
            return _field.Get();
        }
        void* GetSwigCPtr() {
        ...
        ::GlobalNamespace::LoginCompleteDelegateWrapper_SwigDelegateLoginCompleteDelegateWrapper_0* GetSwigDelegate0() {
            static BNM::Field<::GlobalNamespace::LoginCompleteDelegateWrapper_SwigDelegateLoginCompleteDelegateWrapper_0*> _field = GetClass().GetField(O("swigDelegate0"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        static void SetSelfInstance(::GlobalNamespace::LoginCompleteDelegateWrapper* value) {
            static BNM::Field<::GlobalNamespace::LoginCompleteDelegateWrapper*> _field = GetClass().GetField(O("selfInstance"));
            _field.Set(value);
        }
        ...
        void SetSwigDelegate0(::GlobalNamespace::LoginCompleteDelegateWrapper_SwigDelegateLoginCompleteDelegateWrapper_0* value) {
            static BNM::Field<::GlobalNamespace::LoginCompleteDelegateWrapper_SwigDelegateLoginCompleteDelegateWrapper_0*> _field = GetClass().GetField(O("swigDelegate0"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        static void* getCPtr(::GlobalNamespace::LoginCompleteDelegateWrapper* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::LoginCompleteDelegateWrapper* obj) {
