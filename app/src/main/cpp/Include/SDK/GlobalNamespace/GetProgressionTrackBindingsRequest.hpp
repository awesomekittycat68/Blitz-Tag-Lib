...
namespace GlobalNamespace {
    struct GetProgressionTrackBindingsRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetProgressionTrackBindingsRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::GetProgressionTrackBindingsRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::GetProgressionTrackBindingsRequest* obj) {
