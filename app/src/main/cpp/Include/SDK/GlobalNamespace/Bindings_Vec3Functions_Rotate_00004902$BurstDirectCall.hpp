...
namespace GlobalNamespace {
    struct Bindings_Vec3Functions_Rotate_00004902$BurstDirectCall : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "Bindings").GetInnerClass("Vec3Functions").GetInnerClass("Rotate_00004902$BurstDirectCall");
            return clazz;
        }
