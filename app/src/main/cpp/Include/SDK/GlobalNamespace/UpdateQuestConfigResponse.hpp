...
namespace GlobalNamespace {
    struct UpdateQuestConfigResponse : ::GlobalNamespace::MothershipResponse {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateQuestConfigResponse");
            return clazz;
        }
        ...
        static ::GlobalNamespace::UpdateQuestConfigResponse* FromMothershipResponse(::GlobalNamespace::MothershipResponse* response) {
            static BNM::Method<::GlobalNamespace::UpdateQuestConfigResponse*> _m = GetClass().GetMethod(O("FromMothershipResponse"), {"response"});
        ...
        static void* getCPtr(::GlobalNamespace::UpdateQuestConfigResponse* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::UpdateQuestConfigResponse* obj) {
