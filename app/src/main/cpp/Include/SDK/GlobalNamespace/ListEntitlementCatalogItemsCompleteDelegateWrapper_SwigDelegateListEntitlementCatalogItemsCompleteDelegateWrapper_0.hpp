...
namespace GlobalNamespace {
    struct ListEntitlementCatalogItemsCompleteDelegateWrapper_SwigDelegateListEntitlementCatalogItemsCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListEntitlementCatalogItemsCompleteDelegateWrapper").GetInnerClass("SwigDelegateListEntitlementCatalogItemsCompleteDelegateWrapper_0");
            return clazz;
        }
