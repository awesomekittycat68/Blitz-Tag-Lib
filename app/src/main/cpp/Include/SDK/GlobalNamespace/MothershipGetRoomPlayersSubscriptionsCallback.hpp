...
#include "ClientGetBulkSubscriptionsCompleteDelegateWrapper.hpp"

namespace GlobalNamespace {
    struct MothershipGetRoomPlayersSubscriptionsCallback : ::GlobalNamespace::ClientGetBulkSubscriptionsCompleteDelegateWrapper {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipGetRoomPlayersSubscriptionsCallback");
            return clazz;
        }
