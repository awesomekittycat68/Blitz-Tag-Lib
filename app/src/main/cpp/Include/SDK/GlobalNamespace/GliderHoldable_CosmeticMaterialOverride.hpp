...
namespace GlobalNamespace {
    struct GliderHoldable_CosmeticMaterialOverride : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GliderHoldable").GetInnerClass("CosmeticMaterialOverride");
            return clazz;
        }
