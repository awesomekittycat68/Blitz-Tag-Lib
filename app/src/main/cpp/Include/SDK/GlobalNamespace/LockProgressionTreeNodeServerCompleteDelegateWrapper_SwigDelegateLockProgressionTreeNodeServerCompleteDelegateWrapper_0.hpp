...
namespace GlobalNamespace {
    struct LockProgressionTreeNodeServerCompleteDelegateWrapper_SwigDelegateLockProgressionTreeNodeServerCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "LockProgressionTreeNodeServerCompleteDelegateWrapper").GetInnerClass("SwigDelegateLockProgressionTreeNodeServerCompleteDelegateWrapper_0");
            return clazz;
        }
