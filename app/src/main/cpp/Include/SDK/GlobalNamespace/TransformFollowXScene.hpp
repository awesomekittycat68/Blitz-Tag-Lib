...
namespace GlobalNamespace {
    struct TransformFollowXScene : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "TransformFollowXScene");
            return clazz;
        }
        ...
        ::GlobalNamespace::XSceneRef GetRefToFollow() {
            static BNM::Field<::GlobalNamespace::XSceneRef> _field = GetClass().GetField(O("refToFollow"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetRefToFollow(::GlobalNamespace::XSceneRef value) {
            static BNM::Field<::GlobalNamespace::XSceneRef> _field = GetClass().GetField(O("refToFollow"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
