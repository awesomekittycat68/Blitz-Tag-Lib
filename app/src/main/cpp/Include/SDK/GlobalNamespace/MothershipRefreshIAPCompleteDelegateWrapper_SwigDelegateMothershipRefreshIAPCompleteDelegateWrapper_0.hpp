...
namespace GlobalNamespace {
    struct MothershipRefreshIAPCompleteDelegateWrapper_SwigDelegateMothershipRefreshIAPCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipRefreshIAPCompleteDelegateWrapper").GetInnerClass("SwigDelegateMothershipRefreshIAPCompleteDelegateWrapper_0");
            return clazz;
        }
