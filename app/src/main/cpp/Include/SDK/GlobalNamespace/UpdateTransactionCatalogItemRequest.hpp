...
namespace GlobalNamespace {
    struct UpdateTransactionCatalogItemRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateTransactionCatalogItemRequest");
            return clazz;
        }
        ...
        ::BNM::Structures::Mono::String* GetExternalServiceEntitlementId() {
            static BNM::Method<::BNM::Structures::Mono::String*> _method = GetClass().GetMethod(O("get_externalServiceEntitlementId"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _method.Call();
        }
        void SetExternalServiceEntitlementId(::BNM::Structures::Mono::String* value) {
            static BNM::Method<void> _method = GetClass().GetMethod(O("set_externalServiceEntitlementId"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _method.Call(value);
        }
        ...
        ::GlobalNamespace::StringIntMap* GetInventoryChanges() {
            static BNM::Method<::GlobalNamespace::StringIntMap*> _method = GetClass().GetMethod(O("get_inventoryChanges"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _method.Call();
        }
        void SetInventoryChanges(::GlobalNamespace::StringIntMap* value) {
            static BNM::Method<void> _method = GetClass().GetMethod(O("set_inventoryChanges"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _method.Call(value);
        }
        ...
        ::BNM::Structures::Mono::String* get_externalServiceEntitlementId() {
            static BNM::Method<::BNM::Structures::Mono::String*> _m = GetClass().GetMethod(O("get_externalServiceEntitlementId"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call();
        }
        ...
        ::GlobalNamespace::StringIntMap* get_inventoryChanges() {
            static BNM::Method<::GlobalNamespace::StringIntMap*> _m = GetClass().GetMethod(O("get_inventoryChanges"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call();
        }
        ...
        static void* getCPtr(::GlobalNamespace::UpdateTransactionCatalogItemRequest* obj) {
        ...
        void set_externalServiceEntitlementId(::BNM::Structures::Mono::String* value) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("set_externalServiceEntitlementId"), {"value"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(value);
        }
        ...
        void set_inventoryChanges(::GlobalNamespace::StringIntMap* value) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("set_inventoryChanges"), {"value"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(value);
        }
        ...
        static void* swigRelease(::GlobalNamespace::UpdateTransactionCatalogItemRequest* obj) {
