...
namespace GlobalNamespace {
    struct CreateAccountAssociationDelegateWrapper_SwigDelegateCreateAccountAssociationDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateAccountAssociationDelegateWrapper").GetInnerClass("SwigDelegateCreateAccountAssociationDelegateWrapper_0");
            return clazz;
        }
