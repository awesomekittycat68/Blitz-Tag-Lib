...
namespace GlobalNamespace {
    struct ModIOManager_$GetOculusUserId$d__85 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ModIOManager").GetInnerClass("<GetOculusUserId>d__85");
            return clazz;
        }
