...
namespace GlobalNamespace {
    struct SetMothershipTitleDataCompleteDelegateWrapper_SwigDelegateSetMothershipTitleDataCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "SetMothershipTitleDataCompleteDelegateWrapper").GetInnerClass("SwigDelegateSetMothershipTitleDataCompleteDelegateWrapper_0");
            return clazz;
        }
