...
namespace GlobalNamespace {
    struct UserInventoryMap : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UserInventoryMap");
            return clazz;
        }
        ...
        ::GlobalNamespace::MothershipPlayerInventorySummary* GetItem() {
            static BNM::Method<::GlobalNamespace::MothershipPlayerInventorySummary*> _method = GetClass().GetMethod(O("get_Item"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _method.Call();
        }
        void SetItem(::GlobalNamespace::MothershipPlayerInventorySummary* value) {
        ...
        void Add(::BNM::Structures::Mono::String* key, ::GlobalNamespace::MothershipPlayerInventorySummary* val) {
        ...
        ::GlobalNamespace::MothershipPlayerInventorySummary* get_Item(::BNM::Structures::Mono::String* key) {
            static BNM::Method<::GlobalNamespace::MothershipPlayerInventorySummary*> _m = GetClass().GetMethod(O("get_Item"), {"key"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call(key);
        }
        void* get_Keys() {
        ...
        static void* getCPtr(::GlobalNamespace::UserInventoryMap* obj) {
            static BNM::Method<void*> _m = GetClass().GetMethod(O("getCPtr"), {"obj"});
            return _m.Call(obj);
        }
        ::GlobalNamespace::UserInventoryMap_UserInventoryMapEnumerator* GetEnumerator() {
            static BNM::Method<::GlobalNamespace::UserInventoryMap_UserInventoryMapEnumerator*> _m = GetClass().GetMethod(O("GetEnumerator"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call();
        }
        ::GlobalNamespace::MothershipPlayerInventorySummary* getitem(::BNM::Structures::Mono::String* key) {
            static BNM::Method<::GlobalNamespace::MothershipPlayerInventorySummary*> _m = GetClass().GetMethod(O("getitem"), {"key"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call(key);
        }
        template <typename TP0 = void*>
        ...
        void set_Item(::BNM::Structures::Mono::String* key, ::GlobalNamespace::MothershipPlayerInventorySummary* value) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("set_Item"), {"key", "value"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(key, value);
        }
        void setitem(::BNM::Structures::Mono::String* key, ::GlobalNamespace::MothershipPlayerInventorySummary* x) {
        ...
        static void* swigRelease(::GlobalNamespace::UserInventoryMap* obj) {
            static BNM::Method<void*> _m = GetClass().GetMethod(O("swigRelease"), {"obj"});
            return _m.Call(obj);
        }
        bool TryGetValue(::BNM::Structures::Mono::String* key, ::GlobalNamespace::MothershipPlayerInventorySummary*& value) {
