...
namespace GlobalNamespace {
    struct D20_ShaderManager : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "D20_ShaderManager");
            return clazz;
        }
        ...
        float GetUpdateInterval() {
            static BNM::Field<float> _field = GetClass().GetField(O("updateInterval"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        ::BNM::Coroutine::IEnumerator* UpdateVelocityCoroutine() {
            static BNM::Method<::BNM::Coroutine::IEnumerator*> _m = GetClass().GetMethod(O("UpdateVelocityCoroutine"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call();
        }
    };
