...
namespace GlobalNamespace {
    struct GameBallPlayerLocal_InputDataMotion : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GameBallPlayerLocal").GetInnerClass("InputDataMotion");
            return clazz;
        }
