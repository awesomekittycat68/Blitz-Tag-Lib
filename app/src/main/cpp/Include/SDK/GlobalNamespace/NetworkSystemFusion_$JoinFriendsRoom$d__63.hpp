...
namespace GlobalNamespace {
    struct NetworkSystemFusion_$JoinFriendsRoom$d__63 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "NetworkSystemFusion").GetInnerClass("<JoinFriendsRoom>d__63");
            return clazz;
        }

        static BNM::MonoType* GetType() { return GetClass().GetMonoType(); }

        int GetActorIDToFollow() {
            static BNM::Field<int> _field = GetClass().GetField(O("actorIDToFollow"));
        ...
        ::BNM::Structures::Mono::String* GetShufflerToFollow() {
            static BNM::Field<::BNM::Structures::Mono::String*> _field = GetClass().GetField(O("shufflerToFollow"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetActorIDToFollow(int value) {
            static BNM::Field<int> _field = GetClass().GetField(O("actorIDToFollow"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        void SetShufflerToFollow(::BNM::Structures::Mono::String* value) {
            static BNM::Field<::BNM::Structures::Mono::String*> _field = GetClass().GetField(O("shufflerToFollow"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
