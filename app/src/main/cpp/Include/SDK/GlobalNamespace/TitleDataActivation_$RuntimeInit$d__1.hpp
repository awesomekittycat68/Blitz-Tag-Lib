...
namespace GlobalNamespace {
    struct TitleDataActivation_$RuntimeInit$d__1 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "TitleDataActivation").GetInnerClass("<RuntimeInit>d__1");
            return clazz;
        }
