...
namespace GlobalNamespace {
    struct GREnemyMonkeye_$TryHitPlayer$d__87 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GREnemyMonkeye").GetInnerClass("<TryHitPlayer>d__87");
            return clazz;
        }
