...
namespace GlobalNamespace {
    struct Bindings_QuatFunctions_FromDirection_0000490B$BurstDirectCall : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "Bindings").GetInnerClass("QuatFunctions").GetInnerClass("FromDirection_0000490B$BurstDirectCall");
            return clazz;
        }
