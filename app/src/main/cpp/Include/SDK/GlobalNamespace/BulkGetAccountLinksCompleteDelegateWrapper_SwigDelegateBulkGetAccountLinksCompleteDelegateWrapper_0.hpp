...
namespace GlobalNamespace {
    struct BulkGetAccountLinksCompleteDelegateWrapper_SwigDelegateBulkGetAccountLinksCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "BulkGetAccountLinksCompleteDelegateWrapper").GetInnerClass("SwigDelegateBulkGetAccountLinksCompleteDelegateWrapper_0");
            return clazz;
        }
