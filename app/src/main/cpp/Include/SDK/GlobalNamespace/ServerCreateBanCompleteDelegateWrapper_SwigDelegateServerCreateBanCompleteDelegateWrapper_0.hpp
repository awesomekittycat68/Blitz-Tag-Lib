...
namespace GlobalNamespace {
    struct ServerCreateBanCompleteDelegateWrapper_SwigDelegateServerCreateBanCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ServerCreateBanCompleteDelegateWrapper").GetInnerClass("SwigDelegateServerCreateBanCompleteDelegateWrapper_0");
            return clazz;
        }
