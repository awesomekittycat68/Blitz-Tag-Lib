...
namespace GlobalNamespace {
    struct CreateSharedGroupCompleteClientDelegateWrapper_SwigDelegateCreateSharedGroupCompleteClientDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateSharedGroupCompleteClientDelegateWrapper").GetInnerClass("SwigDelegateCreateSharedGroupCompleteClientDelegateWrapper_0");
            return clazz;
        }
