...
namespace GlobalNamespace {
    struct BetaChecker : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "BetaChecker");
            return clazz;
        }
        ...
        bool GetDoNotEnable() {
            static BNM::Field<bool> _field = GetClass().GetField(O("doNotEnable"));
        ...
        void SetDoNotEnable(bool value) {
            static BNM::Field<bool> _field = GetClass().GetField(O("doNotEnable"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
