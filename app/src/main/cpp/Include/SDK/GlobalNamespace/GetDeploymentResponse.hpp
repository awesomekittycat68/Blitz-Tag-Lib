...
namespace GlobalNamespace {
    struct GetDeploymentResponse : ::GlobalNamespace::MothershipResponse {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetDeploymentResponse");
            return clazz;
        }
        ...
        static ::GlobalNamespace::GetDeploymentResponse* FromMothershipResponse(::GlobalNamespace::MothershipResponse* response) {
            static BNM::Method<::GlobalNamespace::GetDeploymentResponse*> _m = GetClass().GetMethod(O("FromMothershipResponse"), {"response"});
        ...
        static void* getCPtr(::GlobalNamespace::GetDeploymentResponse* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::GetDeploymentResponse* obj) {
