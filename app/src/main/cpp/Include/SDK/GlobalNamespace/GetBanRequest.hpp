...
namespace GlobalNamespace {
    struct GetBanRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetBanRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::GetBanRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::GetBanRequest* obj) {
