...
namespace GlobalNamespace {
    struct UpdateProgressionTrackBindingsRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateProgressionTrackBindingsRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::UpdateProgressionTrackBindingsRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::UpdateProgressionTrackBindingsRequest* obj) {
