...
namespace GlobalNamespace {
    struct OfferDisplay : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "OfferDisplay");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::OfferDisplay* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::OfferDisplay* obj) {
