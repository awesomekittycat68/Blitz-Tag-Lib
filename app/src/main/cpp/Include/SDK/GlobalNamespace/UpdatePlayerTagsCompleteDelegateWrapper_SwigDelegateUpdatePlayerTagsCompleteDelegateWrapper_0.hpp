...
namespace GlobalNamespace {
    struct UpdatePlayerTagsCompleteDelegateWrapper_SwigDelegateUpdatePlayerTagsCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdatePlayerTagsCompleteDelegateWrapper").GetInnerClass("SwigDelegateUpdatePlayerTagsCompleteDelegateWrapper_0");
            return clazz;
        }
