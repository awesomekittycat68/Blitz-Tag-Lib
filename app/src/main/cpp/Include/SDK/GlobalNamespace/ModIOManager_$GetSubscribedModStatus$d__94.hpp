...
namespace GlobalNamespace {
    struct ModIOManager_$GetSubscribedModStatus$d__94 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ModIOManager").GetInnerClass("<GetSubscribedModStatus>d__94");
            return clazz;
        }
