...
namespace GlobalNamespace {
    struct ListOffersDisplayRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListOffersDisplayRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::ListOffersDisplayRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::ListOffersDisplayRequest* obj) {
