...
namespace GlobalNamespace {
    struct KIDManager_$TryVerifyAgeResponse$d__83 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "KIDManager").GetInnerClass("<TryVerifyAgeResponse>d__83");
            return clazz;
        }
