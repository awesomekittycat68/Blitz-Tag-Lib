...
namespace GlobalNamespace {
    struct KIDManager_$Server_GetRequirements$d__139 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "KIDManager").GetInnerClass("<Server_GetRequirements>d__139");
            return clazz;
        }
