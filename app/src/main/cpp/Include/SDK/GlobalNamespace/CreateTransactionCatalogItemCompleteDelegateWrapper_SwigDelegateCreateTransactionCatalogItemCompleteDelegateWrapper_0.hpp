...
namespace GlobalNamespace {
    struct CreateTransactionCatalogItemCompleteDelegateWrapper_SwigDelegateCreateTransactionCatalogItemCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateTransactionCatalogItemCompleteDelegateWrapper").GetInnerClass("SwigDelegateCreateTransactionCatalogItemCompleteDelegateWrapper_0");
            return clazz;
        }
