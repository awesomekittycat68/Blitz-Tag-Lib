...
namespace GlobalNamespace {
    struct ListOfferBindingsRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListOfferBindingsRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::ListOfferBindingsRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::ListOfferBindingsRequest* obj) {
