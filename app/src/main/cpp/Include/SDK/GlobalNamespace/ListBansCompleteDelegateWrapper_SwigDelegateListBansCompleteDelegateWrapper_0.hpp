...
namespace GlobalNamespace {
    struct ListBansCompleteDelegateWrapper_SwigDelegateListBansCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListBansCompleteDelegateWrapper").GetInnerClass("SwigDelegateListBansCompleteDelegateWrapper_0");
            return clazz;
        }
