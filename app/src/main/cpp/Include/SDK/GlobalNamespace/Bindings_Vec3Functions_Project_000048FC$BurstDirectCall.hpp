...
namespace GlobalNamespace {
    struct Bindings_Vec3Functions_Project_000048FC$BurstDirectCall : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "Bindings").GetInnerClass("Vec3Functions").GetInnerClass("Project_000048FC$BurstDirectCall");
            return clazz;
        }
