...
namespace GlobalNamespace {
    struct Bindings_Vec3Functions_Dot_000048FA$BurstDirectCall : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "Bindings").GetInnerClass("Vec3Functions").GetInnerClass("Dot_000048FA$BurstDirectCall");
            return clazz;
        }
