...
namespace GlobalNamespace {
    struct MonkeVoteController_$RequestPolls$d__34 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MonkeVoteController").GetInnerClass("<RequestPolls>d__34");
            return clazz;
        }
