...
namespace GlobalNamespace {
    struct LogInWithGoogleRequest : ::GlobalNamespace::LoginRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "LogInWithGoogleRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::LogInWithGoogleRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::LogInWithGoogleRequest* obj) {
