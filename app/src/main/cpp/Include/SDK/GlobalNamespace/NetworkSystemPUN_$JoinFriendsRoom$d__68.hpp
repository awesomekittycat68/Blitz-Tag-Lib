...
namespace GlobalNamespace {
    struct NetworkSystemPUN_$JoinFriendsRoom$d__68 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "NetworkSystemPUN").GetInnerClass("<JoinFriendsRoom>d__68");
            return clazz;
        }
