...
namespace GlobalNamespace {
    struct GetTransactionCatalogItemCompleteDelegateWrapper_SwigDelegateGetTransactionCatalogItemCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetTransactionCatalogItemCompleteDelegateWrapper").GetInnerClass("SwigDelegateGetTransactionCatalogItemCompleteDelegateWrapper_0");
            return clazz;
        }
