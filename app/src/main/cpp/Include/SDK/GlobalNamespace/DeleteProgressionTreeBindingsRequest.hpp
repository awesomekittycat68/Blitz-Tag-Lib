...
namespace GlobalNamespace {
    struct DeleteProgressionTreeBindingsRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteProgressionTreeBindingsRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::DeleteProgressionTreeBindingsRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::DeleteProgressionTreeBindingsRequest* obj) {
