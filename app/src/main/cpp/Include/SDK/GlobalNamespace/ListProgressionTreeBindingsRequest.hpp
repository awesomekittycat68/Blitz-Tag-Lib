...
namespace GlobalNamespace {
    struct ListProgressionTreeBindingsRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListProgressionTreeBindingsRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::ListProgressionTreeBindingsRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::ListProgressionTreeBindingsRequest* obj) {
