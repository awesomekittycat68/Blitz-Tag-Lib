...
namespace GlobalNamespace {
    struct CreateProgressionTrackBindingsCompleteDelegateWrapper_SwigDelegateCreateProgressionTrackBindingsCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateProgressionTrackBindingsCompleteDelegateWrapper").GetInnerClass("SwigDelegateCreateProgressionTrackBindingsCompleteDelegateWrapper_0");
            return clazz;
        }
