...
namespace GlobalNamespace {
    struct GetUserDataMetadataCompleteDelegateWrapper_SwigDelegateGetUserDataMetadataCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetUserDataMetadataCompleteDelegateWrapper").GetInnerClass("SwigDelegateGetUserDataMetadataCompleteDelegateWrapper_0");
            return clazz;
        }
