...
namespace GlobalNamespace {
    struct ProgressionManager_GhostReactorInventoryResponse : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ProgressionManager").GetInnerClass("GhostReactorInventoryResponse");
            return clazz;
        }
