...
namespace GlobalNamespace {
    struct UnlockProgressionTreeNodeCompleteServerDelegateWrapper_SwigDelegateUnlockProgressionTreeNodeCompleteServerDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UnlockProgressionTreeNodeCompleteServerDelegateWrapper").GetInnerClass("SwigDelegateUnlockProgressionTreeNodeCompleteServerDelegateWrapper_0");
            return clazz;
        }
