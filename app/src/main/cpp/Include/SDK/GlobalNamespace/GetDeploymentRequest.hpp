...
namespace GlobalNamespace {
    struct GetDeploymentRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetDeploymentRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::GetDeploymentRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::GetDeploymentRequest* obj) {
