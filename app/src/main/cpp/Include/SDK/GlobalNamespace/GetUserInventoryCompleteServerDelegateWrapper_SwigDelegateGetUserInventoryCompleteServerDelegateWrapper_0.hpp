...
namespace GlobalNamespace {
    struct GetUserInventoryCompleteServerDelegateWrapper_SwigDelegateGetUserInventoryCompleteServerDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetUserInventoryCompleteServerDelegateWrapper").GetInnerClass("SwigDelegateGetUserInventoryCompleteServerDelegateWrapper_0");
            return clazz;
        }
