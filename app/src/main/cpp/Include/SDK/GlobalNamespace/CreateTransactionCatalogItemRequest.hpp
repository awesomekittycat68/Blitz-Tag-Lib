...
namespace GlobalNamespace {
    struct CreateTransactionCatalogItemRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateTransactionCatalogItemRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::CreateTransactionCatalogItemRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::CreateTransactionCatalogItemRequest* obj) {
