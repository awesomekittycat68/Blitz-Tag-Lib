...
namespace GlobalNamespace {
    struct ListBansRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListBansRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::ListBansRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::ListBansRequest* obj) {
