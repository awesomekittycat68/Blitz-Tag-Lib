...
namespace GlobalNamespace {
    struct ModIOManager_$GetSubscribedMods$d__91 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ModIOManager").GetInnerClass("<GetSubscribedMods>d__91");
            return clazz;
        }
