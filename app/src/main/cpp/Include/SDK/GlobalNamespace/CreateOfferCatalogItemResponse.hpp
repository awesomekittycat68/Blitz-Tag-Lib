...
namespace GlobalNamespace {
    struct CreateOfferCatalogItemResponse : ::GlobalNamespace::MothershipResponse {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateOfferCatalogItemResponse");
            return clazz;
        }
        ...
        static ::GlobalNamespace::CreateOfferCatalogItemResponse* FromMothershipResponse(::GlobalNamespace::MothershipResponse* response) {
            static BNM::Method<::GlobalNamespace::CreateOfferCatalogItemResponse*> _m = GetClass().GetMethod(O("FromMothershipResponse"), {"response"});
        ...
        static void* getCPtr(::GlobalNamespace::CreateOfferCatalogItemResponse* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::CreateOfferCatalogItemResponse* obj) {
