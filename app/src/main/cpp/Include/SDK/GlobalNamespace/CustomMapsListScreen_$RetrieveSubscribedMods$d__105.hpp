...
namespace GlobalNamespace {
    struct CustomMapsListScreen_$RetrieveSubscribedMods$d__105 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CustomMapsListScreen").GetInnerClass("<RetrieveSubscribedMods>d__105");
            return clazz;
        }
