...
namespace GlobalNamespace {
    struct GorillaTriggerColliderHandIndicator : ::GlobalNamespace::MonoBehaviourTick {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GorillaTriggerColliderHandIndicator");
            return clazz;
        }
        ...
        ::GlobalNamespace::GorillaThrowableController* GetThrowableController() {
            static BNM::Field<::GlobalNamespace::GorillaThrowableController*> _field = GetClass().GetField(O("throwableController"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetThrowableController(::GlobalNamespace::GorillaThrowableController* value) {
            static BNM::Field<::GlobalNamespace::GorillaThrowableController*> _field = GetClass().GetField(O("throwableController"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
