...
namespace GlobalNamespace {
    struct Bindings_Vec3Functions_NearlyEqual_00004905$PostfixBurstDelegate : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "Bindings").GetInnerClass("Vec3Functions").GetInnerClass("NearlyEqual_00004905$PostfixBurstDelegate");
            return clazz;
        }
