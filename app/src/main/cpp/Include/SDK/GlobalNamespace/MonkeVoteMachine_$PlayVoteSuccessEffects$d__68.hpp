...
namespace GlobalNamespace {
    struct MonkeVoteMachine_$PlayVoteSuccessEffects$d__68 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MonkeVoteMachine").GetInnerClass("<PlayVoteSuccessEffects>d__68");
            return clazz;
        }
