...
namespace GlobalNamespace {
    struct KIDManager_$SendOptInPermissions$d__111 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "KIDManager").GetInnerClass("<SendOptInPermissions>d__111");
            return clazz;
        }
