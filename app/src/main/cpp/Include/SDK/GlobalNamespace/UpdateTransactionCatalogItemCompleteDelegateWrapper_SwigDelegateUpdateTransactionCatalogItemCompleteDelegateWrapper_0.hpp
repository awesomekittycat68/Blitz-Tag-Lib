...
namespace GlobalNamespace {
    struct UpdateTransactionCatalogItemCompleteDelegateWrapper_SwigDelegateUpdateTransactionCatalogItemCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateTransactionCatalogItemCompleteDelegateWrapper").GetInnerClass("SwigDelegateUpdateTransactionCatalogItemCompleteDelegateWrapper_0");
            return clazz;
        }
