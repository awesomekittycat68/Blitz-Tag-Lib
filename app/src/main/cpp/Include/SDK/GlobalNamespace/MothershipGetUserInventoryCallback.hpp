...
#include "GetUserInventoryCompleteClientDelegateWrapper.hpp"

namespace GlobalNamespace {
    struct MothershipGetUserInventoryCallback : ::GlobalNamespace::GetUserInventoryCompleteClientDelegateWrapper {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipGetUserInventoryCallback");
            return clazz;
        }
