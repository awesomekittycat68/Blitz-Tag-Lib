...
namespace GlobalNamespace {
    struct DeleteUserDataCompleteClientDelegateWrapper_SwigDelegateDeleteUserDataCompleteClientDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteUserDataCompleteClientDelegateWrapper").GetInnerClass("SwigDelegateDeleteUserDataCompleteClientDelegateWrapper_0");
            return clazz;
        }
