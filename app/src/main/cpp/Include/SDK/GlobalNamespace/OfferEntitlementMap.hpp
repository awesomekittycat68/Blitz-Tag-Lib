...
namespace GlobalNamespace {
    struct OfferEntitlementMap : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "OfferEntitlementMap");
            return clazz;
        }
        ...
        ::GlobalNamespace::OfferEntitlementChanges* GetItem() {
            static BNM::Method<::GlobalNamespace::OfferEntitlementChanges*> _method = GetClass().GetMethod(O("get_Item"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _method.Call();
        }
        void SetItem(::GlobalNamespace::OfferEntitlementChanges* value) {
        ...
        void Add(::BNM::Structures::Mono::String* key, ::GlobalNamespace::OfferEntitlementChanges* val) {
        ...
        ::GlobalNamespace::OfferEntitlementChanges* get_Item(::BNM::Structures::Mono::String* key) {
            static BNM::Method<::GlobalNamespace::OfferEntitlementChanges*> _m = GetClass().GetMethod(O("get_Item"), {"key"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call(key);
        }
        void* get_Keys() {
        ...
        static void* getCPtr(::GlobalNamespace::OfferEntitlementMap* obj) {
            static BNM::Method<void*> _m = GetClass().GetMethod(O("getCPtr"), {"obj"});
            return _m.Call(obj);
        }
        ::GlobalNamespace::OfferEntitlementMap_OfferEntitlementMapEnumerator* GetEnumerator() {
            static BNM::Method<::GlobalNamespace::OfferEntitlementMap_OfferEntitlementMapEnumerator*> _m = GetClass().GetMethod(O("GetEnumerator"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call();
        }
        ::GlobalNamespace::OfferEntitlementChanges* getitem(::BNM::Structures::Mono::String* key) {
            static BNM::Method<::GlobalNamespace::OfferEntitlementChanges*> _m = GetClass().GetMethod(O("getitem"), {"key"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call(key);
        }
        template <typename TP0 = void*>
        ...
        void set_Item(::BNM::Structures::Mono::String* key, ::GlobalNamespace::OfferEntitlementChanges* value) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("set_Item"), {"key", "value"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(key, value);
        }
        void setitem(::BNM::Structures::Mono::String* key, ::GlobalNamespace::OfferEntitlementChanges* x) {
        ...
        static void* swigRelease(::GlobalNamespace::OfferEntitlementMap* obj) {
            static BNM::Method<void*> _m = GetClass().GetMethod(O("swigRelease"), {"obj"});
            return _m.Call(obj);
        }
        bool TryGetValue(::BNM::Structures::Mono::String* key, ::GlobalNamespace::OfferEntitlementChanges*& value) {
