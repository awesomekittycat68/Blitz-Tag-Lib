...
namespace GlobalNamespace {
    struct AddPlayerAccountLinkCompleteDelegateWrapper_SwigDelegateAddPlayerAccountLinkCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "AddPlayerAccountLinkCompleteDelegateWrapper").GetInnerClass("SwigDelegateAddPlayerAccountLinkCompleteDelegateWrapper_0");
            return clazz;
        }
