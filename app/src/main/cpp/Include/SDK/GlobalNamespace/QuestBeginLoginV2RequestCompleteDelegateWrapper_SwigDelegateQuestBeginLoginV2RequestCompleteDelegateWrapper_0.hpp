...
namespace GlobalNamespace {
    struct QuestBeginLoginV2RequestCompleteDelegateWrapper_SwigDelegateQuestBeginLoginV2RequestCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "QuestBeginLoginV2RequestCompleteDelegateWrapper").GetInnerClass("SwigDelegateQuestBeginLoginV2RequestCompleteDelegateWrapper_0");
            return clazz;
        }
