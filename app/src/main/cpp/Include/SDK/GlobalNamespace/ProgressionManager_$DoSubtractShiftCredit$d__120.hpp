...
namespace GlobalNamespace {
    struct ProgressionManager_$DoSubtractShiftCredit$d__120 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ProgressionManager").GetInnerClass("<DoSubtractShiftCredit>d__120");
            return clazz;
        }
