...
namespace GlobalNamespace {
    struct Bindings_Vec3Functions_Unm_000048F7$PostfixBurstDelegate : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "Bindings").GetInnerClass("Vec3Functions").GetInnerClass("Unm_000048F7$PostfixBurstDelegate");
            return clazz;
        }
