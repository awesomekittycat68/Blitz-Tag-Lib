...
namespace GlobalNamespace {
    struct AutomationGetSubscriptionsRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "AutomationGetSubscriptionsRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::AutomationGetSubscriptionsRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::AutomationGetSubscriptionsRequest* obj) {
