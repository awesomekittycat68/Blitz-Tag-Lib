...
namespace GlobalNamespace {
    struct WriteEventsCompleteServerDelegateWrapper_SwigDelegateWriteEventsCompleteServerDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "WriteEventsCompleteServerDelegateWrapper").GetInnerClass("SwigDelegateWriteEventsCompleteServerDelegateWrapper_0");
            return clazz;
        }
