...
namespace GlobalNamespace {
    struct ListOfferCatalogItemsCompleteDelegateWrapper_SwigDelegateListOfferCatalogItemsCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListOfferCatalogItemsCompleteDelegateWrapper").GetInnerClass("SwigDelegateListOfferCatalogItemsCompleteDelegateWrapper_0");
            return clazz;
        }
