...
namespace GlobalNamespace {
    struct GetUserDataCompleteServerDelegateWrapper_SwigDelegateGetUserDataCompleteServerDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetUserDataCompleteServerDelegateWrapper").GetInnerClass("SwigDelegateGetUserDataCompleteServerDelegateWrapper_0");
            return clazz;
        }
