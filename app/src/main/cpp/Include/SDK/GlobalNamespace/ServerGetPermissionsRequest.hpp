...
namespace GlobalNamespace {
    struct ServerGetPermissionsRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ServerGetPermissionsRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::ServerGetPermissionsRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::ServerGetPermissionsRequest* obj) {
