...
namespace GlobalNamespace {
    struct IncrementProgressionTrackForPlayerRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "IncrementProgressionTrackForPlayerRequest");
            return clazz;
        }

        static BNM::MonoType* GetType() { return GetClass().GetMonoType(); }

        int GetAdditionalProgress() {
            static BNM::Method<int> _method = GetClass().GetMethod(O("get_AdditionalProgress"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _method.Call();
        }
        void SetAdditionalProgress(int value) {
            static BNM::Method<void> _method = GetClass().GetMethod(O("set_AdditionalProgress"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _method.Call(value);
        }
        ...
        int get_AdditionalProgress() {
            static BNM::Method<int> _m = GetClass().GetMethod(O("get_AdditionalProgress"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call();
        }
        ...
        static void* getCPtr(::GlobalNamespace::IncrementProgressionTrackForPlayerRequest* obj) {
            static BNM::Method<void*> _m = GetClass().GetMethod(O("getCPtr"), {"obj"});
            return _m.Call(obj);
        }
        void set_AdditionalProgress(int value) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("set_AdditionalProgress"), {"value"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(value);
        }
        ...
        static void* swigRelease(::GlobalNamespace::IncrementProgressionTrackForPlayerRequest* obj) {
