...
namespace GlobalNamespace {
    struct CreateReportCompleteDelegateWrapper_SwigDelegateCreateReportCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateReportCompleteDelegateWrapper").GetInnerClass("SwigDelegateCreateReportCompleteDelegateWrapper_0");
            return clazz;
        }
