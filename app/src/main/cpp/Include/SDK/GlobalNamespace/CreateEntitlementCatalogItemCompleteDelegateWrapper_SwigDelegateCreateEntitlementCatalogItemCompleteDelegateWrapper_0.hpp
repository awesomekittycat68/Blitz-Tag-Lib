...
namespace GlobalNamespace {
    struct CreateEntitlementCatalogItemCompleteDelegateWrapper_SwigDelegateCreateEntitlementCatalogItemCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateEntitlementCatalogItemCompleteDelegateWrapper").GetInnerClass("SwigDelegateCreateEntitlementCatalogItemCompleteDelegateWrapper_0");
            return clazz;
        }
