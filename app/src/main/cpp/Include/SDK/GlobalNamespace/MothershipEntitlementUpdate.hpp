...
namespace GlobalNamespace {
    struct MothershipEntitlementUpdate : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipEntitlementUpdate");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::MothershipEntitlementUpdate* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::MothershipEntitlementUpdate* obj) {
