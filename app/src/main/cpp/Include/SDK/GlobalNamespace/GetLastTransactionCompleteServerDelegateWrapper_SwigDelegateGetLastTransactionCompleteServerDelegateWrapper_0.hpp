...
namespace GlobalNamespace {
    struct GetLastTransactionCompleteServerDelegateWrapper_SwigDelegateGetLastTransactionCompleteServerDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetLastTransactionCompleteServerDelegateWrapper").GetInnerClass("SwigDelegateGetLastTransactionCompleteServerDelegateWrapper_0");
            return clazz;
        }
