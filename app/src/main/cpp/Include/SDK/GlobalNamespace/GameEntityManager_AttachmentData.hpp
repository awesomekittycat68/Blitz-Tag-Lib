...
namespace GlobalNamespace {
    struct GameEntityManager_AttachmentData : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GameEntityManager").GetInnerClass("AttachmentData");
            return clazz;
        }

        static BNM::MonoType* GetType() { return GetClass().GetMonoType(); }

        int GetAttachToEntityNetId() {
            static BNM::Field<int> _field = GetClass().GetField(O("attachToEntityNetId"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        int GetEntityNetId() {
            static BNM::Field<int> _field = GetClass().GetField(O("entityNetId"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetAttachToEntityNetId(int value) {
            static BNM::Field<int> _field = GetClass().GetField(O("attachToEntityNetId"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        void SetEntityNetId(int value) {
            static BNM::Field<int> _field = GetClass().GetField(O("entityNetId"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
