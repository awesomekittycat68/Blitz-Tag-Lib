...
namespace GlobalNamespace {
    struct GetProgressionTreeBindingsCompleteDelegateWrapper_SwigDelegateGetProgressionTreeBindingsCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetProgressionTreeBindingsCompleteDelegateWrapper").GetInnerClass("SwigDelegateGetProgressionTreeBindingsCompleteDelegateWrapper_0");
            return clazz;
        }
