...
namespace GlobalNamespace {
    struct ListBansBulkCompleteServerDelegateWrapper_SwigDelegateListBansBulkCompleteServerDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListBansBulkCompleteServerDelegateWrapper").GetInnerClass("SwigDelegateListBansBulkCompleteServerDelegateWrapper_0");
            return clazz;
        }
