...
namespace GlobalNamespace {
    struct AddSharedGroupMembersCompleteClientDelegateWrapper_SwigDelegateAddSharedGroupMembersCompleteClientDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "AddSharedGroupMembersCompleteClientDelegateWrapper").GetInnerClass("SwigDelegateAddSharedGroupMembersCompleteClientDelegateWrapper_0");
            return clazz;
        }
