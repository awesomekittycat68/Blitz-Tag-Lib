...
namespace GlobalNamespace {
    struct KIDUI_MainScreen_$OnAskForPermission$d__52 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "KIDUI_MainScreen").GetInnerClass("<OnAskForPermission>d__52");
            return clazz;
        }
