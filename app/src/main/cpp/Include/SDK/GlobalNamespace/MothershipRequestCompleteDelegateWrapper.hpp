...
namespace GlobalNamespace {
    struct MothershipRequestCompleteDelegateWrapper : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipRequestCompleteDelegateWrapper");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::MothershipRequestCompleteDelegateWrapper* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::MothershipRequestCompleteDelegateWrapper* obj) {
