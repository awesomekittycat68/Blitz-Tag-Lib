...
namespace GlobalNamespace {
    struct MothershipRunTransactionRequest : ::GlobalNamespace::MothershipRequestShared {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipRunTransactionRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::MothershipRunTransactionRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::MothershipRunTransactionRequest* obj) {
