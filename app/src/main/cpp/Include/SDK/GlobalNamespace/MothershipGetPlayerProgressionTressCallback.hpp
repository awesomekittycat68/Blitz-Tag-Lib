...
#include "GetProgressionTreesForPlayerCompleteClientDelegateWrapper.hpp"

namespace GlobalNamespace {
    struct MothershipGetPlayerProgressionTressCallback : ::GlobalNamespace::GetProgressionTreesForPlayerCompleteClientDelegateWrapper {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipGetPlayerProgressionTressCallback");
            return clazz;
        }
