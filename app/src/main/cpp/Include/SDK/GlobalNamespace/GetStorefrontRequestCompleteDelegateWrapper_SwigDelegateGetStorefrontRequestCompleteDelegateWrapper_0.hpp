...
namespace GlobalNamespace {
    struct GetStorefrontRequestCompleteDelegateWrapper_SwigDelegateGetStorefrontRequestCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetStorefrontRequestCompleteDelegateWrapper").GetInnerClass("SwigDelegateGetStorefrontRequestCompleteDelegateWrapper_0");
            return clazz;
        }
