...
namespace GlobalNamespace {
    struct ListProgressionTreeRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListProgressionTreeRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::ListProgressionTreeRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::ListProgressionTreeRequest* obj) {
