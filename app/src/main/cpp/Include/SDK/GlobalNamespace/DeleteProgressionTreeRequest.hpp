...
namespace GlobalNamespace {
    struct DeleteProgressionTreeRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteProgressionTreeRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::DeleteProgressionTreeRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::DeleteProgressionTreeRequest* obj) {
