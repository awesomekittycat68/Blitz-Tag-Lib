...
namespace GlobalNamespace {
    struct PurchaseCurrencyButton : ::GlobalNamespace::GorillaPressableButton {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "PurchaseCurrencyButton");
            return clazz;
        }
        ...
        ::BNM::Structures::Mono::String* GetPurchaseCurrencySize() {
            static BNM::Field<::BNM::Structures::Mono::String*> _field = GetClass().GetField(O("purchaseCurrencySize"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetPurchaseCurrencySize(::BNM::Structures::Mono::String* value) {
            static BNM::Field<::BNM::Structures::Mono::String*> _field = GetClass().GetField(O("purchaseCurrencySize"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
