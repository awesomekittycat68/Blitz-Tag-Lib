...
namespace GlobalNamespace {
    struct ModIOTermsOfUse_v1_$UpdateTextWithFullTerms$d__21 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ModIOTermsOfUse_v1").GetInnerClass("<UpdateTextWithFullTerms>d__21");
            return clazz;
        }
