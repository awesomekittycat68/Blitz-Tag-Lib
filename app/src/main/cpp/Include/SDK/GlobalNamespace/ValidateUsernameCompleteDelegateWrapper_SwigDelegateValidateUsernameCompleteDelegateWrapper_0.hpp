...
namespace GlobalNamespace {
    struct ValidateUsernameCompleteDelegateWrapper_SwigDelegateValidateUsernameCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ValidateUsernameCompleteDelegateWrapper").GetInnerClass("SwigDelegateValidateUsernameCompleteDelegateWrapper_0");
            return clazz;
        }
