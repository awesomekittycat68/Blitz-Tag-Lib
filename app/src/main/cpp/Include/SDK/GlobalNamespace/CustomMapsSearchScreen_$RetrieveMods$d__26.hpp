...
namespace GlobalNamespace {
    struct CustomMapsSearchScreen_$RetrieveMods$d__26 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CustomMapsSearchScreen").GetInnerClass("<RetrieveMods>d__26");
            return clazz;
        }
