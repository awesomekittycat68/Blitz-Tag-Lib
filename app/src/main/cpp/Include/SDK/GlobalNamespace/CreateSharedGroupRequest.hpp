...
namespace GlobalNamespace {
    struct CreateSharedGroupRequest : ::GlobalNamespace::MothershipRequestShared {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateSharedGroupRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::CreateSharedGroupRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::CreateSharedGroupRequest* obj) {
