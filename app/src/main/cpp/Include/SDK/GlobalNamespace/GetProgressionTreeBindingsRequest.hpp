...
namespace GlobalNamespace {
    struct GetProgressionTreeBindingsRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetProgressionTreeBindingsRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::GetProgressionTreeBindingsRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::GetProgressionTreeBindingsRequest* obj) {
