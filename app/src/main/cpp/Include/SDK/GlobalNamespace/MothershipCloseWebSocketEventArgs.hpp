...
namespace GlobalNamespace {
    struct MothershipCloseWebSocketEventArgs : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipCloseWebSocketEventArgs");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::MothershipCloseWebSocketEventArgs* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::MothershipCloseWebSocketEventArgs* obj) {
