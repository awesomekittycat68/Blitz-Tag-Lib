...
namespace GlobalNamespace {
    struct GROneTimeEntitySpawner : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GROneTimeEntitySpawner");
            return clazz;
        }
        ...
        bool GetBHasSpawned() {
            static BNM::Field<bool> _field = GetClass().GetField(O("bHasSpawned"));
        ...
        void SetBHasSpawned(bool value) {
            static BNM::Field<bool> _field = GetClass().GetField(O("bHasSpawned"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        void TrySpawn() {
            static BNM::Method<void> _m = GetClass().GetMethod(O("TrySpawn"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call();
        }
        void Update() {
