...
namespace GlobalNamespace {
    struct GetEnvironmentRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetEnvironmentRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::GetEnvironmentRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::GetEnvironmentRequest* obj) {
