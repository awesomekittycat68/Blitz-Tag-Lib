...
namespace GlobalNamespace {
    struct ListTitlesRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListTitlesRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::ListTitlesRequest* obj) {
            static BNM::Method<void*> _m = GetClass().GetMethod(O("getCPtr"), {"obj"});
            return _m.Call(obj);
        }
        static void* swigRelease(::GlobalNamespace::ListTitlesRequest* obj) {
