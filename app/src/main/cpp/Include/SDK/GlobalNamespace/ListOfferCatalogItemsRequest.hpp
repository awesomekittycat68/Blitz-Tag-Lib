...
namespace GlobalNamespace {
    struct ListOfferCatalogItemsRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListOfferCatalogItemsRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::ListOfferCatalogItemsRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::ListOfferCatalogItemsRequest* obj) {
