...
namespace GlobalNamespace {
    struct Bindings_Vec3Functions_Mul_000048F5$BurstDirectCall : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "Bindings").GetInnerClass("Vec3Functions").GetInnerClass("Mul_000048F5$BurstDirectCall");
            return clazz;
        }
