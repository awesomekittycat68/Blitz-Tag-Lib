...
namespace GlobalNamespace {
    struct UpdateProgressionTrackCompleteDelegateWrapper_SwigDelegateUpdateProgressionTrackCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateProgressionTrackCompleteDelegateWrapper").GetInnerClass("SwigDelegateUpdateProgressionTrackCompleteDelegateWrapper_0");
            return clazz;
        }
