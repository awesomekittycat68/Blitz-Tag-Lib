...
namespace GlobalNamespace {
    struct CreateUserDataMetadataCompleteDelegateWrapper_SwigDelegateCreateUserDataMetadataCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateUserDataMetadataCompleteDelegateWrapper").GetInnerClass("SwigDelegateCreateUserDataMetadataCompleteDelegateWrapper_0");
            return clazz;
        }
