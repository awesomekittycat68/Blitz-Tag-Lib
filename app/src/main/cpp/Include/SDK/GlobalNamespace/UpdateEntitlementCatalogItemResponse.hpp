...
namespace GlobalNamespace {
    struct UpdateEntitlementCatalogItemResponse : ::GlobalNamespace::MothershipResponse {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateEntitlementCatalogItemResponse");
            return clazz;
        }
        ...
        static ::GlobalNamespace::UpdateEntitlementCatalogItemResponse* FromMothershipResponse(::GlobalNamespace::MothershipResponse* response) {
            static BNM::Method<::GlobalNamespace::UpdateEntitlementCatalogItemResponse*> _m = GetClass().GetMethod(O("FromMothershipResponse"), {"response"});
        ...
        static void* getCPtr(::GlobalNamespace::UpdateEntitlementCatalogItemResponse* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::UpdateEntitlementCatalogItemResponse* obj) {
