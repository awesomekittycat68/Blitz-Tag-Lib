...
namespace GlobalNamespace {
    struct UpdateProgressionTreeBindingsCompleteDelegateWrapper_SwigDelegateUpdateProgressionTreeBindingsCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateProgressionTreeBindingsCompleteDelegateWrapper").GetInnerClass("SwigDelegateUpdateProgressionTreeBindingsCompleteDelegateWrapper_0");
            return clazz;
        }
