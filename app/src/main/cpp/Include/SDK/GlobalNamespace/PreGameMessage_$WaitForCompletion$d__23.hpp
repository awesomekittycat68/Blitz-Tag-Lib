...
namespace GlobalNamespace {
    struct PreGameMessage_$WaitForCompletion$d__23 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "PreGameMessage").GetInnerClass("<WaitForCompletion>d__23");
            return clazz;
        }
