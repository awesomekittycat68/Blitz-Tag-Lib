...
namespace GlobalNamespace {
    struct MothershipGetInventoryRequest : ::GlobalNamespace::MothershipRequestShared {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipGetInventoryRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::MothershipGetInventoryRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::MothershipGetInventoryRequest* obj) {
