...
namespace GlobalNamespace {
    struct StorefrontResultsMap_StorefrontResultsMapEnumerator : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "StorefrontResultsMap").GetInnerClass("StorefrontResultsMapEnumerator");
            return clazz;
        }

        static BNM::MonoType* GetType() { return GetClass().GetMonoType(); }

        ::GlobalNamespace::StorefrontResultsMap* GetCollectionRef() {
            static BNM::Field<::GlobalNamespace::StorefrontResultsMap*> _field = GetClass().GetField(O("collectionRef"));
        ...
        void SetCollectionRef(::GlobalNamespace::StorefrontResultsMap* value) {
            static BNM::Field<::GlobalNamespace::StorefrontResultsMap*> _field = GetClass().GetField(O("collectionRef"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
