...
namespace GlobalNamespace {
    struct CreateOfferDisplayRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateOfferDisplayRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::CreateOfferDisplayRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::CreateOfferDisplayRequest* obj) {
