...
namespace GlobalNamespace {
    struct KIDManager_$TrySendOptInPermissions$d__85 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "KIDManager").GetInnerClass("<TrySendOptInPermissions>d__85");
            return clazz;
        }
