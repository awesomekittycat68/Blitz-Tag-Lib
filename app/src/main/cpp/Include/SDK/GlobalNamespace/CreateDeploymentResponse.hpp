...
namespace GlobalNamespace {
    struct CreateDeploymentResponse : ::GlobalNamespace::MothershipResponse {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateDeploymentResponse");
            return clazz;
        }
        ...
        static ::GlobalNamespace::CreateDeploymentResponse* FromMothershipResponse(::GlobalNamespace::MothershipResponse* response) {
            static BNM::Method<::GlobalNamespace::CreateDeploymentResponse*> _m = GetClass().GetMethod(O("FromMothershipResponse"), {"response"});
        ...
        static void* getCPtr(::GlobalNamespace::CreateDeploymentResponse* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::CreateDeploymentResponse* obj) {
