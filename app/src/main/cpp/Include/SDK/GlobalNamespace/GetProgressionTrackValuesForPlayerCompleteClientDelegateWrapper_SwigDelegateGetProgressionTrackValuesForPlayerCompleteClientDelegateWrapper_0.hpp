...
namespace GlobalNamespace {
    struct GetProgressionTrackValuesForPlayerCompleteClientDelegateWrapper_SwigDelegateGetProgressionTrackValuesForPlayerCompleteClientDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetProgressionTrackValuesForPlayerCompleteClientDelegateWrapper").GetInnerClass("SwigDelegateGetProgressionTrackValuesForPlayerCompleteClientDelegateWrapper_0");
            return clazz;
        }
