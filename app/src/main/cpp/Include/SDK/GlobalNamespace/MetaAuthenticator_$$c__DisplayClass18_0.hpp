...
namespace GlobalNamespace {
    struct MetaAuthenticator_$$c__DisplayClass18_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MetaAuthenticator").GetInnerClass("<>c__DisplayClass18_0");
            return clazz;
        }
