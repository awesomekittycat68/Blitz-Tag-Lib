...
namespace GlobalNamespace {
    struct OfferChangesMap_OfferChangesMapEnumerator : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "OfferChangesMap").GetInnerClass("OfferChangesMapEnumerator");
            return clazz;
        }

        static BNM::MonoType* GetType() { return GetClass().GetMonoType(); }

        ::GlobalNamespace::OfferChangesMap* GetCollectionRef() {
            static BNM::Field<::GlobalNamespace::OfferChangesMap*> _field = GetClass().GetField(O("collectionRef"));
        ...
        void SetCollectionRef(::GlobalNamespace::OfferChangesMap* value) {
            static BNM::Field<::GlobalNamespace::OfferChangesMap*> _field = GetClass().GetField(O("collectionRef"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
