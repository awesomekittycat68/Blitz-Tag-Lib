...
namespace GlobalNamespace {
    struct NetworkSystemFusion_$MakeOrJoinRoom$d__61 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "NetworkSystemFusion").GetInnerClass("<MakeOrJoinRoom>d__61");
            return clazz;
        }
