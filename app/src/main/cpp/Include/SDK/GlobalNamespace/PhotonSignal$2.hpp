...
namespace GlobalNamespace {
    ...
    struct PhotonSignal$2 : ::GlobalNamespace::PhotonSignal {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "PhotonSignal`2");
            return clazz;
        }
        ...
        void Raise(T1 arg1, T2 arg2) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("Raise"), {"arg1", "arg2"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(arg1, arg2);
        }
        void Raise(::Photon_Realtime::ReceiverGroup receivers, T1 arg1, T2 arg2) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("Raise"), {"receivers", "arg1", "arg2"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(receivers, arg1, arg2);
        }
    };
}
