...
namespace GlobalNamespace {
    struct ValidateUsernameRequest : ::GlobalNamespace::MothershipRequestShared {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ValidateUsernameRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::ValidateUsernameRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::ValidateUsernameRequest* obj) {
