...
namespace GlobalNamespace {
    struct KIDAgeGate_$InitialiseAgeGate$d__33 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "KIDAgeGate").GetInnerClass("<InitialiseAgeGate>d__33");
            return clazz;
        }
