...
namespace GlobalNamespace {
    struct LoginCompleteDelegateWrapper_SwigDelegateLoginCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "LoginCompleteDelegateWrapper").GetInnerClass("SwigDelegateLoginCompleteDelegateWrapper_0");
            return clazz;
        }
