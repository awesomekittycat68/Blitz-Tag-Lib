...
namespace GlobalNamespace {
    struct UpdatePlayerTagsRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdatePlayerTagsRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::UpdatePlayerTagsRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::UpdatePlayerTagsRequest* obj) {
