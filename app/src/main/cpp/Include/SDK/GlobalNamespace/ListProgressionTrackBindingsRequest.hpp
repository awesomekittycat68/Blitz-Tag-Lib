...
namespace GlobalNamespace {
    struct ListProgressionTrackBindingsRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListProgressionTrackBindingsRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::ListProgressionTrackBindingsRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::ListProgressionTrackBindingsRequest* obj) {
