...
namespace GlobalNamespace {
    struct ModIOManager_$RefreshModCache$d__51 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ModIOManager").GetInnerClass("<RefreshModCache>d__51");
            return clazz;
        }
