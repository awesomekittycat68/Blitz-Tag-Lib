...
namespace GlobalNamespace {
    struct RemoveSharedGroupMembersCompleteClientDelegateWrapper_SwigDelegateRemoveSharedGroupMembersCompleteClientDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "RemoveSharedGroupMembersCompleteClientDelegateWrapper").GetInnerClass("SwigDelegateRemoveSharedGroupMembersCompleteClientDelegateWrapper_0");
            return clazz;
        }
