...
namespace GlobalNamespace {
    struct ListTitlesCompleteDelegateWrapper_SwigDelegateListTitlesCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListTitlesCompleteDelegateWrapper").GetInnerClass("SwigDelegateListTitlesCompleteDelegateWrapper_0");
            return clazz;
        }
