...
namespace GlobalNamespace {
    struct Bindings_Vec3Functions_ZeroVector_00004903$BurstDirectCall : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "Bindings").GetInnerClass("Vec3Functions").GetInnerClass("ZeroVector_00004903$BurstDirectCall");
            return clazz;
        }
