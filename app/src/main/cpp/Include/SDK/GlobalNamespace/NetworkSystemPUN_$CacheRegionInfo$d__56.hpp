...
namespace GlobalNamespace {
    struct NetworkSystemPUN_$CacheRegionInfo$d__56 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "NetworkSystemPUN").GetInnerClass("<CacheRegionInfo>d__56");
            return clazz;
        }
