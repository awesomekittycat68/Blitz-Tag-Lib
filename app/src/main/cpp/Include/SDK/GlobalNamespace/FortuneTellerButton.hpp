...
namespace GlobalNamespace {
    struct FortuneTellerButton : ::GlobalNamespace::GorillaPressableButton {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "FortuneTellerButton");
            return clazz;
        }

        static BNM::MonoType* GetType() { return GetClass().GetMonoType(); }

        float GetDurationPressed() {
            static BNM::Field<float> _field = GetClass().GetField(O("durationPressed"));
        ...
        void SetDurationPressed(float value) {
            static BNM::Field<float> _field = GetClass().GetField(O("durationPressed"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        void PressButtonUpdate() {
            static BNM::Method<void> _m = GetClass().GetMethod(O("PressButtonUpdate"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call();
        }
    };
