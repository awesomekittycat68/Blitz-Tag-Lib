...
namespace GlobalNamespace {
    struct UpdateInsecure1ConfigRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateInsecure1ConfigRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::UpdateInsecure1ConfigRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::UpdateInsecure1ConfigRequest* obj) {
