...
namespace GlobalNamespace {
    struct MothershipHydratedTransactionCatalogItem : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipHydratedTransactionCatalogItem");
            return clazz;
        }
        ...
        ::GlobalNamespace::HydratedInventoryChangeMap* GetInventoryChanges() {
            static BNM::Method<::GlobalNamespace::HydratedInventoryChangeMap*> _method = GetClass().GetMethod(O("get_inventoryChanges"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _method.Call();
        }
        void SetInventoryChanges(::GlobalNamespace::HydratedInventoryChangeMap* value) {
        ...
        ::GlobalNamespace::HydratedInventoryChangeMap* get_inventoryChanges() {
            static BNM::Method<::GlobalNamespace::HydratedInventoryChangeMap*> _m = GetClass().GetMethod(O("get_inventoryChanges"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call();
        }
        ...
        static void* getCPtr(::GlobalNamespace::MothershipHydratedTransactionCatalogItem* obj) {
        ...
        void set_inventoryChanges(::GlobalNamespace::HydratedInventoryChangeMap* value) {
        ...
        static void* swigRelease(::GlobalNamespace::MothershipHydratedTransactionCatalogItem* obj) {
