...
namespace GlobalNamespace {
    struct UpdateUserDataMetadataCompleteDelegateWrapper_SwigDelegateUpdateUserDataMetadataCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateUserDataMetadataCompleteDelegateWrapper").GetInnerClass("SwigDelegateUpdateUserDataMetadataCompleteDelegateWrapper_0");
            return clazz;
        }
