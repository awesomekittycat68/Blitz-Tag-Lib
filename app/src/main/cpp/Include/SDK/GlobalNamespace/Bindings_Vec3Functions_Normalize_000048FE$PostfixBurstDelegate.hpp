...
namespace GlobalNamespace {
    struct Bindings_Vec3Functions_Normalize_000048FE$PostfixBurstDelegate : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "Bindings").GetInnerClass("Vec3Functions").GetInnerClass("Normalize_000048FE$PostfixBurstDelegate");
            return clazz;
        }
