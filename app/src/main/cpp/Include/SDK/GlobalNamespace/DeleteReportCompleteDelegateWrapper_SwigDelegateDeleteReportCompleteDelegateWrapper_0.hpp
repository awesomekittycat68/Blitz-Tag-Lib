...
namespace GlobalNamespace {
    struct DeleteReportCompleteDelegateWrapper_SwigDelegateDeleteReportCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteReportCompleteDelegateWrapper").GetInnerClass("SwigDelegateDeleteReportCompleteDelegateWrapper_0");
            return clazz;
        }
