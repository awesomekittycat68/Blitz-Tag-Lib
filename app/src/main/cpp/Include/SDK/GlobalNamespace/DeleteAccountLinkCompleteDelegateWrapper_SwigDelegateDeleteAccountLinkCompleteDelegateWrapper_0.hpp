...
namespace GlobalNamespace {
    struct DeleteAccountLinkCompleteDelegateWrapper_SwigDelegateDeleteAccountLinkCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteAccountLinkCompleteDelegateWrapper").GetInnerClass("SwigDelegateDeleteAccountLinkCompleteDelegateWrapper_0");
            return clazz;
        }
