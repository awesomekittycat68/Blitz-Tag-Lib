...
namespace GlobalNamespace {
    struct ProgressionManager_GetProgressionRequest : ::GlobalNamespace::ProgressionManager_MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ProgressionManager").GetInnerClass("GetProgressionRequest");
            return clazz;
        }
