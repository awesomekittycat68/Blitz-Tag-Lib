...
#include "PlayerSteamBeginLoginResponseCompleteDelegateWrapper.hpp"

namespace GlobalNamespace {
    struct MothershipBeginSteamCallback : ::GlobalNamespace::PlayerSteamBeginLoginResponseCompleteDelegateWrapper {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipBeginSteamCallback");
            return clazz;
        }
