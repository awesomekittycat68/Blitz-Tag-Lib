...
namespace GlobalNamespace {
    struct Bindings_Vec3Functions_Eq_000048F8$PostfixBurstDelegate : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "Bindings").GetInnerClass("Vec3Functions").GetInnerClass("Eq_000048F8$PostfixBurstDelegate");
            return clazz;
        }
