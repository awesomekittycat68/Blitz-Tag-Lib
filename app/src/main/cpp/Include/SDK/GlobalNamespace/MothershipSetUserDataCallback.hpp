...
#include "SetUserDataCompleteClientDelegateWrapper.hpp"

namespace GlobalNamespace {
    struct MothershipSetUserDataCallback : ::GlobalNamespace::SetUserDataCompleteClientDelegateWrapper {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipSetUserDataCallback");
            return clazz;
        }
