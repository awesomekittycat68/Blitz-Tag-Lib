...
namespace GlobalNamespace {
    struct MothershipWebSocketMessage : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipWebSocketMessage");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::MothershipWebSocketMessage* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::MothershipWebSocketMessage* obj) {
