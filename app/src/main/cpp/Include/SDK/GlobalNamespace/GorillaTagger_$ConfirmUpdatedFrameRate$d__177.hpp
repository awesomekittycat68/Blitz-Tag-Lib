...
namespace GlobalNamespace {
    struct GorillaTagger_$ConfirmUpdatedFrameRate$d__177 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GorillaTagger").GetInnerClass("<ConfirmUpdatedFrameRate>d__177");
            return clazz;
        }
