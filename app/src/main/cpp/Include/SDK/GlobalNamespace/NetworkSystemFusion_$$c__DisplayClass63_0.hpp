...
namespace GlobalNamespace {
    struct NetworkSystemFusion_$$c__DisplayClass63_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "NetworkSystemFusion").GetInnerClass("<>c__DisplayClass63_0");
            return clazz;
        }
