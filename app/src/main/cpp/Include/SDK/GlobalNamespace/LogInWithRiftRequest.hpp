...
namespace GlobalNamespace {
    struct LogInWithRiftRequest : ::GlobalNamespace::LoginRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "LogInWithRiftRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::LogInWithRiftRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::LogInWithRiftRequest* obj) {
