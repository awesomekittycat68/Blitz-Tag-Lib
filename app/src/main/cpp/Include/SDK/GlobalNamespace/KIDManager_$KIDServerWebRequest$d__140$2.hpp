...
namespace GlobalNamespace {
    ...
    struct KIDManager_$KIDServerWebRequest$d__140$2 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "KIDManager").GetInnerClass("<KIDServerWebRequest>d__140`2");
            return clazz;
        }
        ...
        ::BNM::Structures::Mono::String* GetQueryParams() {
            static BNM::Field<::BNM::Structures::Mono::String*> _field = GetClass().GetField(O("queryParams"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        Q GetRequestData() {
        ...
        void SetQueryParams(::BNM::Structures::Mono::String* value) {
            static BNM::Field<::BNM::Structures::Mono::String*> _field = GetClass().GetField(O("queryParams"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
