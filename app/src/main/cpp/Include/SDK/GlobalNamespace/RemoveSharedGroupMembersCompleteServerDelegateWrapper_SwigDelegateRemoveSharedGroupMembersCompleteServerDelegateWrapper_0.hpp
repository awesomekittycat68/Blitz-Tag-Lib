...
namespace GlobalNamespace {
    struct RemoveSharedGroupMembersCompleteServerDelegateWrapper_SwigDelegateRemoveSharedGroupMembersCompleteServerDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "RemoveSharedGroupMembersCompleteServerDelegateWrapper").GetInnerClass("SwigDelegateRemoveSharedGroupMembersCompleteServerDelegateWrapper_0");
            return clazz;
        }
