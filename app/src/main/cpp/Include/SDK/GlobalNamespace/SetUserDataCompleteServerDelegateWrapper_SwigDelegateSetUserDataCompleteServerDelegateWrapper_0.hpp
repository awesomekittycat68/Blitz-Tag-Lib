...
namespace GlobalNamespace {
    struct SetUserDataCompleteServerDelegateWrapper_SwigDelegateSetUserDataCompleteServerDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "SetUserDataCompleteServerDelegateWrapper").GetInnerClass("SwigDelegateSetUserDataCompleteServerDelegateWrapper_0");
            return clazz;
        }
