...
namespace GlobalNamespace {
    struct GetProgressionTreesForPlayerCompleteClientDelegateWrapper_SwigDelegateGetProgressionTreesForPlayerCompleteClientDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetProgressionTreesForPlayerCompleteClientDelegateWrapper").GetInnerClass("SwigDelegateGetProgressionTreesForPlayerCompleteClientDelegateWrapper_0");
            return clazz;
        }
