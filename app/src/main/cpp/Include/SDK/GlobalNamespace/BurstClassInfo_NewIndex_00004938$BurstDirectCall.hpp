...
namespace GlobalNamespace {
    struct BurstClassInfo_NewIndex_00004938$BurstDirectCall : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "BurstClassInfo").GetInnerClass("NewIndex_00004938$BurstDirectCall");
            return clazz;
        }
