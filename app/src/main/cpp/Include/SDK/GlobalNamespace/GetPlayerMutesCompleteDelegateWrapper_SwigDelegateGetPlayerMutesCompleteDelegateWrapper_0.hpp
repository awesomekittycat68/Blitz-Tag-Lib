...
namespace GlobalNamespace {
    struct GetPlayerMutesCompleteDelegateWrapper_SwigDelegateGetPlayerMutesCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetPlayerMutesCompleteDelegateWrapper").GetInnerClass("SwigDelegateGetPlayerMutesCompleteDelegateWrapper_0");
            return clazz;
        }
