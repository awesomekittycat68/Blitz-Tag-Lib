...
namespace GlobalNamespace {
    struct CodeRedemption_CodeRedemptionResponse : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CodeRedemption").GetInnerClass("CodeRedemptionResponse");
            return clazz;
        }
        ...
        ::BNM::Structures::Mono::String* GetResult() {
            static BNM::Field<::BNM::Structures::Mono::String*> _field = GetClass().GetField(O("result"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        void* GetStartTime() {
        ...
        void SetResult(::BNM::Structures::Mono::String* value) {
            static BNM::Field<::BNM::Structures::Mono::String*> _field = GetClass().GetField(O("result"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
