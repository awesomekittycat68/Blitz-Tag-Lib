...
namespace GlobalNamespace {
    struct GetUserDataCompleteAutomationDelegateWrapper_SwigDelegateGetUserDataCompleteAutomationDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetUserDataCompleteAutomationDelegateWrapper").GetInnerClass("SwigDelegateGetUserDataCompleteAutomationDelegateWrapper_0");
            return clazz;
        }
