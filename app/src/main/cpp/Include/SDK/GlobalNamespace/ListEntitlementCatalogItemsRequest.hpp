...
namespace GlobalNamespace {
    struct ListEntitlementCatalogItemsRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListEntitlementCatalogItemsRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::ListEntitlementCatalogItemsRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::ListEntitlementCatalogItemsRequest* obj) {
