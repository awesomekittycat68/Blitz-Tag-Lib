...
namespace GlobalNamespace {
    struct DeleteUserDataMetadataRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteUserDataMetadataRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::DeleteUserDataMetadataRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::DeleteUserDataMetadataRequest* obj) {
