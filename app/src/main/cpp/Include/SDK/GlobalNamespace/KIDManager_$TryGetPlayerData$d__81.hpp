...
namespace GlobalNamespace {
    struct KIDManager_$TryGetPlayerData$d__81 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "KIDManager").GetInnerClass("<TryGetPlayerData>d__81");
            return clazz;
        }
