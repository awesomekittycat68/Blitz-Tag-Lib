...
namespace GlobalNamespace {
    struct CreateMuteCompleteDelegateWrapper_SwigDelegateCreateMuteCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateMuteCompleteDelegateWrapper").GetInnerClass("SwigDelegateCreateMuteCompleteDelegateWrapper_0");
            return clazz;
        }
