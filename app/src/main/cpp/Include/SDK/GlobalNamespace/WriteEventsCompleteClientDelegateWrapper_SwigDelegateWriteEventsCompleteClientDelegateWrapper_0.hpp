...
namespace GlobalNamespace {
    struct WriteEventsCompleteClientDelegateWrapper_SwigDelegateWriteEventsCompleteClientDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "WriteEventsCompleteClientDelegateWrapper").GetInnerClass("SwigDelegateWriteEventsCompleteClientDelegateWrapper_0");
            return clazz;
        }
