...
namespace GlobalNamespace {
    struct BushFieldReactorFieldMain : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "BushFieldReactorFieldMain");
            return clazz;
        }
        ...
        ::BNM::Structures::Mono::Array<::BNM::Structures::Unity::Matrix4x4>* GetMAaInstancedBushMatrix() {
            static BNM::Field<::BNM::Structures::Mono::Array<::BNM::Structures::Unity::Matrix4x4>*> _field = GetClass().GetField(O("m_aaInstancedBushMatrix"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ::BNM::Structures::Mono::List<::BoingKit::BoingEffector*>* GetMASphere() {
            static BNM::Field<::BNM::Structures::Mono::List<::BoingKit::BoingEffector*>*> _field = GetClass().GetField(O("m_aSphere"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        float GetMBasePhase() {
        ...
        ::BNM::IL2CPP::Il2CppObject* GetMBushMaterialProps() {
            static BNM::Field<::BNM::IL2CPP::Il2CppObject*> _field = GetClass().GetField(O("m_bushMaterialProps"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetMAaInstancedBushMatrix(::BNM::Structures::Mono::Array<::BNM::Structures::Unity::Matrix4x4>* value) {
            static BNM::Field<::BNM::Structures::Mono::Array<::BNM::Structures::Unity::Matrix4x4>*> _field = GetClass().GetField(O("m_aaInstancedBushMatrix"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        void SetMASphere(::BNM::Structures::Mono::List<::BoingKit::BoingEffector*>* value) {
            static BNM::Field<::BNM::Structures::Mono::List<::BoingKit::BoingEffector*>*> _field = GetClass().GetField(O("m_aSphere"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        void SetMBushMaterialProps(::BNM::IL2CPP::Il2CppObject* value) {
            static BNM::Field<::BNM::IL2CPP::Il2CppObject*> _field = GetClass().GetField(O("m_bushMaterialProps"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
