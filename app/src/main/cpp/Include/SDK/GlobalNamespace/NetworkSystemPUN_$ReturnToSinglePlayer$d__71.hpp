...
namespace GlobalNamespace {
    struct NetworkSystemPUN_$ReturnToSinglePlayer$d__71 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "NetworkSystemPUN").GetInnerClass("<ReturnToSinglePlayer>d__71");
            return clazz;
        }
