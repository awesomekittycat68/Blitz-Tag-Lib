...
namespace GlobalNamespace {
    struct PurchaseOfferRequestCompleteDelegateWrapper_SwigDelegatePurchaseOfferRequestCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "PurchaseOfferRequestCompleteDelegateWrapper").GetInnerClass("SwigDelegatePurchaseOfferRequestCompleteDelegateWrapper_0");
            return clazz;
        }
