...
namespace GlobalNamespace {
    struct ProgressionUtil_$WaitForMothershipSessionToken$d__0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ProgressionUtil").GetInnerClass("<WaitForMothershipSessionToken>d__0");
            return clazz;
        }
