...
namespace GlobalNamespace {
    struct DeleteProgressionTrackRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteProgressionTrackRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::DeleteProgressionTrackRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::DeleteProgressionTrackRequest* obj) {
