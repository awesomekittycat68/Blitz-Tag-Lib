...
namespace GlobalNamespace {
    struct NetworkSystemFusion_$AwaitAuth$d__57 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "NetworkSystemFusion").GetInnerClass("<AwaitAuth>d__57");
            return clazz;
        }
