...
namespace GlobalNamespace {
    struct UpdateProgressionTreeRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateProgressionTreeRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::UpdateProgressionTreeRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::UpdateProgressionTreeRequest* obj) {
