...
namespace GlobalNamespace {
    struct ReportForwardHit : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ReportForwardHit");
            return clazz;
        }
        ...
        bool GetSeekOnEnable() {
            static BNM::Field<bool> _field = GetClass().GetField(O("seekOnEnable"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetSeekOnEnable(bool value) {
            static BNM::Field<bool> _field = GetClass().GetField(O("seekOnEnable"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
