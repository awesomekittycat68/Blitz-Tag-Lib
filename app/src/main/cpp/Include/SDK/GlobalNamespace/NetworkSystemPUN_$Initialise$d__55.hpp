...
namespace GlobalNamespace {
    struct NetworkSystemPUN_$Initialise$d__55 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "NetworkSystemPUN").GetInnerClass("<Initialise>d__55");
            return clazz;
        }
