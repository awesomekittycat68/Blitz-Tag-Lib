...
namespace GlobalNamespace {
    struct StorefrontResultsMap : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "StorefrontResultsMap");
            return clazz;
        }
        ...
        ::GlobalNamespace::MothershipBoundOfferDisplay* GetItem() {
            static BNM::Method<::GlobalNamespace::MothershipBoundOfferDisplay*> _method = GetClass().GetMethod(O("get_Item"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _method.Call();
        }
        void SetItem(::GlobalNamespace::MothershipBoundOfferDisplay* value) {
        ...
        void Add(::BNM::Structures::Mono::String* key, ::GlobalNamespace::MothershipBoundOfferDisplay* val) {
        ...
        ::GlobalNamespace::MothershipBoundOfferDisplay* get_Item(::BNM::Structures::Mono::String* key) {
            static BNM::Method<::GlobalNamespace::MothershipBoundOfferDisplay*> _m = GetClass().GetMethod(O("get_Item"), {"key"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call(key);
        }
        void* get_Keys() {
        ...
        static void* getCPtr(::GlobalNamespace::StorefrontResultsMap* obj) {
            static BNM::Method<void*> _m = GetClass().GetMethod(O("getCPtr"), {"obj"});
            return _m.Call(obj);
        }
        ::GlobalNamespace::StorefrontResultsMap_StorefrontResultsMapEnumerator* GetEnumerator() {
            static BNM::Method<::GlobalNamespace::StorefrontResultsMap_StorefrontResultsMapEnumerator*> _m = GetClass().GetMethod(O("GetEnumerator"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call();
        }
        ::GlobalNamespace::MothershipBoundOfferDisplay* getitem(::BNM::Structures::Mono::String* key) {
            static BNM::Method<::GlobalNamespace::MothershipBoundOfferDisplay*> _m = GetClass().GetMethod(O("getitem"), {"key"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call(key);
        }
        template <typename TP0 = void*>
        ...
        void set_Item(::BNM::Structures::Mono::String* key, ::GlobalNamespace::MothershipBoundOfferDisplay* value) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("set_Item"), {"key", "value"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(key, value);
        }
        void setitem(::BNM::Structures::Mono::String* key, ::GlobalNamespace::MothershipBoundOfferDisplay* x) {
        ...
        static void* swigRelease(::GlobalNamespace::StorefrontResultsMap* obj) {
            static BNM::Method<void*> _m = GetClass().GetMethod(O("swigRelease"), {"obj"});
            return _m.Call(obj);
        }
        bool TryGetValue(::BNM::Structures::Mono::String* key, ::GlobalNamespace::MothershipBoundOfferDisplay*& value) {
