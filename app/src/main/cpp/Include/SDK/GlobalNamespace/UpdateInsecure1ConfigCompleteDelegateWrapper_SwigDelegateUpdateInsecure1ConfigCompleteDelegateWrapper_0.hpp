...
namespace GlobalNamespace {
    struct UpdateInsecure1ConfigCompleteDelegateWrapper_SwigDelegateUpdateInsecure1ConfigCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateInsecure1ConfigCompleteDelegateWrapper").GetInnerClass("SwigDelegateUpdateInsecure1ConfigCompleteDelegateWrapper_0");
            return clazz;
        }
