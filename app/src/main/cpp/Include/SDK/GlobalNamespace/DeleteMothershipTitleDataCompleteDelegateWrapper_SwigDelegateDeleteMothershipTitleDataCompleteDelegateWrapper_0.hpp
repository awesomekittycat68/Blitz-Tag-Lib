...
namespace GlobalNamespace {
    struct DeleteMothershipTitleDataCompleteDelegateWrapper_SwigDelegateDeleteMothershipTitleDataCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteMothershipTitleDataCompleteDelegateWrapper").GetInnerClass("SwigDelegateDeleteMothershipTitleDataCompleteDelegateWrapper_0");
            return clazz;
        }
