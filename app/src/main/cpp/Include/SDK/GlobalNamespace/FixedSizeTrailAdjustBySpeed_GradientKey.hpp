...
namespace GlobalNamespace {
    struct FixedSizeTrailAdjustBySpeed_GradientKey : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "FixedSizeTrailAdjustBySpeed").GetInnerClass("GradientKey");
            return clazz;
        }
