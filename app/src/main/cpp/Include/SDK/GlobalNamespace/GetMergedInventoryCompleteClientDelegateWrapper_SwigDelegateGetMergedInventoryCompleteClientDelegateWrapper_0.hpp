...
namespace GlobalNamespace {
    struct GetMergedInventoryCompleteClientDelegateWrapper_SwigDelegateGetMergedInventoryCompleteClientDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetMergedInventoryCompleteClientDelegateWrapper").GetInnerClass("SwigDelegateGetMergedInventoryCompleteClientDelegateWrapper_0");
            return clazz;
        }
