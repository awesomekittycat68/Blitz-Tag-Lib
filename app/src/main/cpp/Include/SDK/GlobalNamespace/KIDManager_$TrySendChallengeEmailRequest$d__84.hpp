...
namespace GlobalNamespace {
    struct KIDManager_$TrySendChallengeEmailRequest$d__84 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "KIDManager").GetInnerClass("<TrySendChallengeEmailRequest>d__84");
            return clazz;
        }
