...
namespace GlobalNamespace {
    struct CustomMapsListScreen_$RetrieveAvailableMods$d__103 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CustomMapsListScreen").GetInnerClass("<RetrieveAvailableMods>d__103");
            return clazz;
        }
