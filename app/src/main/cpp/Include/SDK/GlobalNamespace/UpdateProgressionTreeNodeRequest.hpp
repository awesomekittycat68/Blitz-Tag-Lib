...
namespace GlobalNamespace {
    struct UpdateProgressionTreeNodeRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateProgressionTreeNodeRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::UpdateProgressionTreeNodeRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::UpdateProgressionTreeNodeRequest* obj) {
