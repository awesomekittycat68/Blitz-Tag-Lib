...
#include "MothershipWebSocketEvents.hpp"

namespace GlobalNamespace {
    struct MothershipWebSocketResponse : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipWebSocketResponse");
            return clazz;
        }
        ...
        ::GlobalNamespace::MothershipWebSocketEvents GetEvent() {
            static BNM::Method<::GlobalNamespace::MothershipWebSocketEvents> _method = GetClass().GetMethod(O("get_Event"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _method.Call();
        }
        void SetEvent(::GlobalNamespace::MothershipWebSocketEvents value) {
            static BNM::Method<void> _method = GetClass().GetMethod(O("set_Event"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _method.Call(value);
        }
        ...
        ::GlobalNamespace::MothershipWebSocketEvents get_Event() {
            static BNM::Method<::GlobalNamespace::MothershipWebSocketEvents> _m = GetClass().GetMethod(O("get_Event"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call();
        }
        ...
        static void* getCPtr(::GlobalNamespace::MothershipWebSocketResponse* obj) {
        ...
        void set_Event(::GlobalNamespace::MothershipWebSocketEvents value) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("set_Event"), {"value"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(value);
        }
        ...
        static void* swigRelease(::GlobalNamespace::MothershipWebSocketResponse* obj) {
