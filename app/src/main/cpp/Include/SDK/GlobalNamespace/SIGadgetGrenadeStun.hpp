...
#include "SIGadgetGrenadeStun_State.hpp"

namespace GlobalNamespace {
    struct SIGadgetGrenadeStun : ::GlobalNamespace::SIGadgetGrenade {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "SIGadgetGrenadeStun");
            return clazz;
        }
        ...
        ::GlobalNamespace::SIGadgetGrenadeStun_State GetState() {
            static BNM::Field<::GlobalNamespace::SIGadgetGrenadeStun_State> _field = GetClass().GetField(O("state"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetState(::GlobalNamespace::SIGadgetGrenadeStun_State value) {
            static BNM::Field<::GlobalNamespace::SIGadgetGrenadeStun_State> _field = GetClass().GetField(O("state"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        void SetState_1(::GlobalNamespace::SIGadgetGrenadeStun_State newState) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("SetState"), {"newState"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(newState);
        }
        void SetStateAuthority(::GlobalNamespace::SIGadgetGrenadeStun_State newState) {
