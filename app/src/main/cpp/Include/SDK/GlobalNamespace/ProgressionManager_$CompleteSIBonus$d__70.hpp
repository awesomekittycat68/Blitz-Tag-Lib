...
namespace GlobalNamespace {
    struct ProgressionManager_$CompleteSIBonus$d__70 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ProgressionManager").GetInnerClass("<CompleteSIBonus>d__70");
            return clazz;
        }
