...
namespace GlobalNamespace {
    struct KIDManager_$CheckKIDNewPlayerDateTime$d__103 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "KIDManager").GetInnerClass("<CheckKIDNewPlayerDateTime>d__103");
            return clazz;
        }
