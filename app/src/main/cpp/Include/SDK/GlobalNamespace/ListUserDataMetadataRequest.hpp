...
namespace GlobalNamespace {
    struct ListUserDataMetadataRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListUserDataMetadataRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::ListUserDataMetadataRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::ListUserDataMetadataRequest* obj) {
