...
namespace GlobalNamespace {
    struct UpdateDeploymentRequiredTagsRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateDeploymentRequiredTagsRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::UpdateDeploymentRequiredTagsRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::UpdateDeploymentRequiredTagsRequest* obj) {
