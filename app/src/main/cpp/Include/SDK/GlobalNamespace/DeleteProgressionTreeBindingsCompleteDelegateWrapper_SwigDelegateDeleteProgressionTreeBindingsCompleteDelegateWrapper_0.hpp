...
namespace GlobalNamespace {
    struct DeleteProgressionTreeBindingsCompleteDelegateWrapper_SwigDelegateDeleteProgressionTreeBindingsCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteProgressionTreeBindingsCompleteDelegateWrapper").GetInnerClass("SwigDelegateDeleteProgressionTreeBindingsCompleteDelegateWrapper_0");
            return clazz;
        }
