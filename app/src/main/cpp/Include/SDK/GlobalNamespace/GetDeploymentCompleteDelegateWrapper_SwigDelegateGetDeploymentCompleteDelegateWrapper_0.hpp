...
namespace GlobalNamespace {
    struct GetDeploymentCompleteDelegateWrapper_SwigDelegateGetDeploymentCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetDeploymentCompleteDelegateWrapper").GetInnerClass("SwigDelegateGetDeploymentCompleteDelegateWrapper_0");
            return clazz;
        }
