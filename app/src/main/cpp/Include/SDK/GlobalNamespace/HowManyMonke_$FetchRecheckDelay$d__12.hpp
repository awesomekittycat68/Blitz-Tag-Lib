...
namespace GlobalNamespace {
    struct HowManyMonke_$FetchRecheckDelay$d__12 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "HowManyMonke").GetInnerClass("<FetchRecheckDelay>d__12");
            return clazz;
        }
