...
namespace GlobalNamespace {
    struct MetaAuthenticator_$$c__DisplayClass22_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MetaAuthenticator").GetInnerClass("<>c__DisplayClass22_0");
            return clazz;
        }
