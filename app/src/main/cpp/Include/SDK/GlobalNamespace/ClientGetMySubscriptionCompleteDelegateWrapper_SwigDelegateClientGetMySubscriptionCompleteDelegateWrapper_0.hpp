...
namespace GlobalNamespace {
    struct ClientGetMySubscriptionCompleteDelegateWrapper_SwigDelegateClientGetMySubscriptionCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ClientGetMySubscriptionCompleteDelegateWrapper").GetInnerClass("SwigDelegateClientGetMySubscriptionCompleteDelegateWrapper_0");
            return clazz;
        }
