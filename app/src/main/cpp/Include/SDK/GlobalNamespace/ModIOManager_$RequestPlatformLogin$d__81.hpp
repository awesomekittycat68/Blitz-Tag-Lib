...
namespace GlobalNamespace {
    struct ModIOManager_$RequestPlatformLogin$d__81 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ModIOManager").GetInnerClass("<RequestPlatformLogin>d__81");
            return clazz;
        }
