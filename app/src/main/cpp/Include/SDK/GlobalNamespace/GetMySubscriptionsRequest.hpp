...
namespace GlobalNamespace {
    struct GetMySubscriptionsRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetMySubscriptionsRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::GetMySubscriptionsRequest* obj) {
            static BNM::Method<void*> _m = GetClass().GetMethod(O("getCPtr"), {"obj"});
            return _m.Call(obj);
        }
        static void* swigRelease(::GlobalNamespace::GetMySubscriptionsRequest* obj) {
