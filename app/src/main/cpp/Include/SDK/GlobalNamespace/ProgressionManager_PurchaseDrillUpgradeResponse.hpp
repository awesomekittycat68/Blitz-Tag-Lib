...
namespace GlobalNamespace {
    struct ProgressionManager_PurchaseDrillUpgradeResponse : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ProgressionManager").GetInnerClass("PurchaseDrillUpgradeResponse");
            return clazz;
        }
