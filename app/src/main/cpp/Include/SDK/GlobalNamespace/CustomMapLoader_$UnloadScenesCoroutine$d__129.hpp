...
namespace GlobalNamespace {
    struct CustomMapLoader_$UnloadScenesCoroutine$d__129 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CustomMapLoader").GetInnerClass("<UnloadScenesCoroutine>d__129");
            return clazz;
        }
