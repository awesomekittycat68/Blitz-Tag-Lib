...
namespace GlobalNamespace {
    struct CustomMapLoader_$ProcessChildObjects$d__107 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CustomMapLoader").GetInnerClass("<ProcessChildObjects>d__107");
            return clazz;
        }
        ...
        ::GameObject* GetParent() {
            static BNM::Field<::GameObject*> _field = GetClass().GetField(O("parent"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
