...
namespace GlobalNamespace {
    struct DeleteUserDataMetadataCompleteDelegateWrapper_SwigDelegateDeleteUserDataMetadataCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteUserDataMetadataCompleteDelegateWrapper").GetInnerClass("SwigDelegateDeleteUserDataMetadataCompleteDelegateWrapper_0");
            return clazz;
        }
