...
namespace GlobalNamespace {
    struct UpdateEnvRequiredTagsResponse : ::GlobalNamespace::MothershipResponse {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateEnvRequiredTagsResponse");
            return clazz;
        }
        ...
        static ::GlobalNamespace::UpdateEnvRequiredTagsResponse* FromMothershipResponse(::GlobalNamespace::MothershipResponse* response) {
            static BNM::Method<::GlobalNamespace::UpdateEnvRequiredTagsResponse*> _m = GetClass().GetMethod(O("FromMothershipResponse"), {"response"});
        ...
        static void* getCPtr(::GlobalNamespace::UpdateEnvRequiredTagsResponse* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::UpdateEnvRequiredTagsResponse* obj) {
