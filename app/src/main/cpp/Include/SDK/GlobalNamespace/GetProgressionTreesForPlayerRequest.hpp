...
namespace GlobalNamespace {
    struct GetProgressionTreesForPlayerRequest : ::GlobalNamespace::MothershipRequestShared {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetProgressionTreesForPlayerRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::GetProgressionTreesForPlayerRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::GetProgressionTreesForPlayerRequest* obj) {
