...
namespace GlobalNamespace {
    struct LockProgressionTreeNodeRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "LockProgressionTreeNodeRequest");
            return clazz;
        }
        ...
        ::BNM::Structures::Mono::String* GetNodeId() {
            static BNM::Method<::BNM::Structures::Mono::String*> _method = GetClass().GetMethod(O("get_node_id"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _method.Call();
        }
        void SetNodeId(::BNM::Structures::Mono::String* value) {
            static BNM::Method<void> _method = GetClass().GetMethod(O("set_node_id"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _method.Call(value);
        }
        bool GetRefundCosts() {
            static BNM::Method<bool> _method = GetClass().GetMethod(O("get_refund_costs"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _method.Call();
        }
        void SetRefundCosts(bool value) {
            static BNM::Method<void> _method = GetClass().GetMethod(O("set_refund_costs"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _method.Call(value);
        }
        bool GetRewindRewards() {
            static BNM::Method<bool> _method = GetClass().GetMethod(O("get_rewind_rewards"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _method.Call();
        }
        void SetRewindRewards(bool value) {
            static BNM::Method<void> _method = GetClass().GetMethod(O("set_rewind_rewards"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _method.Call(value);
        }
        ...
        ::BNM::Structures::Mono::String* get_node_id() {
            static BNM::Method<::BNM::Structures::Mono::String*> _m = GetClass().GetMethod(O("get_node_id"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call();
        }
        bool get_refund_costs() {
            static BNM::Method<bool> _m = GetClass().GetMethod(O("get_refund_costs"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call();
        }
        bool get_rewind_rewards() {
            static BNM::Method<bool> _m = GetClass().GetMethod(O("get_rewind_rewards"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call();
        }
        ...
        static void* getCPtr(::GlobalNamespace::LockProgressionTreeNodeRequest* obj) {
        ...
        void set_node_id(::BNM::Structures::Mono::String* value) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("set_node_id"), {"value"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(value);
        }
        void set_refund_costs(bool value) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("set_refund_costs"), {"value"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(value);
        }
        void set_rewind_rewards(bool value) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("set_rewind_rewards"), {"value"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(value);
        }
        ...
        static void* swigRelease(::GlobalNamespace::LockProgressionTreeNodeRequest* obj) {
