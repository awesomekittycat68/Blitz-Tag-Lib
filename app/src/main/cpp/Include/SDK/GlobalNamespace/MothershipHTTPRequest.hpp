...
namespace GlobalNamespace {
    struct MothershipHTTPRequest : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipHTTPRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::MothershipHTTPRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::MothershipHTTPRequest* obj) {
