...
namespace GlobalNamespace {
    struct GetPlayerAccountLinksResponse : ::GlobalNamespace::MothershipResponse {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetPlayerAccountLinksResponse");
            return clazz;
        }
        ...
        static ::GlobalNamespace::GetPlayerAccountLinksResponse* FromMothershipResponse(::GlobalNamespace::MothershipResponse* response) {
            static BNM::Method<::GlobalNamespace::GetPlayerAccountLinksResponse*> _m = GetClass().GetMethod(O("FromMothershipResponse"), {"response"});
        ...
        static void* getCPtr(::GlobalNamespace::GetPlayerAccountLinksResponse* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::GetPlayerAccountLinksResponse* obj) {
