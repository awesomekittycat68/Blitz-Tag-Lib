...
namespace GlobalNamespace {
    struct GetUserInventoryCompleteAutomationDelegateWrapper_SwigDelegateGetUserInventoryCompleteAutomationDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetUserInventoryCompleteAutomationDelegateWrapper").GetInnerClass("SwigDelegateGetUserInventoryCompleteAutomationDelegateWrapper_0");
            return clazz;
        }
