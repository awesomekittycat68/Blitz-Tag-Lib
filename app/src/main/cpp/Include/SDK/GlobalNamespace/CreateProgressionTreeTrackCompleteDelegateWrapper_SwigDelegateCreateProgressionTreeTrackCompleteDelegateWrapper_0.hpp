...
namespace GlobalNamespace {
    struct CreateProgressionTreeTrackCompleteDelegateWrapper_SwigDelegateCreateProgressionTreeTrackCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateProgressionTreeTrackCompleteDelegateWrapper").GetInnerClass("SwigDelegateCreateProgressionTreeTrackCompleteDelegateWrapper_0");
            return clazz;
        }
