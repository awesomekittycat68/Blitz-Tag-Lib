...
namespace GlobalNamespace {
    struct OfferEntitlementMap_OfferEntitlementMapEnumerator : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "OfferEntitlementMap").GetInnerClass("OfferEntitlementMapEnumerator");
            return clazz;
        }

        static BNM::MonoType* GetType() { return GetClass().GetMonoType(); }

        ::GlobalNamespace::OfferEntitlementMap* GetCollectionRef() {
            static BNM::Field<::GlobalNamespace::OfferEntitlementMap*> _field = GetClass().GetField(O("collectionRef"));
        ...
        void SetCollectionRef(::GlobalNamespace::OfferEntitlementMap* value) {
            static BNM::Field<::GlobalNamespace::OfferEntitlementMap*> _field = GetClass().GetField(O("collectionRef"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
