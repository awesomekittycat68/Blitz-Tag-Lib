...
namespace GlobalNamespace {
    struct NetworkSystemPUN_$TryCreateRoom$d__65 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "NetworkSystemPUN").GetInnerClass("<TryCreateRoom>d__65");
            return clazz;
        }
