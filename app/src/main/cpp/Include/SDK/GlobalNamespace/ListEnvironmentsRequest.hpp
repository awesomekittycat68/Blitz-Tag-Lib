...
namespace GlobalNamespace {
    struct ListEnvironmentsRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListEnvironmentsRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::ListEnvironmentsRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::ListEnvironmentsRequest* obj) {
