...
namespace GlobalNamespace {
    struct ListClientMothershipTitleDataRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListClientMothershipTitleDataRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::ListClientMothershipTitleDataRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::ListClientMothershipTitleDataRequest* obj) {
