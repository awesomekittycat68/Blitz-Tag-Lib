...
namespace GlobalNamespace {
    struct MothershipWriteEventsRequest : ::GlobalNamespace::MothershipRequestShared {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipWriteEventsRequest");
            return clazz;
        }
        ...
        ::GlobalNamespace::AnalyticsRequestVector* GetEvents() {
            static BNM::Method<::GlobalNamespace::AnalyticsRequestVector*> _method = GetClass().GetMethod(O("get_events"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _method.Call();
        }
        void SetEvents(::GlobalNamespace::AnalyticsRequestVector* value) {
            static BNM::Method<void> _method = GetClass().GetMethod(O("set_events"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _method.Call(value);
        }
        ...
        ::GlobalNamespace::AnalyticsRequestVector* get_events() {
            static BNM::Method<::GlobalNamespace::AnalyticsRequestVector*> _m = GetClass().GetMethod(O("get_events"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call();
        }
        ...
        static void* getCPtr(::GlobalNamespace::MothershipWriteEventsRequest* obj) {
        ...
        void set_events(::GlobalNamespace::AnalyticsRequestVector* value) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("set_events"), {"value"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(value);
        }
        ...
        static void* swigRelease(::GlobalNamespace::MothershipWriteEventsRequest* obj) {
