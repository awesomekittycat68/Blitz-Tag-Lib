...
namespace GlobalNamespace {
    struct GetLastTransactionCompleteAutomationDelegateWrapper_SwigDelegateGetLastTransactionCompleteAutomationDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetLastTransactionCompleteAutomationDelegateWrapper").GetInnerClass("SwigDelegateGetLastTransactionCompleteAutomationDelegateWrapper_0");
            return clazz;
        }
