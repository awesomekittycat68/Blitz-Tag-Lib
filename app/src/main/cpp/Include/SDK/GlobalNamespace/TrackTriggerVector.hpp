...
namespace GlobalNamespace {
    struct TrackTriggerVector : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "TrackTriggerVector");
            return clazz;
        }
        ...
        ::GlobalNamespace::TriggerDefinition* GetItem() {
            static BNM::Method<::GlobalNamespace::TriggerDefinition*> _method = GetClass().GetMethod(O("get_Item"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _method.Call();
        }
        void SetItem(::GlobalNamespace::TriggerDefinition* value) {
        ...
        void Add(::GlobalNamespace::TriggerDefinition* x) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("Add"), {"x"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(x);
        }
        void AddRange(::GlobalNamespace::TrackTriggerVector* values) {
        ...
        void CopyTo(::BNM::Structures::Mono::Array<::GlobalNamespace::TriggerDefinition*>* array) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("CopyTo"), {"array"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(array);
        }
        void CopyTo(::BNM::Structures::Mono::Array<::GlobalNamespace::TriggerDefinition*>* array, int arrayIndex) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("CopyTo"), {"array", "arrayIndex"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(array, arrayIndex);
        }
        void CopyTo(int index, ::BNM::Structures::Mono::Array<::GlobalNamespace::TriggerDefinition*>* array, int arrayIndex, int count) {
        ...
        ::GlobalNamespace::TriggerDefinition* get_Item(int index) {
            static BNM::Method<::GlobalNamespace::TriggerDefinition*> _m = GetClass().GetMethod(O("get_Item"), {"index"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call(index);
        }
        static void* getCPtr(::GlobalNamespace::TrackTriggerVector* obj) {
            static BNM::Method<void*> _m = GetClass().GetMethod(O("getCPtr"), {"obj"});
            return _m.Call(obj);
        }
        ::GlobalNamespace::TrackTriggerVector_TrackTriggerVectorEnumerator* GetEnumerator() {
            static BNM::Method<::GlobalNamespace::TrackTriggerVector_TrackTriggerVectorEnumerator*> _m = GetClass().GetMethod(O("GetEnumerator"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call();
        }
        ::GlobalNamespace::TriggerDefinition* getitem(int index) {
            static BNM::Method<::GlobalNamespace::TriggerDefinition*> _m = GetClass().GetMethod(O("getitem"), {"index"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call(index);
        }
        ::GlobalNamespace::TriggerDefinition* getitemcopy(int index) {
            static BNM::Method<::GlobalNamespace::TriggerDefinition*> _m = GetClass().GetMethod(O("getitemcopy"), {"index"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call(index);
        }
        ::GlobalNamespace::TrackTriggerVector* GetRange(int index, int count) {
            static BNM::Method<::GlobalNamespace::TrackTriggerVector*> _m = GetClass().GetMethod(O("GetRange"), {"index", "count"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call(index, count);
        }
        void Insert(int index, ::GlobalNamespace::TriggerDefinition* x) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("Insert"), {"index", "x"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(index, x);
        }
        void InsertRange(int index, ::GlobalNamespace::TrackTriggerVector* values) {
        ...
        static ::GlobalNamespace::TrackTriggerVector* Repeat(::GlobalNamespace::TriggerDefinition* value, int count) {
            static BNM::Method<::GlobalNamespace::TrackTriggerVector*> _m = GetClass().GetMethod(O("Repeat"), {"value", "count"});
        ...
        void set_Item(int index, ::GlobalNamespace::TriggerDefinition* value) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("set_Item"), {"index", "value"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(index, value);
        }
        void setitem(int index, ::GlobalNamespace::TriggerDefinition* val) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("setitem"), {"index", "val"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(index, val);
        }
        void SetRange(int index, ::GlobalNamespace::TrackTriggerVector* values) {
        ...
        static void* swigRelease(::GlobalNamespace::TrackTriggerVector* obj) {
            static BNM::Method<void*> _m = GetClass().GetMethod(O("swigRelease"), {"obj"});
            return _m.Call(obj);
        }
        ::BNM::Structures::Mono::Array<::GlobalNamespace::TriggerDefinition*>* ToArray() {
            static BNM::Method<::BNM::Structures::Mono::Array<::GlobalNamespace::TriggerDefinition*>*> _m = GetClass().GetMethod(O("ToArray"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call();
        }
    };
