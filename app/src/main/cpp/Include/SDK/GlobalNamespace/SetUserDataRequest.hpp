...
namespace GlobalNamespace {
    struct SetUserDataRequest : ::GlobalNamespace::MothershipRequestShared {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "SetUserDataRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::SetUserDataRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::SetUserDataRequest* obj) {
