...
namespace GlobalNamespace {
    struct CreateProgressionTreeNodeRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateProgressionTreeNodeRequest");
            return clazz;
        }
        ...
        ::GlobalNamespace::TreeNodeDefinition* GetNodeDefinition() {
            static BNM::Method<::GlobalNamespace::TreeNodeDefinition*> _method = GetClass().GetMethod(O("get_nodeDefinition"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _method.Call();
        }
        void SetNodeDefinition(::GlobalNamespace::TreeNodeDefinition* value) {
            static BNM::Method<void> _method = GetClass().GetMethod(O("set_nodeDefinition"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _method.Call(value);
        }
        ...
        ::GlobalNamespace::TreeNodeDefinition* get_nodeDefinition() {
            static BNM::Method<::GlobalNamespace::TreeNodeDefinition*> _m = GetClass().GetMethod(O("get_nodeDefinition"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call();
        }
        ...
        static void* getCPtr(::GlobalNamespace::CreateProgressionTreeNodeRequest* obj) {
        ...
        void set_nodeDefinition(::GlobalNamespace::TreeNodeDefinition* value) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("set_nodeDefinition"), {"value"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(value);
        }
        ...
        static void* swigRelease(::GlobalNamespace::CreateProgressionTreeNodeRequest* obj) {
