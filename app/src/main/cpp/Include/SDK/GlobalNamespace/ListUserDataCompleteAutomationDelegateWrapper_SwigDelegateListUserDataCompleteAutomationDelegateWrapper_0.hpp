...
namespace GlobalNamespace {
    struct ListUserDataCompleteAutomationDelegateWrapper_SwigDelegateListUserDataCompleteAutomationDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListUserDataCompleteAutomationDelegateWrapper").GetInnerClass("SwigDelegateListUserDataCompleteAutomationDelegateWrapper_0");
            return clazz;
        }
