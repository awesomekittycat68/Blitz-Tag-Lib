...
namespace GlobalNamespace {
    struct ListUsersCompleteDelegateWrapper_SwigDelegateListUsersCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListUsersCompleteDelegateWrapper").GetInnerClass("SwigDelegateListUsersCompleteDelegateWrapper_0");
            return clazz;
        }
