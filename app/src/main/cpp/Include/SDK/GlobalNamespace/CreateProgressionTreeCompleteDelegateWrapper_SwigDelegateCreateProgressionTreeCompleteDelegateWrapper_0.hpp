...
namespace GlobalNamespace {
    struct CreateProgressionTreeCompleteDelegateWrapper_SwigDelegateCreateProgressionTreeCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateProgressionTreeCompleteDelegateWrapper").GetInnerClass("SwigDelegateCreateProgressionTreeCompleteDelegateWrapper_0");
            return clazz;
        }
