...
namespace GlobalNamespace {
    struct TempMask : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "TempMask");
            return clazz;
        }
        ...
        void* GetDayOn() {
            static BNM::Field<void*> _field = GetClass().GetField(O("dayOn"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        int GetMonth() {
        ...
        void* GetMyDate() {
            static BNM::Field<void*> _field = GetClass().GetField(O("myDate"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        ::BNM::Coroutine::IEnumerator* MaskOnDuringDate() {
            static BNM::Method<::BNM::Coroutine::IEnumerator*> _m = GetClass().GetMethod(O("MaskOnDuringDate"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call();
        }
        void OnDisable() {
