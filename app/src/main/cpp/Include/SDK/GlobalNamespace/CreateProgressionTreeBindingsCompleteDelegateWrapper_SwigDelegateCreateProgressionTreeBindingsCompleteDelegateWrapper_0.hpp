...
namespace GlobalNamespace {
    struct CreateProgressionTreeBindingsCompleteDelegateWrapper_SwigDelegateCreateProgressionTreeBindingsCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateProgressionTreeBindingsCompleteDelegateWrapper").GetInnerClass("SwigDelegateCreateProgressionTreeBindingsCompleteDelegateWrapper_0");
            return clazz;
        }
