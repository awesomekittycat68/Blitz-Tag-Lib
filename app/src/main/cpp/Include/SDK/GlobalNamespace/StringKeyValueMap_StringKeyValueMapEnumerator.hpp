...
namespace GlobalNamespace {
    struct StringKeyValueMap_StringKeyValueMapEnumerator : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "StringKeyValueMap").GetInnerClass("StringKeyValueMapEnumerator");
            return clazz;
        }

        static BNM::MonoType* GetType() { return GetClass().GetMonoType(); }

        ::GlobalNamespace::StringKeyValueMap* GetCollectionRef() {
            static BNM::Field<::GlobalNamespace::StringKeyValueMap*> _field = GetClass().GetField(O("collectionRef"));
        ...
        void SetCollectionRef(::GlobalNamespace::StringKeyValueMap* value) {
            static BNM::Field<::GlobalNamespace::StringKeyValueMap*> _field = GetClass().GetField(O("collectionRef"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
