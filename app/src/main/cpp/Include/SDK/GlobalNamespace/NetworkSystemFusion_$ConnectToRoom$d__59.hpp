...
namespace GlobalNamespace {
    struct NetworkSystemFusion_$ConnectToRoom$d__59 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "NetworkSystemFusion").GetInnerClass("<ConnectToRoom>d__59");
            return clazz;
        }
