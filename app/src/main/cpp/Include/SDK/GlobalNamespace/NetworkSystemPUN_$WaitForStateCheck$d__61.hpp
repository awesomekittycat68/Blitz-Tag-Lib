...
namespace GlobalNamespace {
    struct NetworkSystemPUN_$WaitForStateCheck$d__61 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "NetworkSystemPUN").GetInnerClass("<WaitForStateCheck>d__61");
            return clazz;
        }
