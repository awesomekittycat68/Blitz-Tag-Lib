...
namespace GlobalNamespace {
    struct StringIntMap_StringIntMapEnumerator : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "StringIntMap").GetInnerClass("StringIntMapEnumerator");
            return clazz;
        }

        static BNM::MonoType* GetType() { return GetClass().GetMonoType(); }

        ::GlobalNamespace::StringIntMap* GetCollectionRef() {
            static BNM::Field<::GlobalNamespace::StringIntMap*> _field = GetClass().GetField(O("collectionRef"));
        ...
        void SetCollectionRef(::GlobalNamespace::StringIntMap* value) {
            static BNM::Field<::GlobalNamespace::StringIntMap*> _field = GetClass().GetField(O("collectionRef"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
