...
namespace GlobalNamespace {
    struct FusionCallbackHandler_$RemoveCallbacks$d__3 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "FusionCallbackHandler").GetInnerClass("<RemoveCallbacks>d__3");
            return clazz;
        }
