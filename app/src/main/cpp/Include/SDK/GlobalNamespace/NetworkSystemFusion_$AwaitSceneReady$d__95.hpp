...
namespace GlobalNamespace {
    struct NetworkSystemFusion_$AwaitSceneReady$d__95 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "NetworkSystemFusion").GetInnerClass("<AwaitSceneReady>d__95");
            return clazz;
        }
