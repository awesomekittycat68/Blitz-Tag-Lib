...
namespace GlobalNamespace {
    struct NetworkSystemPUN_$InternalDisconnect$d__72 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "NetworkSystemPUN").GetInnerClass("<InternalDisconnect>d__72");
            return clazz;
        }
