...
namespace GlobalNamespace {
    struct GetProgressionTrackValuesForPlayerCompleteServerDelegateWrapper_SwigDelegateGetProgressionTrackValuesForPlayerCompleteServerDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetProgressionTrackValuesForPlayerCompleteServerDelegateWrapper").GetInnerClass("SwigDelegateGetProgressionTrackValuesForPlayerCompleteServerDelegateWrapper_0");
            return clazz;
        }
