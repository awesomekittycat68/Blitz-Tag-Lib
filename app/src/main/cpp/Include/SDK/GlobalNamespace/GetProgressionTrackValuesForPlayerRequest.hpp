...
namespace GlobalNamespace {
    struct GetProgressionTrackValuesForPlayerRequest : ::GlobalNamespace::MothershipRequestShared {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetProgressionTrackValuesForPlayerRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::GetProgressionTrackValuesForPlayerRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::GetProgressionTrackValuesForPlayerRequest* obj) {
