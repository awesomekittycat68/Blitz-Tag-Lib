...
namespace GlobalNamespace {
    struct CreateTrackLevelRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateTrackLevelRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::CreateTrackLevelRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::CreateTrackLevelRequest* obj) {
