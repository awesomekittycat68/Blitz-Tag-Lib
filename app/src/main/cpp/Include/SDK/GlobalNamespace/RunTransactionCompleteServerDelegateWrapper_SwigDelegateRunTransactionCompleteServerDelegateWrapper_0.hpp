...
namespace GlobalNamespace {
    struct RunTransactionCompleteServerDelegateWrapper_SwigDelegateRunTransactionCompleteServerDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "RunTransactionCompleteServerDelegateWrapper").GetInnerClass("SwigDelegateRunTransactionCompleteServerDelegateWrapper_0");
            return clazz;
        }
