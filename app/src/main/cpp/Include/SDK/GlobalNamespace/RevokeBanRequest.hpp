...
namespace GlobalNamespace {
    struct RevokeBanRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "RevokeBanRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::RevokeBanRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::RevokeBanRequest* obj) {
