...
namespace GlobalNamespace {
    struct NetworkSystemPUN_$AwaitSceneReady$d__87 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "NetworkSystemPUN").GetInnerClass("<AwaitSceneReady>d__87");
            return clazz;
        }
