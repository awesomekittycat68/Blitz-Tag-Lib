...
namespace GlobalNamespace {
    struct GetUserInventoryCompleteClientDelegateWrapper_SwigDelegateGetUserInventoryCompleteClientDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetUserInventoryCompleteClientDelegateWrapper").GetInnerClass("SwigDelegateGetUserInventoryCompleteClientDelegateWrapper_0");
            return clazz;
        }
