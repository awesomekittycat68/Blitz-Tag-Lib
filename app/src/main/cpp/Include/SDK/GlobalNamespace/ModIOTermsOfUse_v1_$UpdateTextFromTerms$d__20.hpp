...
namespace GlobalNamespace {
    struct ModIOTermsOfUse_v1_$UpdateTextFromTerms$d__20 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ModIOTermsOfUse_v1").GetInnerClass("<UpdateTextFromTerms>d__20");
            return clazz;
        }
