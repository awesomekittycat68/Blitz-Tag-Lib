...
namespace GlobalNamespace {
    struct GetEntitlementCatalogItemCompleteDelegateWrapper_SwigDelegateGetEntitlementCatalogItemCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetEntitlementCatalogItemCompleteDelegateWrapper").GetInnerClass("SwigDelegateGetEntitlementCatalogItemCompleteDelegateWrapper_0");
            return clazz;
        }
