...
namespace GlobalNamespace {
    struct UpdateEnvRequiredTagsCompleteDelegateWrapper_SwigDelegateUpdateEnvRequiredTagsCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateEnvRequiredTagsCompleteDelegateWrapper").GetInnerClass("SwigDelegateUpdateEnvRequiredTagsCompleteDelegateWrapper_0");
            return clazz;
        }
