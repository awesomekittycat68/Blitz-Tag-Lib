...
namespace GlobalNamespace {
    struct ExplicitAccountLinkCompleteDelegateWrapper_SwigDelegateExplicitAccountLinkCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ExplicitAccountLinkCompleteDelegateWrapper").GetInnerClass("SwigDelegateExplicitAccountLinkCompleteDelegateWrapper_0");
            return clazz;
        }
