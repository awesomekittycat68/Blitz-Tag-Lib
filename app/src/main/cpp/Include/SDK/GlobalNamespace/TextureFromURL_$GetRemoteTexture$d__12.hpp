...
namespace GlobalNamespace {
    struct TextureFromURL_$GetRemoteTexture$d__12 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "TextureFromURL").GetInnerClass("<GetRemoteTexture>d__12");
            return clazz;
        }
