...
namespace GlobalNamespace {
    struct KIDMessagingController_$$c__DisplayClass21_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "KIDMessagingController").GetInnerClass("<>c__DisplayClass21_0");
            return clazz;
        }
