...
namespace GlobalNamespace {
    struct PlayerSteamBeginLoginResponse : ::GlobalNamespace::MothershipResponse {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "PlayerSteamBeginLoginResponse");
            return clazz;
        }
        ...
        static ::GlobalNamespace::PlayerSteamBeginLoginResponse* FromMothershipResponse(::GlobalNamespace::MothershipResponse* response) {
            static BNM::Method<::GlobalNamespace::PlayerSteamBeginLoginResponse*> _m = GetClass().GetMethod(O("FromMothershipResponse"), {"response"});
        ...
        static void* getCPtr(::GlobalNamespace::PlayerSteamBeginLoginResponse* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::PlayerSteamBeginLoginResponse* obj) {
