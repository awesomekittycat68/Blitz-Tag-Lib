...
namespace GlobalNamespace {
    struct GetPlayerAccountLinksRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetPlayerAccountLinksRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::GetPlayerAccountLinksRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::GetPlayerAccountLinksRequest* obj) {
