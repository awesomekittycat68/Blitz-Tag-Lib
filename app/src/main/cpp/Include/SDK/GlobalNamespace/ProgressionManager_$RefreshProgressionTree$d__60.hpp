...
namespace GlobalNamespace {
    struct ProgressionManager_$RefreshProgressionTree$d__60 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ProgressionManager").GetInnerClass("<RefreshProgressionTree>d__60");
            return clazz;
        }
