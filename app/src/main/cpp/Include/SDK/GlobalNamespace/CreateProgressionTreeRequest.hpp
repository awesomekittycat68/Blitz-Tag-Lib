...
namespace GlobalNamespace {
    struct CreateProgressionTreeRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateProgressionTreeRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::CreateProgressionTreeRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::CreateProgressionTreeRequest* obj) {
