...
namespace GlobalNamespace {
    ...
    struct PhotonSignal$1 : ::GlobalNamespace::PhotonSignal {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "PhotonSignal`1");
            return clazz;
        }
        ...
        void Raise(T1 arg1) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("Raise"), {"arg1"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(arg1);
        }
        void Raise(::Photon_Realtime::ReceiverGroup receivers, T1 arg1) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("Raise"), {"receivers", "arg1"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(receivers, arg1);
        }
    };
}
