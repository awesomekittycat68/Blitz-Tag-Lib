...
namespace GlobalNamespace {
    struct ListProgressionTreesCompleteDelegateWrapper_SwigDelegateListProgressionTreesCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListProgressionTreesCompleteDelegateWrapper").GetInnerClass("SwigDelegateListProgressionTreesCompleteDelegateWrapper_0");
            return clazz;
        }
