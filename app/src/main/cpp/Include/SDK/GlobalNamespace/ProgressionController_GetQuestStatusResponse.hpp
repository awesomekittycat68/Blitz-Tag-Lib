...
namespace GlobalNamespace {
    struct ProgressionController_GetQuestStatusResponse : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ProgressionController").GetInnerClass("GetQuestStatusResponse");
            return clazz;
        }
