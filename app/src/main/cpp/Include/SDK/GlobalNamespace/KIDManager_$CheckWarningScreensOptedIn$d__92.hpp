...
namespace GlobalNamespace {
    struct KIDManager_$CheckWarningScreensOptedIn$d__92 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "KIDManager").GetInnerClass("<CheckWarningScreensOptedIn>d__92");
            return clazz;
        }
