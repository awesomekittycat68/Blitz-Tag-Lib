...
namespace GlobalNamespace {
    struct MothershipEntitlementCatalogItem : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipEntitlementCatalogItem");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::MothershipEntitlementCatalogItem* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::MothershipEntitlementCatalogItem* obj) {
            static BNM::Method<void*> _m = GetClass().GetMethod(O("swigRelease"), {"obj"});
            return _m.Call(obj);
        }
        bool ToJson(::GlobalNamespace::SWIGTYPE_p_rapidjson__Value* catalogItem, ::GlobalNamespace::SWIGTYPE_p_rapidjson__Document* body) {
            static BNM::Method<bool> _m = GetClass().GetMethod(O("ToJson"), {"catalogItem", "body"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call(catalogItem, body);
        }
    };
}
