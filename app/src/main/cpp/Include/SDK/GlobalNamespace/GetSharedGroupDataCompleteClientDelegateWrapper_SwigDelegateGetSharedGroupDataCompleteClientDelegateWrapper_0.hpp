...
namespace GlobalNamespace {
    struct GetSharedGroupDataCompleteClientDelegateWrapper_SwigDelegateGetSharedGroupDataCompleteClientDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetSharedGroupDataCompleteClientDelegateWrapper").GetInnerClass("SwigDelegateGetSharedGroupDataCompleteClientDelegateWrapper_0");
            return clazz;
        }
