...
namespace GlobalNamespace {
    struct WaterSurfaceMaterialController : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "WaterSurfaceMaterialController");
            return clazz;
        }
        ...
        float GetScrollX() {
            static BNM::Field<float> _field = GetClass().GetField(O("ScrollX"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        float GetScrollY() {
            static BNM::Field<float> _field = GetClass().GetField(O("ScrollY"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void ApplyProperties() {
            static BNM::Method<void> _m = GetClass().GetMethod(O("ApplyProperties"));
