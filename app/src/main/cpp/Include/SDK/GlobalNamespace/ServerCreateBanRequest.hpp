...
namespace GlobalNamespace {
    struct ServerCreateBanRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ServerCreateBanRequest");
            return clazz;
        }
        ...
        bool GetIsHardwareBan() {
            static BNM::Method<bool> _method = GetClass().GetMethod(O("get_is_hardware_ban"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _method.Call();
        }
        void SetIsHardwareBan(bool value) {
            static BNM::Method<void> _method = GetClass().GetMethod(O("set_is_hardware_ban"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _method.Call(value);
        }
        ...
        bool get_is_hardware_ban() {
            static BNM::Method<bool> _m = GetClass().GetMethod(O("get_is_hardware_ban"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call();
        }
        ...
        static void* getCPtr(::GlobalNamespace::ServerCreateBanRequest* obj) {
        ...
        void set_is_hardware_ban(bool value) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("set_is_hardware_ban"), {"value"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(value);
        }
        ...
        static void* swigRelease(::GlobalNamespace::ServerCreateBanRequest* obj) {
