...
namespace GlobalNamespace {
    struct ListBansBulkCompleteDelegateWrapper_SwigDelegateListBansBulkCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListBansBulkCompleteDelegateWrapper").GetInnerClass("SwigDelegateListBansBulkCompleteDelegateWrapper_0");
            return clazz;
        }
