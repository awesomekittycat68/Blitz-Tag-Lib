...
namespace GlobalNamespace {
    struct UpdateTransactionCatalogItemSunsetStatusResponse : ::GlobalNamespace::MothershipResponse {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateTransactionCatalogItemSunsetStatusResponse");
            return clazz;
        }
        ...
        static ::GlobalNamespace::UpdateTransactionCatalogItemSunsetStatusResponse* FromMothershipResponse(::GlobalNamespace::MothershipResponse* response) {
            static BNM::Method<::GlobalNamespace::UpdateTransactionCatalogItemSunsetStatusResponse*> _m = GetClass().GetMethod(O("FromMothershipResponse"), {"response"});
        ...
        static void* getCPtr(::GlobalNamespace::UpdateTransactionCatalogItemSunsetStatusResponse* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::UpdateTransactionCatalogItemSunsetStatusResponse* obj) {
