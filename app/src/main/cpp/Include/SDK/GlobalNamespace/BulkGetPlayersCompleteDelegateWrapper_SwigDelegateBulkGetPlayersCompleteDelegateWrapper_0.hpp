...
namespace GlobalNamespace {
    struct BulkGetPlayersCompleteDelegateWrapper_SwigDelegateBulkGetPlayersCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "BulkGetPlayersCompleteDelegateWrapper").GetInnerClass("SwigDelegateBulkGetPlayersCompleteDelegateWrapper_0");
            return clazz;
        }
