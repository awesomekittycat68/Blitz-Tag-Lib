...
namespace GlobalNamespace {
    struct IncrementProgressionTrackForPlayerCompleteServerDelegateWrapper_SwigDelegateIncrementProgressionTrackForPlayerCompleteServerDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "IncrementProgressionTrackForPlayerCompleteServerDelegateWrapper").GetInnerClass("SwigDelegateIncrementProgressionTrackForPlayerCompleteServerDelegateWrapper_0");
            return clazz;
        }
