...
namespace GlobalNamespace {
    struct LegalAgreements_$StartLegalAgreements$d__24 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "LegalAgreements").GetInnerClass("<StartLegalAgreements>d__24");
            return clazz;
        }
