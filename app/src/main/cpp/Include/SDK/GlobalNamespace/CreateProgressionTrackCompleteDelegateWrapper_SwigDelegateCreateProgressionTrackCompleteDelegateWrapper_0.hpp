...
namespace GlobalNamespace {
    struct CreateProgressionTrackCompleteDelegateWrapper_SwigDelegateCreateProgressionTrackCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateProgressionTrackCompleteDelegateWrapper").GetInnerClass("SwigDelegateCreateProgressionTrackCompleteDelegateWrapper_0");
            return clazz;
        }
