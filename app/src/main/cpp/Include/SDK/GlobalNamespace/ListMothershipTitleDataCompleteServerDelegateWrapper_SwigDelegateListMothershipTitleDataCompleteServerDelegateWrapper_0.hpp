...
namespace GlobalNamespace {
    struct ListMothershipTitleDataCompleteServerDelegateWrapper_SwigDelegateListMothershipTitleDataCompleteServerDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListMothershipTitleDataCompleteServerDelegateWrapper").GetInnerClass("SwigDelegateListMothershipTitleDataCompleteServerDelegateWrapper_0");
            return clazz;
        }
