...
namespace GlobalNamespace {
    struct GetUserDataMetadataRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetUserDataMetadataRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::GetUserDataMetadataRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::GetUserDataMetadataRequest* obj) {
