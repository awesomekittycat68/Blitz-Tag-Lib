...
namespace GlobalNamespace {
    struct CreateOfferCatalogItemCompleteDelegateWrapper_SwigDelegateCreateOfferCatalogItemCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateOfferCatalogItemCompleteDelegateWrapper").GetInnerClass("SwigDelegateCreateOfferCatalogItemCompleteDelegateWrapper_0");
            return clazz;
        }
