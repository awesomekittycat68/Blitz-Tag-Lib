...
namespace GlobalNamespace {
    struct ServerGetBulkSubscriptionsCompleteDelegateWrapper_SwigDelegateServerGetBulkSubscriptionsCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ServerGetBulkSubscriptionsCompleteDelegateWrapper").GetInnerClass("SwigDelegateServerGetBulkSubscriptionsCompleteDelegateWrapper_0");
            return clazz;
        }
