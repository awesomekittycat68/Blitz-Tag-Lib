...
namespace GlobalNamespace {
    struct AccountLinkLookupEntry : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "AccountLinkLookupEntry");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::AccountLinkLookupEntry* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::AccountLinkLookupEntry* obj) {
