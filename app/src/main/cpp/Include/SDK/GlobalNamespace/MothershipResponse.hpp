...
namespace GlobalNamespace {
    struct MothershipResponse : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipResponse");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::MothershipResponse* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::MothershipResponse* obj) {
