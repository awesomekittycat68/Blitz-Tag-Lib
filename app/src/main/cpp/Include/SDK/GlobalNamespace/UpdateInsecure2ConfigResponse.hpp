...
namespace GlobalNamespace {
    struct UpdateInsecure2ConfigResponse : ::GlobalNamespace::MothershipResponse {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateInsecure2ConfigResponse");
            return clazz;
        }
        ...
        static ::GlobalNamespace::UpdateInsecure2ConfigResponse* FromMothershipResponse(::GlobalNamespace::MothershipResponse* response) {
            static BNM::Method<::GlobalNamespace::UpdateInsecure2ConfigResponse*> _m = GetClass().GetMethod(O("FromMothershipResponse"), {"response"});
        ...
        static void* getCPtr(::GlobalNamespace::UpdateInsecure2ConfigResponse* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::UpdateInsecure2ConfigResponse* obj) {
