...
namespace GlobalNamespace {
    struct UpdateProgressionTreeBindingsRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateProgressionTreeBindingsRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::UpdateProgressionTreeBindingsRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::UpdateProgressionTreeBindingsRequest* obj) {
