...
namespace GlobalNamespace {
    struct DeleteUserDataCompleteAutomationDelegateWrapper_SwigDelegateDeleteUserDataCompleteAutomationDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteUserDataCompleteAutomationDelegateWrapper").GetInnerClass("SwigDelegateDeleteUserDataCompleteAutomationDelegateWrapper_0");
            return clazz;
        }
