...
namespace GlobalNamespace {
    struct PoseStiffnessComparison : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "PoseStiffnessComparison");
            return clazz;
        }
        ...
        float GetMYA() {
            static BNM::Field<float> _field = GetClass().GetField(O("m_yA"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        float GetMYB() {
            static BNM::Field<float> _field = GetClass().GetField(O("m_yB"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        float GetPeriod() {
        ...
        void SetMYA(float value) {
            static BNM::Field<float> _field = GetClass().GetField(O("m_yA"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        void SetMYB(float value) {
            static BNM::Field<float> _field = GetClass().GetField(O("m_yB"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
