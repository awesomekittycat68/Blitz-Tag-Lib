...
namespace GlobalNamespace {
    struct UpdateRiftConfigCompleteDelegateWrapper_SwigDelegateUpdateRiftConfigCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateRiftConfigCompleteDelegateWrapper").GetInnerClass("SwigDelegateUpdateRiftConfigCompleteDelegateWrapper_0");
            return clazz;
        }
