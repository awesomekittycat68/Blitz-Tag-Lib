...
namespace GlobalNamespace {
    struct ProgressionManager_$GetActiveSIQuests$d__72 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ProgressionManager").GetInnerClass("<GetActiveSIQuests>d__72");
            return clazz;
        }
