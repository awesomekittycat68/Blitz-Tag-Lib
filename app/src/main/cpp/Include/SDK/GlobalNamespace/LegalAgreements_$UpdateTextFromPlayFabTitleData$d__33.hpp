...
namespace GlobalNamespace {
    struct LegalAgreements_$UpdateTextFromPlayFabTitleData$d__33 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "LegalAgreements").GetInnerClass("<UpdateTextFromPlayFabTitleData>d__33");
            return clazz;
        }
        ...
        ::BNM::Structures::Mono::String* GetKey() {
            static BNM::Field<::BNM::Structures::Mono::String*> _field = GetClass().GetField(O("key"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ::TMP_Text* GetTarget() {
            static BNM::Field<::TMP_Text*> _field = GetClass().GetField(O("target"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
