...
namespace GlobalNamespace {
    struct MonkeVoteController_$WaitForSessionToken$d__35 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MonkeVoteController").GetInnerClass("<WaitForSessionToken>d__35");
            return clazz;
        }
