...
namespace GlobalNamespace {
    struct NetworkSystemPUN_$OnDisconnected$d__116 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "NetworkSystemPUN").GetInnerClass("<OnDisconnected>d__116");
            return clazz;
        }
