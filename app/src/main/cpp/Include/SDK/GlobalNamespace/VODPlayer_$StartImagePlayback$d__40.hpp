...
namespace GlobalNamespace {
    struct VODPlayer_$StartImagePlayback$d__40 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "VODPlayer").GetInnerClass("<StartImagePlayback>d__40");
            return clazz;
        }
