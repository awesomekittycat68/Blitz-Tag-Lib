...
namespace GlobalNamespace {
    struct Bindings_Vec3Functions_Cross_000048FB$BurstDirectCall : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "Bindings").GetInnerClass("Vec3Functions").GetInnerClass("Cross_000048FB$BurstDirectCall");
            return clazz;
        }
