...
namespace GlobalNamespace {
    struct BurstClassInfo_NameCall_00004939$BurstDirectCall : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "BurstClassInfo").GetInnerClass("NameCall_00004939$BurstDirectCall");
            return clazz;
        }
