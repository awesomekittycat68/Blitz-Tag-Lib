...
namespace GlobalNamespace {
    struct CreateSharedGroupCompleteServerDelegateWrapper_SwigDelegateCreateSharedGroupCompleteServerDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateSharedGroupCompleteServerDelegateWrapper").GetInnerClass("SwigDelegateCreateSharedGroupCompleteServerDelegateWrapper_0");
            return clazz;
        }
