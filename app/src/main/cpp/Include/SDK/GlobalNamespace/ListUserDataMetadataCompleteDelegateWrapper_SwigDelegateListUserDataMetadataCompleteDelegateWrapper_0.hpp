...
namespace GlobalNamespace {
    struct ListUserDataMetadataCompleteDelegateWrapper_SwigDelegateListUserDataMetadataCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListUserDataMetadataCompleteDelegateWrapper").GetInnerClass("SwigDelegateListUserDataMetadataCompleteDelegateWrapper_0");
            return clazz;
        }
