...
namespace GlobalNamespace {
    struct GetUserDataCompleteClientDelegateWrapper_SwigDelegateGetUserDataCompleteClientDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetUserDataCompleteClientDelegateWrapper").GetInnerClass("SwigDelegateGetUserDataCompleteClientDelegateWrapper_0");
            return clazz;
        }
