...
namespace GlobalNamespace {
    struct ListProgressionTracksRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListProgressionTracksRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::ListProgressionTracksRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::ListProgressionTracksRequest* obj) {
