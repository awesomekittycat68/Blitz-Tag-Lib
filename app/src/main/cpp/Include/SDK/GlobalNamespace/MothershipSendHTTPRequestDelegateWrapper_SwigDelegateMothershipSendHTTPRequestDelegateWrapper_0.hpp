...
namespace GlobalNamespace {
    struct MothershipSendHTTPRequestDelegateWrapper_SwigDelegateMothershipSendHTTPRequestDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipSendHTTPRequestDelegateWrapper").GetInnerClass("SwigDelegateMothershipSendHTTPRequestDelegateWrapper_0");
            return clazz;
        }
