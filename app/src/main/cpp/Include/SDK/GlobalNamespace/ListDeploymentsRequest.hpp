...
namespace GlobalNamespace {
    struct ListDeploymentsRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListDeploymentsRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::ListDeploymentsRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::ListDeploymentsRequest* obj) {
