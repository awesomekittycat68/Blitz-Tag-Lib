...
namespace GlobalNamespace {
    struct ProgressionTree : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ProgressionTree");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::ProgressionTree* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::ProgressionTree* obj) {
