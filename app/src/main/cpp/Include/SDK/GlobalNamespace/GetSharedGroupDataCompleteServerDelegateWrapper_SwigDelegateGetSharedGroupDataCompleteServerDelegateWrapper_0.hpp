...
namespace GlobalNamespace {
    struct GetSharedGroupDataCompleteServerDelegateWrapper_SwigDelegateGetSharedGroupDataCompleteServerDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetSharedGroupDataCompleteServerDelegateWrapper").GetInnerClass("SwigDelegateGetSharedGroupDataCompleteServerDelegateWrapper_0");
            return clazz;
        }
