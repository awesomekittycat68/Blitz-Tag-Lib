...
namespace GlobalNamespace {
    struct DeleteMuteCompleteDelegateWrapper_SwigDelegateDeleteMuteCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteMuteCompleteDelegateWrapper").GetInnerClass("SwigDelegateDeleteMuteCompleteDelegateWrapper_0");
            return clazz;
        }
