...
namespace GlobalNamespace {
    struct DeleteAccountAssociationCompleteDelegateWrapper_SwigDelegateDeleteAccountAssociationCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteAccountAssociationCompleteDelegateWrapper").GetInnerClass("SwigDelegateDeleteAccountAssociationCompleteDelegateWrapper_0");
            return clazz;
        }
