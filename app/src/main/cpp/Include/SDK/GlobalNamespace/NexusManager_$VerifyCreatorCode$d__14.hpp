...
namespace GlobalNamespace {
    struct NexusManager_$VerifyCreatorCode$d__14 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "NexusManager").GetInnerClass("<VerifyCreatorCode>d__14");
            return clazz;
        }
        ...
        ::GlobalNamespace::NexusGroupId* GetId() {
            static BNM::Field<::GlobalNamespace::NexusGroupId*> _field = GetClass().GetField(O("id"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetId(::GlobalNamespace::NexusGroupId* value) {
            static BNM::Field<::GlobalNamespace::NexusGroupId*> _field = GetClass().GetField(O("id"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
