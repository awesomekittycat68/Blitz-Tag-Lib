...
namespace GlobalNamespace {
    struct ProgressionManager_$PurchaseTechPoints$d__74 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ProgressionManager").GetInnerClass("<PurchaseTechPoints>d__74");
            return clazz;
        }
