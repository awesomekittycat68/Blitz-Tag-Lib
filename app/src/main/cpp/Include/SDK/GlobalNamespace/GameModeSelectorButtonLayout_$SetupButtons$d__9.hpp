...
namespace GlobalNamespace {
    struct GameModeSelectorButtonLayout_$SetupButtons$d__9 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GameModeSelectorButtonLayout").GetInnerClass("<SetupButtons>d__9");
            return clazz;
        }
