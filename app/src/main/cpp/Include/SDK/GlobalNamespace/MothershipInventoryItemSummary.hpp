...
namespace GlobalNamespace {
    struct MothershipInventoryItemSummary : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipInventoryItemSummary");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::MothershipInventoryItemSummary* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::MothershipInventoryItemSummary* obj) {
