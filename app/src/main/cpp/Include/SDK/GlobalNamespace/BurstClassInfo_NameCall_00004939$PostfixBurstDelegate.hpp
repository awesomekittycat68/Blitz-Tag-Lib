...
namespace GlobalNamespace {
    struct BurstClassInfo_NameCall_00004939$PostfixBurstDelegate : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "BurstClassInfo").GetInnerClass("NameCall_00004939$PostfixBurstDelegate");
            return clazz;
        }
