...
namespace GlobalNamespace {
    struct MothershipWebSocketDelegateWrapper_SwigDelegateMothershipWebSocketDelegateWrapper_1 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipWebSocketDelegateWrapper").GetInnerClass("SwigDelegateMothershipWebSocketDelegateWrapper_1");
            return clazz;
        }
