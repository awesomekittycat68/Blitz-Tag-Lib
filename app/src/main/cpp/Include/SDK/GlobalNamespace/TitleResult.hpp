...
namespace GlobalNamespace {
    struct TitleResult : ::GlobalNamespace::MothershipResponse {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "TitleResult");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::TitleResult* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::TitleResult* obj) {
