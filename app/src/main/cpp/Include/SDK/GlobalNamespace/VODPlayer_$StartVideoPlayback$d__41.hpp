...
namespace GlobalNamespace {
    struct VODPlayer_$StartVideoPlayback$d__41 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "VODPlayer").GetInnerClass("<StartVideoPlayback>d__41");
            return clazz;
        }
