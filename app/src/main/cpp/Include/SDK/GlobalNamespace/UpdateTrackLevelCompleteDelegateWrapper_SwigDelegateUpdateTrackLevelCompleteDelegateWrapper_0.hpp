...
namespace GlobalNamespace {
    struct UpdateTrackLevelCompleteDelegateWrapper_SwigDelegateUpdateTrackLevelCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateTrackLevelCompleteDelegateWrapper").GetInnerClass("SwigDelegateUpdateTrackLevelCompleteDelegateWrapper_0");
            return clazz;
        }
