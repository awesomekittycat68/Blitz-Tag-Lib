...
namespace GlobalNamespace {
    struct ProgressionManager_$DoIdolCollectReward$d__109 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ProgressionManager").GetInnerClass("<DoIdolCollectReward>d__109");
            return clazz;
        }

        static BNM::MonoType* GetType() { return GetClass().GetMonoType(); }

        ::GlobalNamespace::ProgressionManager_SetSIIdolCollectRequest* GetData() {
            static BNM::Field<::GlobalNamespace::ProgressionManager_SetSIIdolCollectRequest*> _field = GetClass().GetField(O("data"));
        ...
        void SetData(::GlobalNamespace::ProgressionManager_SetSIIdolCollectRequest* value) {
            static BNM::Field<::GlobalNamespace::ProgressionManager_SetSIIdolCollectRequest*> _field = GetClass().GetField(O("data"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
