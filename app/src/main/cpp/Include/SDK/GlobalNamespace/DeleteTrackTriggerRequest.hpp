...
namespace GlobalNamespace {
    struct DeleteTrackTriggerRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteTrackTriggerRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::DeleteTrackTriggerRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::DeleteTrackTriggerRequest* obj) {
