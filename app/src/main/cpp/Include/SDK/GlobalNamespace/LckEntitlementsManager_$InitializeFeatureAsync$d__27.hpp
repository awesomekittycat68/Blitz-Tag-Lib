...
namespace GlobalNamespace {
    struct LckEntitlementsManager_$InitializeFeatureAsync$d__27 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "LckEntitlementsManager").GetInnerClass("<InitializeFeatureAsync>d__27");
            return clazz;
        }
