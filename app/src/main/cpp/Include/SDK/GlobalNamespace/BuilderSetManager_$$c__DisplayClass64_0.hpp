...
namespace GlobalNamespace {
    struct BuilderSetManager_$$c__DisplayClass64_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "BuilderSetManager").GetInnerClass("<>c__DisplayClass64_0");
            return clazz;
        }
