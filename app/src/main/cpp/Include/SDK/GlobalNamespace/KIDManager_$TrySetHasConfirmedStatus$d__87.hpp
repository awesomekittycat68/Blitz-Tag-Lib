...
namespace GlobalNamespace {
    struct KIDManager_$TrySetHasConfirmedStatus$d__87 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "KIDManager").GetInnerClass("<TrySetHasConfirmedStatus>d__87");
            return clazz;
        }
