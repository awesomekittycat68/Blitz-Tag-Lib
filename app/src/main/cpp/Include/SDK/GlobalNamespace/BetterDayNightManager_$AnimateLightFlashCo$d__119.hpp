...
namespace GlobalNamespace {
    struct BetterDayNightManager_$AnimateLightFlashCo$d__119 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "BetterDayNightManager").GetInnerClass("<AnimateLightFlashCo>d__119");
            return clazz;
        }
