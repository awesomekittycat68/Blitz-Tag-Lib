...
namespace GlobalNamespace {
    struct PlayerTagsUpdateMap_PlayerTagsUpdateMapEnumerator : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "PlayerTagsUpdateMap").GetInnerClass("PlayerTagsUpdateMapEnumerator");
            return clazz;
        }

        static BNM::MonoType* GetType() { return GetClass().GetMonoType(); }

        ::GlobalNamespace::PlayerTagsUpdateMap* GetCollectionRef() {
            static BNM::Field<::GlobalNamespace::PlayerTagsUpdateMap*> _field = GetClass().GetField(O("collectionRef"));
        ...
        void SetCollectionRef(::GlobalNamespace::PlayerTagsUpdateMap* value) {
            static BNM::Field<::GlobalNamespace::PlayerTagsUpdateMap*> _field = GetClass().GetField(O("collectionRef"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
