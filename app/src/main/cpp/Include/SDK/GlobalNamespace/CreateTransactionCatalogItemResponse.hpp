...
namespace GlobalNamespace {
    struct CreateTransactionCatalogItemResponse : ::GlobalNamespace::MothershipResponse {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateTransactionCatalogItemResponse");
            return clazz;
        }
        ...
        static ::GlobalNamespace::CreateTransactionCatalogItemResponse* FromMothershipResponse(::GlobalNamespace::MothershipResponse* response) {
            static BNM::Method<::GlobalNamespace::CreateTransactionCatalogItemResponse*> _m = GetClass().GetMethod(O("FromMothershipResponse"), {"response"});
        ...
        static void* getCPtr(::GlobalNamespace::CreateTransactionCatalogItemResponse* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::CreateTransactionCatalogItemResponse* obj) {
