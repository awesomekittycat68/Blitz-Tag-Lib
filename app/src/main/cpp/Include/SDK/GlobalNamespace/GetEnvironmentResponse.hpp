...
namespace GlobalNamespace {
    struct GetEnvironmentResponse : ::GlobalNamespace::MothershipResponse {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetEnvironmentResponse");
            return clazz;
        }
        ...
        static ::GlobalNamespace::GetEnvironmentResponse* FromMothershipResponse(::GlobalNamespace::MothershipResponse* response) {
            static BNM::Method<::GlobalNamespace::GetEnvironmentResponse*> _m = GetClass().GetMethod(O("FromMothershipResponse"), {"response"});
        ...
        static void* getCPtr(::GlobalNamespace::GetEnvironmentResponse* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::GetEnvironmentResponse* obj) {
