...
namespace GlobalNamespace {
    struct GetBanCompleteDelegateWrapper : ::GlobalNamespace::MothershipRequestCompleteDelegateWrapper {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetBanCompleteDelegateWrapper");
            return clazz;
        }

        static BNM::MonoType* GetType() { return GetClass().GetMonoType(); }

        static ::GlobalNamespace::GetBanCompleteDelegateWrapper* GetSelfInstance() {
            static BNM::Field<::GlobalNamespace::GetBanCompleteDelegateWrapper*> _field = GetClass().GetField(O("selfInstance"));
            return _field.Get();
        }
        void* GetSwigCPtr() {
        ...
        ::GlobalNamespace::GetBanCompleteDelegateWrapper_SwigDelegateGetBanCompleteDelegateWrapper_0* GetSwigDelegate0() {
            static BNM::Field<::GlobalNamespace::GetBanCompleteDelegateWrapper_SwigDelegateGetBanCompleteDelegateWrapper_0*> _field = GetClass().GetField(O("swigDelegate0"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        static void SetSelfInstance(::GlobalNamespace::GetBanCompleteDelegateWrapper* value) {
            static BNM::Field<::GlobalNamespace::GetBanCompleteDelegateWrapper*> _field = GetClass().GetField(O("selfInstance"));
            _field.Set(value);
        }
        ...
        void SetSwigDelegate0(::GlobalNamespace::GetBanCompleteDelegateWrapper_SwigDelegateGetBanCompleteDelegateWrapper_0* value) {
            static BNM::Field<::GlobalNamespace::GetBanCompleteDelegateWrapper_SwigDelegateGetBanCompleteDelegateWrapper_0*> _field = GetClass().GetField(O("swigDelegate0"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        static void* getCPtr(::GlobalNamespace::GetBanCompleteDelegateWrapper* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::GetBanCompleteDelegateWrapper* obj) {
