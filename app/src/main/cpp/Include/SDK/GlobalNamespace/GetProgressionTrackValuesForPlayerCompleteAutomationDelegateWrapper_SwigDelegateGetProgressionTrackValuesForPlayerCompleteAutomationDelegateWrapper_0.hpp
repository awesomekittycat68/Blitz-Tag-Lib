...
namespace GlobalNamespace {
    struct GetProgressionTrackValuesForPlayerCompleteAutomationDelegateWrapper_SwigDelegateGetProgressionTrackValuesForPlayerCompleteAutomationDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetProgressionTrackValuesForPlayerCompleteAutomationDelegateWrapper").GetInnerClass("SwigDelegateGetProgressionTrackValuesForPlayerCompleteAutomationDelegateWrapper_0");
            return clazz;
        }
