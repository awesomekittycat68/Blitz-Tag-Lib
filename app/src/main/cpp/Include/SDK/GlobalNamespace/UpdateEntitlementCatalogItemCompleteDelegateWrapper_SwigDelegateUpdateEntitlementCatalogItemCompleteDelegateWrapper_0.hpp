...
namespace GlobalNamespace {
    struct UpdateEntitlementCatalogItemCompleteDelegateWrapper_SwigDelegateUpdateEntitlementCatalogItemCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateEntitlementCatalogItemCompleteDelegateWrapper").GetInnerClass("SwigDelegateUpdateEntitlementCatalogItemCompleteDelegateWrapper_0");
            return clazz;
        }
