...
namespace GlobalNamespace {
    struct GetReportCompleteDelegateWrapper_SwigDelegateGetReportCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetReportCompleteDelegateWrapper").GetInnerClass("SwigDelegateGetReportCompleteDelegateWrapper_0");
            return clazz;
        }
