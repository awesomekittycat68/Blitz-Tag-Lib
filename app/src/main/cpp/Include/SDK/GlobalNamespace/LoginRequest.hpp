...
namespace GlobalNamespace {
    struct LoginRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "LoginRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::LoginRequest* obj) {
            static BNM::Method<void*> _m = GetClass().GetMethod(O("getCPtr"), {"obj"});
            return _m.Call(obj);
        }
        static void* swigRelease(::GlobalNamespace::LoginRequest* obj) {
