...
namespace GlobalNamespace {
    struct ModIOManager_$ShowModIOTermsOfUse$d__46 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ModIOManager").GetInnerClass("<ShowModIOTermsOfUse>d__46");
            return clazz;
        }
