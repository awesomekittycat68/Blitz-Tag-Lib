...
namespace GlobalNamespace {
    struct CheckoutCartButton : ::GlobalNamespace::GorillaPressableButton {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CheckoutCartButton");
            return clazz;
        }
        ...
        void SetItem(::GorillaNetworking::CosmeticsController_CosmeticItem item, bool isCurrentItemToBuy) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("SetItem"), {"item", "isCurrentItemToBuy"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(item, isCurrentItemToBuy);
        }
        void Start() {
