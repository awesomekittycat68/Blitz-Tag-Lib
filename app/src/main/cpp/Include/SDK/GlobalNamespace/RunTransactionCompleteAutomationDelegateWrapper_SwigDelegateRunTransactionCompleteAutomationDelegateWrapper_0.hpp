...
namespace GlobalNamespace {
    struct RunTransactionCompleteAutomationDelegateWrapper_SwigDelegateRunTransactionCompleteAutomationDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "RunTransactionCompleteAutomationDelegateWrapper").GetInnerClass("SwigDelegateRunTransactionCompleteAutomationDelegateWrapper_0");
            return clazz;
        }
