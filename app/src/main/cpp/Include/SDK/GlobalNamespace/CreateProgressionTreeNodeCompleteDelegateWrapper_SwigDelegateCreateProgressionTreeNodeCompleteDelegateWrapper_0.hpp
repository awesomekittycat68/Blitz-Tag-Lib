...
namespace GlobalNamespace {
    struct CreateProgressionTreeNodeCompleteDelegateWrapper_SwigDelegateCreateProgressionTreeNodeCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateProgressionTreeNodeCompleteDelegateWrapper").GetInnerClass("SwigDelegateCreateProgressionTreeNodeCompleteDelegateWrapper_0");
            return clazz;
        }
