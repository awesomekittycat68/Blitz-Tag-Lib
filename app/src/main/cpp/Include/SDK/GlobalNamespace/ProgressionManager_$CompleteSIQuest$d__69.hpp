...
namespace GlobalNamespace {
    struct ProgressionManager_$CompleteSIQuest$d__69 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ProgressionManager").GetInnerClass("<CompleteSIQuest>d__69");
            return clazz;
        }
