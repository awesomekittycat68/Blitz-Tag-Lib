...
namespace GlobalNamespace {
    struct CreateServerKeyCompleteDelegateWrapper_SwigDelegateCreateServerKeyCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateServerKeyCompleteDelegateWrapper").GetInnerClass("SwigDelegateCreateServerKeyCompleteDelegateWrapper_0");
            return clazz;
        }
