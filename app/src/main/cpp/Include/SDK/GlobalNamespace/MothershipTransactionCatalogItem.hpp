...
namespace GlobalNamespace {
    struct MothershipTransactionCatalogItem : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipTransactionCatalogItem");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::MothershipTransactionCatalogItem* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::MothershipTransactionCatalogItem* obj) {
