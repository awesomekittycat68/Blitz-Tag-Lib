...
namespace GlobalNamespace {
    struct ProgressionController_$ReportProgress$d__71 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ProgressionController").GetInnerClass("<ReportProgress>d__71");
            return clazz;
        }
