...
namespace GlobalNamespace {
    struct DeleteMuteRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteMuteRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::DeleteMuteRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::DeleteMuteRequest* obj) {
