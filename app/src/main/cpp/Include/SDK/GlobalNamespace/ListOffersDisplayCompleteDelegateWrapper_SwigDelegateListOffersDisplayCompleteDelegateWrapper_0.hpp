...
namespace GlobalNamespace {
    struct ListOffersDisplayCompleteDelegateWrapper_SwigDelegateListOffersDisplayCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListOffersDisplayCompleteDelegateWrapper").GetInnerClass("SwigDelegateListOffersDisplayCompleteDelegateWrapper_0");
            return clazz;
        }
