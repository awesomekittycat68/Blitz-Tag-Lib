...
namespace GlobalNamespace {
    struct PlayerQuestBeginLoginV2Request : ::GlobalNamespace::LoginRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "PlayerQuestBeginLoginV2Request");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::PlayerQuestBeginLoginV2Request* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::PlayerQuestBeginLoginV2Request* obj) {
