...
namespace GlobalNamespace {
    struct DeleteProgressionTreeNodeCompleteDelegateWrapper_SwigDelegateDeleteProgressionTreeNodeCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteProgressionTreeNodeCompleteDelegateWrapper").GetInnerClass("SwigDelegateDeleteProgressionTreeNodeCompleteDelegateWrapper_0");
            return clazz;
        }
