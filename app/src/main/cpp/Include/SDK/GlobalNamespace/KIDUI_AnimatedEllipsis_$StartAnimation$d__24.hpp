...
namespace GlobalNamespace {
    struct KIDUI_AnimatedEllipsis_$StartAnimation$d__24 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "KIDUI_AnimatedEllipsis").GetInnerClass("<StartAnimation>d__24");
            return clazz;
        }
