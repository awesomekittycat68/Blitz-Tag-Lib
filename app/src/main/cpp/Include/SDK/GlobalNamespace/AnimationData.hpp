...
namespace GlobalNamespace {
    struct AnimationData : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "AnimationData");
            return clazz;
        }
        ...
        float GetEventTime() {
            static BNM::Field<float> _field = GetClass().GetField(O("eventTime"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        float GetSpeed() {
