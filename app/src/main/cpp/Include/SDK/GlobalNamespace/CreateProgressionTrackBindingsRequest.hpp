...
namespace GlobalNamespace {
    struct CreateProgressionTrackBindingsRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateProgressionTrackBindingsRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::CreateProgressionTrackBindingsRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::CreateProgressionTrackBindingsRequest* obj) {
