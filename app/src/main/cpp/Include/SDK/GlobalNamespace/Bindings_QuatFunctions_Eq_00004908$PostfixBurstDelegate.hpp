...
namespace GlobalNamespace {
    struct Bindings_QuatFunctions_Eq_00004908$PostfixBurstDelegate : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "Bindings").GetInnerClass("QuatFunctions").GetInnerClass("Eq_00004908$PostfixBurstDelegate");
            return clazz;
        }
