...
namespace GlobalNamespace {
    struct UnlockProgressionTreeNodeAutomationCompleteDelegateWrapper_SwigDelegateUnlockProgressionTreeNodeAutomationCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UnlockProgressionTreeNodeAutomationCompleteDelegateWrapper").GetInnerClass("SwigDelegateUnlockProgressionTreeNodeAutomationCompleteDelegateWrapper_0");
            return clazz;
        }
