...
namespace GlobalNamespace {
    struct AddSharedGroupMembersCompleteServerDelegateWrapper_SwigDelegateAddSharedGroupMembersCompleteServerDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "AddSharedGroupMembersCompleteServerDelegateWrapper").GetInnerClass("SwigDelegateAddSharedGroupMembersCompleteServerDelegateWrapper_0");
            return clazz;
        }
