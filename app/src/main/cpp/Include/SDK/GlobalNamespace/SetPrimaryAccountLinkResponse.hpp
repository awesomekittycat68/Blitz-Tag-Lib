...
namespace GlobalNamespace {
    struct SetPrimaryAccountLinkResponse : ::GlobalNamespace::MothershipResponse {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "SetPrimaryAccountLinkResponse");
            return clazz;
        }
        ...
        static ::GlobalNamespace::SetPrimaryAccountLinkResponse* FromMothershipResponse(::GlobalNamespace::MothershipResponse* response) {
            static BNM::Method<::GlobalNamespace::SetPrimaryAccountLinkResponse*> _m = GetClass().GetMethod(O("FromMothershipResponse"), {"response"});
        ...
        static void* getCPtr(::GlobalNamespace::SetPrimaryAccountLinkResponse* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::SetPrimaryAccountLinkResponse* obj) {
