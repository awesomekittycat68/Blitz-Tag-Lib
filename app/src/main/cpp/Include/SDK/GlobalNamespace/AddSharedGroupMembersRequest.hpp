...
namespace GlobalNamespace {
    struct AddSharedGroupMembersRequest : ::GlobalNamespace::MothershipRequestShared {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "AddSharedGroupMembersRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::AddSharedGroupMembersRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::AddSharedGroupMembersRequest* obj) {
