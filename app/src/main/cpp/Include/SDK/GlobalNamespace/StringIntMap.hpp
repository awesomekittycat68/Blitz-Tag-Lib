...
namespace GlobalNamespace {
    struct StringIntMap : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "StringIntMap");
            return clazz;
        }
        ...
        void Add(::BNM::Structures::Mono::String* key, int val) {
        ...
        int get_Item(::BNM::Structures::Mono::String* key) {
        ...
        static void* getCPtr(::GlobalNamespace::StringIntMap* obj) {
            static BNM::Method<void*> _m = GetClass().GetMethod(O("getCPtr"), {"obj"});
            return _m.Call(obj);
        }
        ::GlobalNamespace::StringIntMap_StringIntMapEnumerator* GetEnumerator() {
            static BNM::Method<::GlobalNamespace::StringIntMap_StringIntMapEnumerator*> _m = GetClass().GetMethod(O("GetEnumerator"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call();
        }
        int getitem(::BNM::Structures::Mono::String* key) {
            static BNM::Method<int> _m = GetClass().GetMethod(O("getitem"), {"key"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call(key);
        }
        template <typename TP0 = void*>
        ...
        void set_Item(::BNM::Structures::Mono::String* key, int value) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("set_Item"), {"key", "value"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(key, value);
        }
        void setitem(::BNM::Structures::Mono::String* key, int x) {
        ...
        static void* swigRelease(::GlobalNamespace::StringIntMap* obj) {
            static BNM::Method<void*> _m = GetClass().GetMethod(O("swigRelease"), {"obj"});
            return _m.Call(obj);
        }
        bool TryGetValue(::BNM::Structures::Mono::String* key, int& value) {
