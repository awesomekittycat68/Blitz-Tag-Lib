...
namespace GlobalNamespace {
    struct UpdateInsecure2ConfigRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateInsecure2ConfigRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::UpdateInsecure2ConfigRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::UpdateInsecure2ConfigRequest* obj) {
