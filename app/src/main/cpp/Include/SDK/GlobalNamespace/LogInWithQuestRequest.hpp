...
namespace GlobalNamespace {
    struct LogInWithQuestRequest : ::GlobalNamespace::LoginRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "LogInWithQuestRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::LogInWithQuestRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::LogInWithQuestRequest* obj) {
