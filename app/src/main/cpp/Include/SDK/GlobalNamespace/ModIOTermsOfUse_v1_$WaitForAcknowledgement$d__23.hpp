...
namespace GlobalNamespace {
    struct ModIOTermsOfUse_v1_$WaitForAcknowledgement$d__23 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ModIOTermsOfUse_v1").GetInnerClass("<WaitForAcknowledgement>d__23");
            return clazz;
        }
