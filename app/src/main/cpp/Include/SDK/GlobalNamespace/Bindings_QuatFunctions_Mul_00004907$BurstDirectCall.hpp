...
namespace GlobalNamespace {
    struct Bindings_QuatFunctions_Mul_00004907$BurstDirectCall : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "Bindings").GetInnerClass("QuatFunctions").GetInnerClass("Mul_00004907$BurstDirectCall");
            return clazz;
        }
