...
namespace GlobalNamespace {
    struct UpdateProgressionTreeCompleteDelegateWrapper_SwigDelegateUpdateProgressionTreeCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateProgressionTreeCompleteDelegateWrapper").GetInnerClass("SwigDelegateUpdateProgressionTreeCompleteDelegateWrapper_0");
            return clazz;
        }
