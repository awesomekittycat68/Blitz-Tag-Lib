...
namespace GlobalNamespace {
    struct MothershipTitleDataShort : ::GlobalNamespace::MothershipResponse {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipTitleDataShort");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::MothershipTitleDataShort* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::MothershipTitleDataShort* obj) {
