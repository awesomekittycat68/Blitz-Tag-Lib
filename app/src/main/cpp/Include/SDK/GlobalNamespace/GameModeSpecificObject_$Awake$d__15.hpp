...
namespace GlobalNamespace {
    struct GameModeSpecificObject_$Awake$d__15 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GameModeSpecificObject").GetInnerClass("<Awake>d__15");
            return clazz;
        }
