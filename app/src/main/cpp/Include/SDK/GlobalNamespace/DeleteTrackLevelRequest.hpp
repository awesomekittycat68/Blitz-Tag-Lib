...
namespace GlobalNamespace {
    struct DeleteTrackLevelRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteTrackLevelRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::DeleteTrackLevelRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::DeleteTrackLevelRequest* obj) {
