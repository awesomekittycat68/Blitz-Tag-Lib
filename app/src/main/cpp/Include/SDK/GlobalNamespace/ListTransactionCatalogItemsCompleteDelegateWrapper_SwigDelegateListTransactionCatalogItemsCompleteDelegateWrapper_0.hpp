...
namespace GlobalNamespace {
    struct ListTransactionCatalogItemsCompleteDelegateWrapper_SwigDelegateListTransactionCatalogItemsCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListTransactionCatalogItemsCompleteDelegateWrapper").GetInnerClass("SwigDelegateListTransactionCatalogItemsCompleteDelegateWrapper_0");
            return clazz;
        }
