...
namespace GlobalNamespace {
    struct SetUserDataCompleteClientDelegateWrapper_SwigDelegateSetUserDataCompleteClientDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "SetUserDataCompleteClientDelegateWrapper").GetInnerClass("SwigDelegateSetUserDataCompleteClientDelegateWrapper_0");
            return clazz;
        }
