...
namespace GlobalNamespace {
    struct GetPlayerMutesRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetPlayerMutesRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::GetPlayerMutesRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::GetPlayerMutesRequest* obj) {
