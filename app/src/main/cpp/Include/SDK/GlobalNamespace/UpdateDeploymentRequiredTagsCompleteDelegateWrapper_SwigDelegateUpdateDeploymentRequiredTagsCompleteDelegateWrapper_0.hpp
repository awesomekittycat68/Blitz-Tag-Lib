...
namespace GlobalNamespace {
    struct UpdateDeploymentRequiredTagsCompleteDelegateWrapper_SwigDelegateUpdateDeploymentRequiredTagsCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateDeploymentRequiredTagsCompleteDelegateWrapper").GetInnerClass("SwigDelegateUpdateDeploymentRequiredTagsCompleteDelegateWrapper_0");
            return clazz;
        }
