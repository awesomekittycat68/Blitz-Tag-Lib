...
namespace GlobalNamespace {
    struct ServerCreateReportCompleteDelegateWrapper_SwigDelegateServerCreateReportCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ServerCreateReportCompleteDelegateWrapper").GetInnerClass("SwigDelegateServerCreateReportCompleteDelegateWrapper_0");
            return clazz;
        }
