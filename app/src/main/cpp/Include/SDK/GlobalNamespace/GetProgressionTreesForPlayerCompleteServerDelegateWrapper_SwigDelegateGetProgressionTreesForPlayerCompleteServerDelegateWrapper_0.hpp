...
namespace GlobalNamespace {
    struct GetProgressionTreesForPlayerCompleteServerDelegateWrapper_SwigDelegateGetProgressionTreesForPlayerCompleteServerDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetProgressionTreesForPlayerCompleteServerDelegateWrapper").GetInnerClass("SwigDelegateGetProgressionTreesForPlayerCompleteServerDelegateWrapper_0");
            return clazz;
        }
