...
namespace GlobalNamespace {
    struct CreateTrackTriggerCompleteDelegateWrapper_SwigDelegateCreateTrackTriggerCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateTrackTriggerCompleteDelegateWrapper").GetInnerClass("SwigDelegateCreateTrackTriggerCompleteDelegateWrapper_0");
            return clazz;
        }
