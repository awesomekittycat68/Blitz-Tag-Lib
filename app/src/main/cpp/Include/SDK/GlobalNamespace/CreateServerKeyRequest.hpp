...
namespace GlobalNamespace {
    struct CreateServerKeyRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateServerKeyRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::CreateServerKeyRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::CreateServerKeyRequest* obj) {
