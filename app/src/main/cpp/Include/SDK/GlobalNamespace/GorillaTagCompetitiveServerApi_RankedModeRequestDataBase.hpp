...
namespace GlobalNamespace {
    struct GorillaTagCompetitiveServerApi_RankedModeRequestDataBase : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GorillaTagCompetitiveServerApi").GetInnerClass("RankedModeRequestDataBase");
            return clazz;
        }
