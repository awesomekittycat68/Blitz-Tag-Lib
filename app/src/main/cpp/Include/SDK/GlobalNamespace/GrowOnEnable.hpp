...
namespace GlobalNamespace {
    struct GrowOnEnable : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GrowOnEnable");
            return clazz;
        }
        ...
        float GetLerpVal() {
            static BNM::Field<float> _field = GetClass().GetField(O("_lerpVal"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ::BNM::Structures::Unity::Vector3 GetTargetScale() {
            static BNM::Field<::BNM::Structures::Unity::Vector3> _field = GetClass().GetField(O("_targetScale"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ::GlobalNamespace::AnimationCurves_EaseType GetEaseType() {
            static BNM::Field<::GlobalNamespace::AnimationCurves_EaseType> _field = GetClass().GetField(O("easeType"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        float GetGrowDuration() {
            static BNM::Field<float> _field = GetClass().GetField(O("growDuration"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetEaseType(::GlobalNamespace::AnimationCurves_EaseType value) {
            static BNM::Field<::GlobalNamespace::AnimationCurves_EaseType> _field = GetClass().GetField(O("easeType"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        void SetGrowDuration(float value) {
            static BNM::Field<float> _field = GetClass().GetField(O("growDuration"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
