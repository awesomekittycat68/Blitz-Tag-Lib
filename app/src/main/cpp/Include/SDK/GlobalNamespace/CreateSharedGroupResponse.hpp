...
namespace GlobalNamespace {
    struct CreateSharedGroupResponse : ::GlobalNamespace::MothershipResponse {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateSharedGroupResponse");
            return clazz;
        }
        ...
        static ::GlobalNamespace::CreateSharedGroupResponse* FromMothershipResponse(::GlobalNamespace::MothershipResponse* response) {
            static BNM::Method<::GlobalNamespace::CreateSharedGroupResponse*> _m = GetClass().GetMethod(O("FromMothershipResponse"), {"response"});
        ...
        static void* getCPtr(::GlobalNamespace::CreateSharedGroupResponse* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::CreateSharedGroupResponse* obj) {
