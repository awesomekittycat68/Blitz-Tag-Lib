...
namespace GlobalNamespace {
    struct KIDAgeGate_$WaitForAgeChoice$d__36 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "KIDAgeGate").GetInnerClass("<WaitForAgeChoice>d__36");
            return clazz;
        }
