...
namespace GlobalNamespace {
    struct GetTransactionCatalogItemRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetTransactionCatalogItemRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::GetTransactionCatalogItemRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::GetTransactionCatalogItemRequest* obj) {
