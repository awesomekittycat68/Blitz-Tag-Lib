...
namespace GlobalNamespace {
    struct HoverboardHandle : ::GlobalNamespace::HoldableObject {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "HoverboardHandle");
            return clazz;
        }
        ...
        ::GlobalNamespace::HoverboardVisual* GetParentVisual() {
            static BNM::Field<::GlobalNamespace::HoverboardVisual*> _field = GetClass().GetField(O("parentVisual"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetParentVisual(::GlobalNamespace::HoverboardVisual* value) {
            static BNM::Field<::GlobalNamespace::HoverboardVisual*> _field = GetClass().GetField(O("parentVisual"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
