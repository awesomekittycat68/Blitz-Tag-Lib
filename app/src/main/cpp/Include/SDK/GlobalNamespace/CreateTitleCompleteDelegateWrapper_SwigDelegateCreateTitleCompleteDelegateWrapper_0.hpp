...
namespace GlobalNamespace {
    struct CreateTitleCompleteDelegateWrapper_SwigDelegateCreateTitleCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateTitleCompleteDelegateWrapper").GetInnerClass("SwigDelegateCreateTitleCompleteDelegateWrapper_0");
            return clazz;
        }
