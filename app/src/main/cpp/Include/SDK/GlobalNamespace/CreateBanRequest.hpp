...
namespace GlobalNamespace {
    struct CreateBanRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateBanRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::CreateBanRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::CreateBanRequest* obj) {
