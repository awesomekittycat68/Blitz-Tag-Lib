...
namespace GlobalNamespace {
    struct GrowUntilCollision : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GrowUntilCollision");
            return clazz;
        }
        ...
        float GetInitialRadius() {
            static BNM::Field<float> _field = GetClass().GetField(O("initialRadius"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        float GetMaxPitch() {
            static BNM::Field<float> _field = GetClass().GetField(O("maxPitch"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        float GetMaxSize() {
        ...
        float GetMinRetriggerTime() {
            static BNM::Field<float> _field = GetClass().GetField(O("minRetriggerTime"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        float GetTimeSinceTrigger() {
            static BNM::Field<float> _field = GetClass().GetField(O("timeSinceTrigger"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetMinRetriggerTime(float value) {
            static BNM::Field<float> _field = GetClass().GetField(O("minRetriggerTime"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        void SetTimeSinceTrigger(float value) {
            static BNM::Field<float> _field = GetClass().GetField(O("timeSinceTrigger"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        void tryToTrigger(::BNM::Structures::Unity::Vector3 p1, ::BNM::Structures::Unity::Vector3 p2) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("tryToTrigger"), {"p1", "p2"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(p1, p2);
        }
        void Update() {
        ...
        void zero() {
            static BNM::Method<void> _m = GetClass().GetMethod(O("zero"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call();
        }
    };
