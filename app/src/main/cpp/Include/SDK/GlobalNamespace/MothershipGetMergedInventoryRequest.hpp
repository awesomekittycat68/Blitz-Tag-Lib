...
namespace GlobalNamespace {
    struct MothershipGetMergedInventoryRequest : ::GlobalNamespace::MothershipRequestShared {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipGetMergedInventoryRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::MothershipGetMergedInventoryRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::MothershipGetMergedInventoryRequest* obj) {
