...
namespace GlobalNamespace {
    struct CreateEntitlementCatalogItemRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateEntitlementCatalogItemRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::CreateEntitlementCatalogItemRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::CreateEntitlementCatalogItemRequest* obj) {
