...
namespace GlobalNamespace {
    struct LineRenderVelocityMapper : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "LineRenderVelocityMapper");
            return clazz;
        }
        ...
        ::LineRenderer* GetLr() {
            static BNM::Field<::LineRenderer*> _field = GetClass().GetField(O("_lr"));
