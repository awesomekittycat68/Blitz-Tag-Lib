...
namespace GlobalNamespace {
    struct CreateOfferDisplayCompleteDelegateWrapper_SwigDelegateCreateOfferDisplayCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateOfferDisplayCompleteDelegateWrapper").GetInnerClass("SwigDelegateCreateOfferDisplayCompleteDelegateWrapper_0");
            return clazz;
        }
