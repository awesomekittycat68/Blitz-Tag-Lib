...
namespace GlobalNamespace {
    struct DeleteUserDataCompleteServerDelegateWrapper_SwigDelegateDeleteUserDataCompleteServerDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteUserDataCompleteServerDelegateWrapper").GetInnerClass("SwigDelegateDeleteUserDataCompleteServerDelegateWrapper_0");
            return clazz;
        }
