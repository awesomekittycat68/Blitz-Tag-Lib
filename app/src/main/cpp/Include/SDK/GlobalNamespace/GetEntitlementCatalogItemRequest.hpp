...
namespace GlobalNamespace {
    struct GetEntitlementCatalogItemRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetEntitlementCatalogItemRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::GetEntitlementCatalogItemRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::GetEntitlementCatalogItemRequest* obj) {
