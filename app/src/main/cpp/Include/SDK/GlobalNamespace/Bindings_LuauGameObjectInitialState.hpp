...
namespace GlobalNamespace {
    struct Bindings_LuauGameObjectInitialState : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "Bindings").GetInnerClass("LuauGameObjectInitialState");
            return clazz;
        }
        ...
        bool GetCollidable() {
            static BNM::Field<bool> _field = GetClass().GetField(O("Collidable"));
