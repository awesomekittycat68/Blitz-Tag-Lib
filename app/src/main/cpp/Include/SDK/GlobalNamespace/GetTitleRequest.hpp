...
namespace GlobalNamespace {
    struct GetTitleRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetTitleRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::GetTitleRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::GetTitleRequest* obj) {
