...
namespace GlobalNamespace {
    struct UpdateInsecure1ConfigResponse : ::GlobalNamespace::MothershipResponse {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateInsecure1ConfigResponse");
            return clazz;
        }
        ...
        static ::GlobalNamespace::UpdateInsecure1ConfigResponse* FromMothershipResponse(::GlobalNamespace::MothershipResponse* response) {
            static BNM::Method<::GlobalNamespace::UpdateInsecure1ConfigResponse*> _m = GetClass().GetMethod(O("FromMothershipResponse"), {"response"});
        ...
        static void* getCPtr(::GlobalNamespace::UpdateInsecure1ConfigResponse* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::UpdateInsecure1ConfigResponse* obj) {
