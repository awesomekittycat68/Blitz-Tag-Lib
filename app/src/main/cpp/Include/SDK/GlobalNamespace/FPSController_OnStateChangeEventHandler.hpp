...
namespace GlobalNamespace {
    struct FPSController_OnStateChangeEventHandler : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "FPSController").GetInnerClass("OnStateChangeEventHandler");
            return clazz;
        }
