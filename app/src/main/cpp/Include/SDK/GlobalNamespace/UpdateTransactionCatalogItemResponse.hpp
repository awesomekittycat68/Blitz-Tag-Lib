...
namespace GlobalNamespace {
    struct UpdateTransactionCatalogItemResponse : ::GlobalNamespace::MothershipResponse {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateTransactionCatalogItemResponse");
            return clazz;
        }
        ...
        static ::GlobalNamespace::UpdateTransactionCatalogItemResponse* FromMothershipResponse(::GlobalNamespace::MothershipResponse* response) {
            static BNM::Method<::GlobalNamespace::UpdateTransactionCatalogItemResponse*> _m = GetClass().GetMethod(O("FromMothershipResponse"), {"response"});
        ...
        static void* getCPtr(::GlobalNamespace::UpdateTransactionCatalogItemResponse* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::UpdateTransactionCatalogItemResponse* obj) {
