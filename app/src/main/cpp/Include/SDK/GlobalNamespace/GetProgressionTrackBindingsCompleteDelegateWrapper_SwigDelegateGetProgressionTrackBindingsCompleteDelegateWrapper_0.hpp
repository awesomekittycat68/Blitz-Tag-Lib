...
namespace GlobalNamespace {
    struct GetProgressionTrackBindingsCompleteDelegateWrapper_SwigDelegateGetProgressionTrackBindingsCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetProgressionTrackBindingsCompleteDelegateWrapper").GetInnerClass("SwigDelegateGetProgressionTrackBindingsCompleteDelegateWrapper_0");
            return clazz;
        }
