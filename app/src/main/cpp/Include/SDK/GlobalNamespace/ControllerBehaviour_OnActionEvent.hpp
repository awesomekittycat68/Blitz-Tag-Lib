...
namespace GlobalNamespace {
    struct ControllerBehaviour_OnActionEvent : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ControllerBehaviour").GetInnerClass("OnActionEvent");
            return clazz;
        }
