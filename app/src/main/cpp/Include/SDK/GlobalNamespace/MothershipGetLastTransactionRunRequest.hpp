...
namespace GlobalNamespace {
    struct MothershipGetLastTransactionRunRequest : ::GlobalNamespace::MothershipRequestShared {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipGetLastTransactionRunRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::MothershipGetLastTransactionRunRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::MothershipGetLastTransactionRunRequest* obj) {
