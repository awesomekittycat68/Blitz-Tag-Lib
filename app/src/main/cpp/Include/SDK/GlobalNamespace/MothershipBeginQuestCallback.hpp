...
#include "QuestBeginLoginV2RequestCompleteDelegateWrapper.hpp"

namespace GlobalNamespace {
    struct MothershipBeginQuestCallback : ::GlobalNamespace::QuestBeginLoginV2RequestCompleteDelegateWrapper {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipBeginQuestCallback");
            return clazz;
        }
