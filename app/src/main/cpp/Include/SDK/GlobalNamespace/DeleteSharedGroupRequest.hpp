...
namespace GlobalNamespace {
    struct DeleteSharedGroupRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteSharedGroupRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::DeleteSharedGroupRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::DeleteSharedGroupRequest* obj) {
