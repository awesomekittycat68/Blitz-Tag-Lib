...
namespace GlobalNamespace {
    struct DeleteAccountAssociationRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteAccountAssociationRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::DeleteAccountAssociationRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::DeleteAccountAssociationRequest* obj) {
