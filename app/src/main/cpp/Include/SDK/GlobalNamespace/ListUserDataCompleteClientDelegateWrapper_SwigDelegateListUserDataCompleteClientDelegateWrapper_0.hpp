...
namespace GlobalNamespace {
    struct ListUserDataCompleteClientDelegateWrapper_SwigDelegateListUserDataCompleteClientDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListUserDataCompleteClientDelegateWrapper").GetInnerClass("SwigDelegateListUserDataCompleteClientDelegateWrapper_0");
            return clazz;
        }
