...
namespace GlobalNamespace {
    struct UpdateSharedGroupDataCompleteClientDelegateWrapper_SwigDelegateUpdateSharedGroupDataCompleteClientDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateSharedGroupDataCompleteClientDelegateWrapper").GetInnerClass("SwigDelegateUpdateSharedGroupDataCompleteClientDelegateWrapper_0");
            return clazz;
        }
