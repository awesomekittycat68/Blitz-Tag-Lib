...
namespace GlobalNamespace {
    struct DeleteMothershipTitleDataResponse : ::GlobalNamespace::MothershipResponse {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteMothershipTitleDataResponse");
            return clazz;
        }
        ...
        static ::GlobalNamespace::DeleteMothershipTitleDataResponse* FromMothershipResponse(::GlobalNamespace::MothershipResponse* response) {
            static BNM::Method<::GlobalNamespace::DeleteMothershipTitleDataResponse*> _m = GetClass().GetMethod(O("FromMothershipResponse"), {"response"});
        ...
        static void* getCPtr(::GlobalNamespace::DeleteMothershipTitleDataResponse* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::DeleteMothershipTitleDataResponse* obj) {
