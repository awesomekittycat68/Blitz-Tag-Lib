...
namespace GlobalNamespace {
    struct ServerValidateUsernameCompleteDelegateWrapper_SwigDelegateServerValidateUsernameCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ServerValidateUsernameCompleteDelegateWrapper").GetInnerClass("SwigDelegateServerValidateUsernameCompleteDelegateWrapper_0");
            return clazz;
        }
