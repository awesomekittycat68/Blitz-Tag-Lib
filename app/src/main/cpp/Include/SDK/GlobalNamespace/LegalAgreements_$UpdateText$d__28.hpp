...
namespace GlobalNamespace {
    struct LegalAgreements_$UpdateText$d__28 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "LegalAgreements").GetInnerClass("<UpdateText>d__28");
            return clazz;
        }

        static BNM::MonoType* GetType() { return GetClass().GetMonoType(); }

        ::GlobalNamespace::LegalAgreementTextAsset* GetAsset() {
            static BNM::Field<::GlobalNamespace::LegalAgreementTextAsset*> _field = GetClass().GetField(O("asset"));
        ...
        void SetAsset(::GlobalNamespace::LegalAgreementTextAsset* value) {
            static BNM::Field<::GlobalNamespace::LegalAgreementTextAsset*> _field = GetClass().GetField(O("asset"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
