...
namespace GlobalNamespace {
    struct GetTitleResponse : ::GlobalNamespace::MothershipResponse {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetTitleResponse");
            return clazz;
        }
        ...
        static ::GlobalNamespace::GetTitleResponse* FromMothershipResponse(::GlobalNamespace::MothershipResponse* response) {
            static BNM::Method<::GlobalNamespace::GetTitleResponse*> _m = GetClass().GetMethod(O("FromMothershipResponse"), {"response"});
        ...
        static void* getCPtr(::GlobalNamespace::GetTitleResponse* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::GetTitleResponse* obj) {
