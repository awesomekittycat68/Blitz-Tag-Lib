...
namespace GlobalNamespace {
    struct CreateUserDataMetadataRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateUserDataMetadataRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::CreateUserDataMetadataRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::CreateUserDataMetadataRequest* obj) {
