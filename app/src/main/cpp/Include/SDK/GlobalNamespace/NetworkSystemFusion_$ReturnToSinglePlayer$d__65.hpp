...
namespace GlobalNamespace {
    struct NetworkSystemFusion_$ReturnToSinglePlayer$d__65 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "NetworkSystemFusion").GetInnerClass("<ReturnToSinglePlayer>d__65");
            return clazz;
        }
