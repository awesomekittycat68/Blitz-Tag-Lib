...
namespace GlobalNamespace {
    struct LegalAgreementBodyText_$UpdateTextFromPlayFabTitleData$d__10 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "LegalAgreementBodyText").GetInnerClass("<UpdateTextFromPlayFabTitleData>d__10");
            return clazz;
        }
