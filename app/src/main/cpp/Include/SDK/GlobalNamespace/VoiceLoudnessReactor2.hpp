...
namespace GlobalNamespace {
    struct VoiceLoudnessReactor2 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "VoiceLoudnessReactor2");
            return clazz;
        }
        ...
        float GetSensitivity() {
            static BNM::Field<float> _field = GetClass().GetField(O("sensitivity"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
