...
namespace GlobalNamespace {
    struct ProgressionManager_$$c__DisplayClass121_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ProgressionManager").GetInnerClass("<>c__DisplayClass121_0");
            return clazz;
        }
