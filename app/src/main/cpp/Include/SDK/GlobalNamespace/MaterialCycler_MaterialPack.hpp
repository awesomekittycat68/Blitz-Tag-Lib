...
namespace GlobalNamespace {
    struct MaterialCycler_MaterialPack : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MaterialCycler").GetInnerClass("MaterialPack");
            return clazz;
        }
        ...
        ::BNM::Structures::Mono::Array<::Material*>* GetMaterials_f() {
