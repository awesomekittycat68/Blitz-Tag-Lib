...
namespace GlobalNamespace {
    struct CosmeticsDemoRig_EdSpawnedCosmetic : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CosmeticsDemoRig").GetInnerClass("EdSpawnedCosmetic");
            return clazz;
        }
        ...
        ::GorillaTag_CosmeticSystem::CosmeticSO* GetSo() {
            static BNM::Field<::GorillaTag_CosmeticSystem::CosmeticSO*> _field = GetClass().GetField(O("so"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetSo(::GorillaTag_CosmeticSystem::CosmeticSO* value) {
            static BNM::Field<::GorillaTag_CosmeticSystem::CosmeticSO*> _field = GetClass().GetField(O("so"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
