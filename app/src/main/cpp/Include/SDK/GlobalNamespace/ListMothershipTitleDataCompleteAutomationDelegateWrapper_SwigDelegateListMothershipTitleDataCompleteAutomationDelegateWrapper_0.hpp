...
namespace GlobalNamespace {
    struct ListMothershipTitleDataCompleteAutomationDelegateWrapper_SwigDelegateListMothershipTitleDataCompleteAutomationDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListMothershipTitleDataCompleteAutomationDelegateWrapper").GetInnerClass("SwigDelegateListMothershipTitleDataCompleteAutomationDelegateWrapper_0");
            return clazz;
        }
