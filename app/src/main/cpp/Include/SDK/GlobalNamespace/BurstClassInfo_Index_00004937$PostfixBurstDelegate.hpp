...
namespace GlobalNamespace {
    struct BurstClassInfo_Index_00004937$PostfixBurstDelegate : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "BurstClassInfo").GetInnerClass("Index_00004937$PostfixBurstDelegate");
            return clazz;
        }
