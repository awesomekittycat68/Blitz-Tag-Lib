...
namespace GlobalNamespace {
    struct UserHydratedProgressionTreeResponse : ::GlobalNamespace::MothershipResponse {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UserHydratedProgressionTreeResponse");
            return clazz;
        }
        ...
        ::GlobalNamespace::UserHydratedNodeVector* GetNodes() {
            static BNM::Method<::GlobalNamespace::UserHydratedNodeVector*> _method = GetClass().GetMethod(O("get_Nodes"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _method.Call();
        }
        void SetNodes(::GlobalNamespace::UserHydratedNodeVector* value) {
        ...
        ::GlobalNamespace::UserHydratedProgressionTrackResponse* GetTrack() {
            static BNM::Method<::GlobalNamespace::UserHydratedProgressionTrackResponse*> _method = GetClass().GetMethod(O("get_Track"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _method.Call();
        }
        void SetTrack(::GlobalNamespace::UserHydratedProgressionTrackResponse* value) {
        ...
        static ::GlobalNamespace::UserHydratedProgressionTreeResponse* FromMothershipResponse(::GlobalNamespace::MothershipResponse* response) {
            static BNM::Method<::GlobalNamespace::UserHydratedProgressionTreeResponse*> _m = GetClass().GetMethod(O("FromMothershipResponse"), {"response"});
        ...
        ::GlobalNamespace::UserHydratedNodeVector* get_Nodes() {
            static BNM::Method<::GlobalNamespace::UserHydratedNodeVector*> _m = GetClass().GetMethod(O("get_Nodes"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call();
        }
        ...
        ::GlobalNamespace::UserHydratedProgressionTrackResponse* get_Track() {
            static BNM::Method<::GlobalNamespace::UserHydratedProgressionTrackResponse*> _m = GetClass().GetMethod(O("get_Track"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call();
        }
        ...
        static void* getCPtr(::GlobalNamespace::UserHydratedProgressionTreeResponse* obj) {
        ...
        void set_Nodes(::GlobalNamespace::UserHydratedNodeVector* value) {
        ...
        void set_Track(::GlobalNamespace::UserHydratedProgressionTrackResponse* value) {
        ...
        static void* swigRelease(::GlobalNamespace::UserHydratedProgressionTreeResponse* obj) {
