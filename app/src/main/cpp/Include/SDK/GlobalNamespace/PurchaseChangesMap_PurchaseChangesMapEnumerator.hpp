...
namespace GlobalNamespace {
    struct PurchaseChangesMap_PurchaseChangesMapEnumerator : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "PurchaseChangesMap").GetInnerClass("PurchaseChangesMapEnumerator");
            return clazz;
        }

        static BNM::MonoType* GetType() { return GetClass().GetMonoType(); }

        ::GlobalNamespace::PurchaseChangesMap* GetCollectionRef() {
            static BNM::Field<::GlobalNamespace::PurchaseChangesMap*> _field = GetClass().GetField(O("collectionRef"));
        ...
        void SetCollectionRef(::GlobalNamespace::PurchaseChangesMap* value) {
            static BNM::Field<::GlobalNamespace::PurchaseChangesMap*> _field = GetClass().GetField(O("collectionRef"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
