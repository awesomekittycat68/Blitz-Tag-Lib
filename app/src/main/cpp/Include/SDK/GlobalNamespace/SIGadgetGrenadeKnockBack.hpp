...
#include "SIGadgetGrenadeKnockBack_State.hpp"

namespace GlobalNamespace {
    struct SIGadgetGrenadeKnockBack : ::GlobalNamespace::SIGadgetGrenade {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "SIGadgetGrenadeKnockBack");
            return clazz;
        }
        ...
        ::GlobalNamespace::SIGadgetGrenadeKnockBack_State GetState() {
            static BNM::Field<::GlobalNamespace::SIGadgetGrenadeKnockBack_State> _field = GetClass().GetField(O("state"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetState(::GlobalNamespace::SIGadgetGrenadeKnockBack_State value) {
            static BNM::Field<::GlobalNamespace::SIGadgetGrenadeKnockBack_State> _field = GetClass().GetField(O("state"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        void SetState_1(::GlobalNamespace::SIGadgetGrenadeKnockBack_State newState) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("SetState"), {"newState"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(newState);
        }
        void SetStateAuthority(::GlobalNamespace::SIGadgetGrenadeKnockBack_State newState) {
