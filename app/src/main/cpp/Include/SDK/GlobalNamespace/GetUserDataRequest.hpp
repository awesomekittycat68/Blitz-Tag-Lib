...
namespace GlobalNamespace {
    struct GetUserDataRequest : ::GlobalNamespace::MothershipRequestShared {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetUserDataRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::GetUserDataRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::GetUserDataRequest* obj) {
