...
namespace GlobalNamespace {
    struct GorillaUITransformFollow : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GorillaUITransformFollow");
            return clazz;
        }
        ...
        bool GetDoesMove() {
            static BNM::Field<bool> _field = GetClass().GetField(O("doesMove"));
