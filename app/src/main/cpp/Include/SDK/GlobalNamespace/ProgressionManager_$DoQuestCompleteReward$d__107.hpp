...
namespace GlobalNamespace {
    struct ProgressionManager_$DoQuestCompleteReward$d__107 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ProgressionManager").GetInnerClass("<DoQuestCompleteReward>d__107");
            return clazz;
        }

        static BNM::MonoType* GetType() { return GetClass().GetMonoType(); }

        ::GlobalNamespace::ProgressionManager_SetSIQuestCompleteRequest* GetData() {
            static BNM::Field<::GlobalNamespace::ProgressionManager_SetSIQuestCompleteRequest*> _field = GetClass().GetField(O("data"));
        ...
        void SetData(::GlobalNamespace::ProgressionManager_SetSIQuestCompleteRequest* value) {
            static BNM::Field<::GlobalNamespace::ProgressionManager_SetSIQuestCompleteRequest*> _field = GetClass().GetField(O("data"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
