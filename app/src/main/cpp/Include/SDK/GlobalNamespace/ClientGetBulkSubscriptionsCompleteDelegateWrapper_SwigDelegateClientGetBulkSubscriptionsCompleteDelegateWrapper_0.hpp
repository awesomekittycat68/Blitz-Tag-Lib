...
namespace GlobalNamespace {
    struct ClientGetBulkSubscriptionsCompleteDelegateWrapper_SwigDelegateClientGetBulkSubscriptionsCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ClientGetBulkSubscriptionsCompleteDelegateWrapper").GetInnerClass("SwigDelegateClientGetBulkSubscriptionsCompleteDelegateWrapper_0");
            return clazz;
        }
