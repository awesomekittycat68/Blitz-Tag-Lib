...
namespace GlobalNamespace {
    struct GameEntityManager_ZoneStateRequest : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GameEntityManager").GetInnerClass("ZoneStateRequest");
            return clazz;
        }
