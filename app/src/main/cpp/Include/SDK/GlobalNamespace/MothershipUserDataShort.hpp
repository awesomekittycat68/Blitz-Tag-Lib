...
namespace GlobalNamespace {
    struct MothershipUserDataShort : ::GlobalNamespace::MothershipResponse {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipUserDataShort");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::MothershipUserDataShort* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::MothershipUserDataShort* obj) {
