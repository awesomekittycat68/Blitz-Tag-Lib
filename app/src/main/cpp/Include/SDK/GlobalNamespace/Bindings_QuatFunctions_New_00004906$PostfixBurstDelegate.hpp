...
namespace GlobalNamespace {
    struct Bindings_QuatFunctions_New_00004906$PostfixBurstDelegate : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "Bindings").GetInnerClass("QuatFunctions").GetInnerClass("New_00004906$PostfixBurstDelegate");
            return clazz;
        }
