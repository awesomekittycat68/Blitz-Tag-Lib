...
namespace GlobalNamespace {
    struct KIDManager_$Server_SetConfirmedStatus$d__131 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "KIDManager").GetInnerClass("<Server_SetConfirmedStatus>d__131");
            return clazz;
        }
