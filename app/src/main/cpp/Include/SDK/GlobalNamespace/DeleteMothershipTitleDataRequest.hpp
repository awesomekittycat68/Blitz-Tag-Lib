...
namespace GlobalNamespace {
    struct DeleteMothershipTitleDataRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteMothershipTitleDataRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::DeleteMothershipTitleDataRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::DeleteMothershipTitleDataRequest* obj) {
