...
namespace GlobalNamespace {
    struct CreateTrackLevelCompleteDelegateWrapper_SwigDelegateCreateTrackLevelCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateTrackLevelCompleteDelegateWrapper").GetInnerClass("SwigDelegateCreateTrackLevelCompleteDelegateWrapper_0");
            return clazz;
        }
