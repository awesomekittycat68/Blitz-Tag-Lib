...
namespace GlobalNamespace {
    struct DeleteProgressionTreeCompleteDelegateWrapper_SwigDelegateDeleteProgressionTreeCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteProgressionTreeCompleteDelegateWrapper").GetInnerClass("SwigDelegateDeleteProgressionTreeCompleteDelegateWrapper_0");
            return clazz;
        }
