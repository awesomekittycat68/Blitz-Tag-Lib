...
namespace GlobalNamespace {
    struct DeleteReportRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteReportRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::DeleteReportRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::DeleteReportRequest* obj) {
