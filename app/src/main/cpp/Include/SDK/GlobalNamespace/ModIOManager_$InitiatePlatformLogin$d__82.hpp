...
namespace GlobalNamespace {
    struct ModIOManager_$InitiatePlatformLogin$d__82 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ModIOManager").GetInnerClass("<InitiatePlatformLogin>d__82");
            return clazz;
        }
