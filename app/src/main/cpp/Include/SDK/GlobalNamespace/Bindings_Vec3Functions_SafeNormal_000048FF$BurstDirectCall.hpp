...
namespace GlobalNamespace {
    struct Bindings_Vec3Functions_SafeNormal_000048FF$BurstDirectCall : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "Bindings").GetInnerClass("Vec3Functions").GetInnerClass("SafeNormal_000048FF$BurstDirectCall");
            return clazz;
        }
