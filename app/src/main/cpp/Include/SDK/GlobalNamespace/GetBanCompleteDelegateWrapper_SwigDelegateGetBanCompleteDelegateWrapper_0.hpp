...
namespace GlobalNamespace {
    struct GetBanCompleteDelegateWrapper_SwigDelegateGetBanCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetBanCompleteDelegateWrapper").GetInnerClass("SwigDelegateGetBanCompleteDelegateWrapper_0");
            return clazz;
        }
