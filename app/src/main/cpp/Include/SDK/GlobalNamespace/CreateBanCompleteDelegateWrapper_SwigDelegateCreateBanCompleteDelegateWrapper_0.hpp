...
namespace GlobalNamespace {
    struct CreateBanCompleteDelegateWrapper_SwigDelegateCreateBanCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateBanCompleteDelegateWrapper").GetInnerClass("SwigDelegateCreateBanCompleteDelegateWrapper_0");
            return clazz;
        }
