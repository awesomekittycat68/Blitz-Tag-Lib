...
#include "GRAbilityAttackSwipe_State.hpp"
#include "GRAbilityBase.hpp"

namespace GlobalNamespace {
    struct GRAbilityAttackSwipe : ::GlobalNamespace::GRAbilityBase {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GRAbilityAttackSwipe");
            return clazz;
        }
        ...
        float GetAttackMoveSpeed() {
            static BNM::Field<float> _field = GetClass().GetField(O("attackMoveSpeed"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        float GetCoolDown() {
        ...
        ::GlobalNamespace::GRAbilityAttackSwipe_State GetState() {
            static BNM::Field<::GlobalNamespace::GRAbilityAttackSwipe_State> _field = GetClass().GetField(O("state"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ::Transform* GetTarget() {
        ...
        void SetAttackMoveSpeed(float value) {
            static BNM::Field<float> _field = GetClass().GetField(O("attackMoveSpeed"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        void SetState(::GlobalNamespace::GRAbilityAttackSwipe_State value) {
            static BNM::Field<::GlobalNamespace::GRAbilityAttackSwipe_State> _field = GetClass().GetField(O("state"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
