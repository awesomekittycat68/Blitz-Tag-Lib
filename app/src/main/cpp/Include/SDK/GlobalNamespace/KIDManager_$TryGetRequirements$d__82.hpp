...
namespace GlobalNamespace {
    struct KIDManager_$TryGetRequirements$d__82 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "KIDManager").GetInnerClass("<TryGetRequirements>d__82");
            return clazz;
        }
