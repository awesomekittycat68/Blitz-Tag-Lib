...
namespace GlobalNamespace {
    struct ListProgressionTrackBindingsCompleteDelegateWrapper_SwigDelegateListProgressionTrackBindingsCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListProgressionTrackBindingsCompleteDelegateWrapper").GetInnerClass("SwigDelegateListProgressionTrackBindingsCompleteDelegateWrapper_0");
            return clazz;
        }
