...
namespace GlobalNamespace {
    struct UpdateProgressionTreeNodeCompleteDelegateWrapper_SwigDelegateUpdateProgressionTreeNodeCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateProgressionTreeNodeCompleteDelegateWrapper").GetInnerClass("SwigDelegateUpdateProgressionTreeNodeCompleteDelegateWrapper_0");
            return clazz;
        }
