...
namespace GlobalNamespace {
    struct EyeScannableMono_$RecalculateBoundsLater$d__17 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "EyeScannableMono").GetInnerClass("<RecalculateBoundsLater>d__17");
            return clazz;
        }
