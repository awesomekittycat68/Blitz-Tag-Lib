...
namespace GlobalNamespace {
    struct ListMothershipTitleDataCompleteDelegateWrapper_SwigDelegateListMothershipTitleDataCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListMothershipTitleDataCompleteDelegateWrapper").GetInnerClass("SwigDelegateListMothershipTitleDataCompleteDelegateWrapper_0");
            return clazz;
        }
