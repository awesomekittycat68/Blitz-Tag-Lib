...
namespace GlobalNamespace {
    struct SetPrimaryAccountLinkCompleteDelegateWrapper_SwigDelegateSetPrimaryAccountLinkCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "SetPrimaryAccountLinkCompleteDelegateWrapper").GetInnerClass("SwigDelegateSetPrimaryAccountLinkCompleteDelegateWrapper_0");
            return clazz;
        }
