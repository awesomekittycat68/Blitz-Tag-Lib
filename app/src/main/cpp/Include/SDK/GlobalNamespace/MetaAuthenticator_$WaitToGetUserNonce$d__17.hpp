...
namespace GlobalNamespace {
    struct MetaAuthenticator_$WaitToGetUserNonce$d__17 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MetaAuthenticator").GetInnerClass("<WaitToGetUserNonce>d__17");
            return clazz;
        }
