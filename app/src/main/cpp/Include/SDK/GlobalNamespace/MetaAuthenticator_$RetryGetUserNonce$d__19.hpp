...
namespace GlobalNamespace {
    struct MetaAuthenticator_$RetryGetUserNonce$d__19 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MetaAuthenticator").GetInnerClass("<RetryGetUserNonce>d__19");
            return clazz;
        }
