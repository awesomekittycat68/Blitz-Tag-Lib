...
namespace GlobalNamespace {
    struct ClientGetPermissionsCompleteDelegateWrapper_SwigDelegateClientGetPermissionsCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ClientGetPermissionsCompleteDelegateWrapper").GetInnerClass("SwigDelegateClientGetPermissionsCompleteDelegateWrapper_0");
            return clazz;
        }
