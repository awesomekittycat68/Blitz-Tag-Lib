...
namespace GlobalNamespace {
    struct MetaAuthenticator_$RetryGetDeviceAttestationToken$d__23 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MetaAuthenticator").GetInnerClass("<RetryGetDeviceAttestationToken>d__23");
            return clazz;
        }
