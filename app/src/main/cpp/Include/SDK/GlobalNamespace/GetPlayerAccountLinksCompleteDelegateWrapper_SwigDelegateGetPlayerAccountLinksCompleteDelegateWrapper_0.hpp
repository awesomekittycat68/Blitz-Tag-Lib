...
namespace GlobalNamespace {
    struct GetPlayerAccountLinksCompleteDelegateWrapper_SwigDelegateGetPlayerAccountLinksCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetPlayerAccountLinksCompleteDelegateWrapper").GetInnerClass("SwigDelegateGetPlayerAccountLinksCompleteDelegateWrapper_0");
            return clazz;
        }
