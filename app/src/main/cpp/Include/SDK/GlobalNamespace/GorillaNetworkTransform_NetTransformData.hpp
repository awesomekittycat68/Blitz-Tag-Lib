...
namespace GlobalNamespace {
    struct GorillaNetworkTransform_NetTransformData : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GorillaNetworkTransform").GetInnerClass("NetTransformData");
            return clazz;
        }
        ...
        double GetSentTime() {
            static BNM::Field<double> _field = GetClass().GetField(O("SentTime"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
