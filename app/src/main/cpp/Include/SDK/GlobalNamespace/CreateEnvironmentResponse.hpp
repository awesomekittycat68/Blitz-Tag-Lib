...
namespace GlobalNamespace {
    struct CreateEnvironmentResponse : ::GlobalNamespace::MothershipResponse {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateEnvironmentResponse");
            return clazz;
        }
        ...
        static ::GlobalNamespace::CreateEnvironmentResponse* FromMothershipResponse(::GlobalNamespace::MothershipResponse* response) {
            static BNM::Method<::GlobalNamespace::CreateEnvironmentResponse*> _m = GetClass().GetMethod(O("FromMothershipResponse"), {"response"});
        ...
        static void* getCPtr(::GlobalNamespace::CreateEnvironmentResponse* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::CreateEnvironmentResponse* obj) {
