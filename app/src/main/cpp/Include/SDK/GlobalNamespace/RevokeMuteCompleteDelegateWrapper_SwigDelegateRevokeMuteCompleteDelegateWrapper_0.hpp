...
namespace GlobalNamespace {
    struct RevokeMuteCompleteDelegateWrapper_SwigDelegateRevokeMuteCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "RevokeMuteCompleteDelegateWrapper").GetInnerClass("SwigDelegateRevokeMuteCompleteDelegateWrapper_0");
            return clazz;
        }
