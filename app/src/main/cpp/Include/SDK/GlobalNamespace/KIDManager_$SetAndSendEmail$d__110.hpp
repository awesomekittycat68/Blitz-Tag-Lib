...
namespace GlobalNamespace {
    struct KIDManager_$SetAndSendEmail$d__110 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "KIDManager").GetInnerClass("<SetAndSendEmail>d__110");
            return clazz;
        }
