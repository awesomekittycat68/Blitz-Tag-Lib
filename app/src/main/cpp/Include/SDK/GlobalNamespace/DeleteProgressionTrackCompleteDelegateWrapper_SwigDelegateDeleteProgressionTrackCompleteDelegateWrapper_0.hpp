...
namespace GlobalNamespace {
    struct DeleteProgressionTrackCompleteDelegateWrapper_SwigDelegateDeleteProgressionTrackCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteProgressionTrackCompleteDelegateWrapper").GetInnerClass("SwigDelegateDeleteProgressionTrackCompleteDelegateWrapper_0");
            return clazz;
        }
