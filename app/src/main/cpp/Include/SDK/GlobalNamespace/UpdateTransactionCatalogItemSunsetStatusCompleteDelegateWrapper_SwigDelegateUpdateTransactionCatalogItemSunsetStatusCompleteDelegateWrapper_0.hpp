...
namespace GlobalNamespace {
    struct UpdateTransactionCatalogItemSunsetStatusCompleteDelegateWrapper_SwigDelegateUpdateTransactionCatalogItemSunsetStatusCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateTransactionCatalogItemSunsetStatusCompleteDelegateWrapper").GetInnerClass("SwigDelegateUpdateTransactionCatalogItemSunsetStatusCompleteDelegateWrapper_0");
            return clazz;
        }
