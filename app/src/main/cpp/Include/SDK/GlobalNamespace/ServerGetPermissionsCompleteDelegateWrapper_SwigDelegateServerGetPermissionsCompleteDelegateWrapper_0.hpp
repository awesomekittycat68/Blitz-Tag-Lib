...
namespace GlobalNamespace {
    struct ServerGetPermissionsCompleteDelegateWrapper_SwigDelegateServerGetPermissionsCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ServerGetPermissionsCompleteDelegateWrapper").GetInnerClass("SwigDelegateServerGetPermissionsCompleteDelegateWrapper_0");
            return clazz;
        }
