...
namespace GlobalNamespace {
    struct MothershipUserDataMetadataShort : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipUserDataMetadataShort");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::MothershipUserDataMetadataShort* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::MothershipUserDataMetadataShort* obj) {
