...
namespace GlobalNamespace {
    struct DeleteUserDataRequest : ::GlobalNamespace::MothershipRequestShared {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "DeleteUserDataRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::DeleteUserDataRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::DeleteUserDataRequest* obj) {
