...
namespace GlobalNamespace {
    struct ListAccountAssociationsRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListAccountAssociationsRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::ListAccountAssociationsRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::ListAccountAssociationsRequest* obj) {
