...
namespace GlobalNamespace {
    struct Bindings_Vec3Functions_OneVector_00004904$BurstDirectCall : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "Bindings").GetInnerClass("Vec3Functions").GetInnerClass("OneVector_00004904$BurstDirectCall");
            return clazz;
        }
