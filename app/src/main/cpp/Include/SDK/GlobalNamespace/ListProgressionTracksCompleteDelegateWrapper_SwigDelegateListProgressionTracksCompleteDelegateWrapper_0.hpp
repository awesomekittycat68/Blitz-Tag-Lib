...
namespace GlobalNamespace {
    struct ListProgressionTracksCompleteDelegateWrapper_SwigDelegateListProgressionTracksCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListProgressionTracksCompleteDelegateWrapper").GetInnerClass("SwigDelegateListProgressionTracksCompleteDelegateWrapper_0");
            return clazz;
        }
