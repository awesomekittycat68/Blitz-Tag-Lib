...
namespace GlobalNamespace {
    struct MothershipBoundOfferDisplay : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipBoundOfferDisplay");
            return clazz;
        }
        ...
        ::GlobalNamespace::NormalizedOffersVector* GetOffers() {
            static BNM::Method<::GlobalNamespace::NormalizedOffersVector*> _method = GetClass().GetMethod(O("get_offers"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _method.Call();
        }
        void SetOffers(::GlobalNamespace::NormalizedOffersVector* value) {
            static BNM::Method<void> _method = GetClass().GetMethod(O("set_offers"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _method.Call(value);
        }
        bool GetSwigCMemOwn() {
        ...
        ::GlobalNamespace::NormalizedOffersVector* get_offers() {
            static BNM::Method<::GlobalNamespace::NormalizedOffersVector*> _m = GetClass().GetMethod(O("get_offers"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call();
        }
        static void* getCPtr(::GlobalNamespace::MothershipBoundOfferDisplay* obj) {
        ...
        void set_offers(::GlobalNamespace::NormalizedOffersVector* value) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("set_offers"), {"value"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(value);
        }
        static void* swigRelease(::GlobalNamespace::MothershipBoundOfferDisplay* obj) {
