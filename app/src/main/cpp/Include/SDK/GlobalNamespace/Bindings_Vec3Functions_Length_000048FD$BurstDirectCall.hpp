...
namespace GlobalNamespace {
    struct Bindings_Vec3Functions_Length_000048FD$BurstDirectCall : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "Bindings").GetInnerClass("Vec3Functions").GetInnerClass("Length_000048FD$BurstDirectCall");
            return clazz;
        }
