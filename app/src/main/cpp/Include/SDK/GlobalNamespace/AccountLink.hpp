...
namespace GlobalNamespace {
    struct AccountLink : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "AccountLink");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::AccountLink* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::AccountLink* obj) {
