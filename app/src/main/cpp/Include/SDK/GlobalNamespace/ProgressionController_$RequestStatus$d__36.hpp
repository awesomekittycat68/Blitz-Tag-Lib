...
namespace GlobalNamespace {
    struct ProgressionController_$RequestStatus$d__36 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ProgressionController").GetInnerClass("<RequestStatus>d__36");
            return clazz;
        }
