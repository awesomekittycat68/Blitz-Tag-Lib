...
namespace GlobalNamespace {
    struct UpdateQuestConfigCompleteDelegateWrapper_SwigDelegateUpdateQuestConfigCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateQuestConfigCompleteDelegateWrapper").GetInnerClass("SwigDelegateUpdateQuestConfigCompleteDelegateWrapper_0");
            return clazz;
        }
