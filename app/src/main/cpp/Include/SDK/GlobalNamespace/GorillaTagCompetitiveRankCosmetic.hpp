...
namespace GlobalNamespace {
    struct GorillaTagCompetitiveRankCosmetic : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GorillaTagCompetitiveRankCosmetic");
            return clazz;
        }
        ...
        ::BNM::Structures::Mono::Array<::GameObject*>* GetRankCosmetics() {
            static BNM::Field<::BNM::Structures::Mono::Array<::GameObject*>*> _field = GetClass().GetField(O("rankCosmetics"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        bool GetUsePCELO() {
            static BNM::Field<bool> _field = GetClass().GetField(O("usePCELO"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetRankCosmetics(::BNM::Structures::Mono::Array<::GameObject*>* value) {
            static BNM::Field<::BNM::Structures::Mono::Array<::GameObject*>*> _field = GetClass().GetField(O("rankCosmetics"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        void SetUsePCELO(bool value) {
            static BNM::Field<bool> _field = GetClass().GetField(O("usePCELO"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        ...
        void OnRankedScoreChanged(int questRank, int pcRank) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("OnRankedScoreChanged"), {"questRank", "pcRank"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(questRank, pcRank);
        }
        ...
        void UpdateDisplayedCosmetic(int questRank, int pcRank) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("UpdateDisplayedCosmetic"), {"questRank", "pcRank"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(questRank, pcRank);
        }
    };
