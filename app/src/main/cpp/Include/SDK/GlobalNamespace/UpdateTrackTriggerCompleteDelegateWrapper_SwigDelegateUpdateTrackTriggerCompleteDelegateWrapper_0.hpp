...
namespace GlobalNamespace {
    struct UpdateTrackTriggerCompleteDelegateWrapper_SwigDelegateUpdateTrackTriggerCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateTrackTriggerCompleteDelegateWrapper").GetInnerClass("SwigDelegateUpdateTrackTriggerCompleteDelegateWrapper_0");
            return clazz;
        }
