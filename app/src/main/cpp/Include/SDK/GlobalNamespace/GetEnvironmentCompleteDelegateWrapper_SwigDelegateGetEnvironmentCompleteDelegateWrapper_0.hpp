...
namespace GlobalNamespace {
    struct GetEnvironmentCompleteDelegateWrapper_SwigDelegateGetEnvironmentCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GetEnvironmentCompleteDelegateWrapper").GetInnerClass("SwigDelegateGetEnvironmentCompleteDelegateWrapper_0");
            return clazz;
        }
