...
namespace GlobalNamespace {
    struct ModIOManager_$GetOculusUserProof$d__87 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ModIOManager").GetInnerClass("<GetOculusUserProof>d__87");
            return clazz;
        }
