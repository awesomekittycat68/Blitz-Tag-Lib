...
namespace GlobalNamespace {
    struct TextureFromURL_$LoadFromTitleData$d__7 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "TextureFromURL").GetInnerClass("<LoadFromTitleData>d__7");
            return clazz;
        }
