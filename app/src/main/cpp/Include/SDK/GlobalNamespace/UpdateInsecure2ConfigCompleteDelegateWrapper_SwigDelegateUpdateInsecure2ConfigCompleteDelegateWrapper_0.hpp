...
namespace GlobalNamespace {
    struct UpdateInsecure2ConfigCompleteDelegateWrapper_SwigDelegateUpdateInsecure2ConfigCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateInsecure2ConfigCompleteDelegateWrapper").GetInnerClass("SwigDelegateUpdateInsecure2ConfigCompleteDelegateWrapper_0");
            return clazz;
        }
