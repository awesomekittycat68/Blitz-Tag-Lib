...
namespace GlobalNamespace {
    struct ProgressionManager_$DoIncrementSIResource$d__106 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ProgressionManager").GetInnerClass("<DoIncrementSIResource>d__106");
            return clazz;
        }
