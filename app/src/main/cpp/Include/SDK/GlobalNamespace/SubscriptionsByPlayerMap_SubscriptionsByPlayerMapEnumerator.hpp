...
namespace GlobalNamespace {
    struct SubscriptionsByPlayerMap_SubscriptionsByPlayerMapEnumerator : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "SubscriptionsByPlayerMap").GetInnerClass("SubscriptionsByPlayerMapEnumerator");
            return clazz;
        }

        static BNM::MonoType* GetType() { return GetClass().GetMonoType(); }

        ::GlobalNamespace::SubscriptionsByPlayerMap* GetCollectionRef() {
            static BNM::Field<::GlobalNamespace::SubscriptionsByPlayerMap*> _field = GetClass().GetField(O("collectionRef"));
        ...
        void SetCollectionRef(::GlobalNamespace::SubscriptionsByPlayerMap* value) {
            static BNM::Field<::GlobalNamespace::SubscriptionsByPlayerMap*> _field = GetClass().GetField(O("collectionRef"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
