...
namespace GlobalNamespace {
    struct KIDManager_OnEmailResultReceived : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "KIDManager").GetInnerClass("OnEmailResultReceived");
            return clazz;
        }
        ...
        void* BeginInvoke(bool result, ::BNM::IL2CPP::Il2CppObject* callback, TP2 object) {
