...
namespace GlobalNamespace {
    struct UpdateRiftConfigRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateRiftConfigRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::UpdateRiftConfigRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::UpdateRiftConfigRequest* obj) {
