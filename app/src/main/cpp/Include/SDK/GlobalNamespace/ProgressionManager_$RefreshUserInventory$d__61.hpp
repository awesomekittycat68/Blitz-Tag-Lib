...
namespace GlobalNamespace {
    struct ProgressionManager_$RefreshUserInventory$d__61 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ProgressionManager").GetInnerClass("<RefreshUserInventory>d__61");
            return clazz;
        }
