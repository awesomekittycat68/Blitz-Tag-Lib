...
namespace GlobalNamespace {
    struct ListUserDataRequest : ::GlobalNamespace::MothershipRequestShared {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListUserDataRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::ListUserDataRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::ListUserDataRequest* obj) {
