...
namespace GlobalNamespace {
    struct GorillaBodyPhysics : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GorillaBodyPhysics");
            return clazz;
        }

        static BNM::MonoType* GetType() { return GetClass().GetMonoType(); }

        ::GameObject* GetBodyCollider() {
            static BNM::Field<::GameObject*> _field = GetClass().GetField(O("bodyCollider"));
        ...
        void SetBodyCollider(::GameObject* value) {
            static BNM::Field<::GameObject*> _field = GetClass().GetField(O("bodyCollider"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
