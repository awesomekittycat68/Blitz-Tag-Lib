...
namespace GlobalNamespace {
    struct RevokeBanCompleteDelegateWrapper_SwigDelegateRevokeBanCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "RevokeBanCompleteDelegateWrapper").GetInnerClass("SwigDelegateRevokeBanCompleteDelegateWrapper_0");
            return clazz;
        }
