...
namespace GlobalNamespace {
    template <typename T>
    struct RandomComponent$1 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "RandomComponent`1");
            return clazz;
        }
        ...
        void* GetOnNextItem() {
            static BNM::Field<void*> _field = GetClass().GetField(O("onNextItem"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        int GetSeed_f() {
