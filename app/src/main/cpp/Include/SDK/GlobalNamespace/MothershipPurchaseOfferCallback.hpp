...
#include "PurchaseOfferRequestCompleteDelegateWrapper.hpp"

namespace GlobalNamespace {
    struct MothershipPurchaseOfferCallback : ::GlobalNamespace::PurchaseOfferRequestCompleteDelegateWrapper {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "MothershipPurchaseOfferCallback");
            return clazz;
        }
