...
namespace GlobalNamespace {
    struct KIDManager_$WaitForAndUpdateNewSession$d__168 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "KIDManager").GetInnerClass("<WaitForAndUpdateNewSession>d__168");
            return clazz;
        }
