...
namespace GlobalNamespace {
    struct ModIOManager_$HasAcceptedLatestTerms$d__45 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ModIOManager").GetInnerClass("<HasAcceptedLatestTerms>d__45");
            return clazz;
        }
