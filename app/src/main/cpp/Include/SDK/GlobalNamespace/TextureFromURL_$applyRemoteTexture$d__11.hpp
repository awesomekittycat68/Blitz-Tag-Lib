...
namespace GlobalNamespace {
    struct TextureFromURL_$applyRemoteTexture$d__11 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "TextureFromURL").GetInnerClass("<applyRemoteTexture>d__11");
            return clazz;
        }
        ...
        void SetImageUrl(::BNM::Structures::Mono::String* value) {
            static BNM::Field<::BNM::Structures::Mono::String*> _field = GetClass().GetField(O("imageUrl"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
