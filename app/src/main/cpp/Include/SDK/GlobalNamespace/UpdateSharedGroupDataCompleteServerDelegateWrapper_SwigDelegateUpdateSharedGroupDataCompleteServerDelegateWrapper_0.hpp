...
namespace GlobalNamespace {
    struct UpdateSharedGroupDataCompleteServerDelegateWrapper_SwigDelegateUpdateSharedGroupDataCompleteServerDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateSharedGroupDataCompleteServerDelegateWrapper").GetInnerClass("SwigDelegateUpdateSharedGroupDataCompleteServerDelegateWrapper_0");
            return clazz;
        }
