...
namespace GlobalNamespace {
    struct UpdateProgressionTrackBindingsCompleteDelegateWrapper_SwigDelegateUpdateProgressionTrackBindingsCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UpdateProgressionTrackBindingsCompleteDelegateWrapper").GetInnerClass("SwigDelegateUpdateProgressionTrackBindingsCompleteDelegateWrapper_0");
            return clazz;
        }
