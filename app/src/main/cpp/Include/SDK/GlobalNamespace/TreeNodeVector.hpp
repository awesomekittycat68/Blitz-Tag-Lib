...
namespace GlobalNamespace {
    struct TreeNodeVector : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "TreeNodeVector");
            return clazz;
        }
        ...
        ::GlobalNamespace::TreeNodeDefinition* GetItem() {
            static BNM::Method<::GlobalNamespace::TreeNodeDefinition*> _method = GetClass().GetMethod(O("get_Item"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _method.Call();
        }
        void SetItem(::GlobalNamespace::TreeNodeDefinition* value) {
        ...
        void Add(::GlobalNamespace::TreeNodeDefinition* x) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("Add"), {"x"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(x);
        }
        void AddRange(::GlobalNamespace::TreeNodeVector* values) {
        ...
        void CopyTo(::BNM::Structures::Mono::Array<::GlobalNamespace::TreeNodeDefinition*>* array) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("CopyTo"), {"array"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(array);
        }
        void CopyTo(::BNM::Structures::Mono::Array<::GlobalNamespace::TreeNodeDefinition*>* array, int arrayIndex) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("CopyTo"), {"array", "arrayIndex"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(array, arrayIndex);
        }
        void CopyTo(int index, ::BNM::Structures::Mono::Array<::GlobalNamespace::TreeNodeDefinition*>* array, int arrayIndex, int count) {
        ...
        ::GlobalNamespace::TreeNodeDefinition* get_Item(int index) {
            static BNM::Method<::GlobalNamespace::TreeNodeDefinition*> _m = GetClass().GetMethod(O("get_Item"), {"index"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call(index);
        }
        static void* getCPtr(::GlobalNamespace::TreeNodeVector* obj) {
            static BNM::Method<void*> _m = GetClass().GetMethod(O("getCPtr"), {"obj"});
            return _m.Call(obj);
        }
        ::GlobalNamespace::TreeNodeVector_TreeNodeVectorEnumerator* GetEnumerator() {
            static BNM::Method<::GlobalNamespace::TreeNodeVector_TreeNodeVectorEnumerator*> _m = GetClass().GetMethod(O("GetEnumerator"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call();
        }
        ::GlobalNamespace::TreeNodeDefinition* getitem(int index) {
            static BNM::Method<::GlobalNamespace::TreeNodeDefinition*> _m = GetClass().GetMethod(O("getitem"), {"index"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call(index);
        }
        ::GlobalNamespace::TreeNodeDefinition* getitemcopy(int index) {
            static BNM::Method<::GlobalNamespace::TreeNodeDefinition*> _m = GetClass().GetMethod(O("getitemcopy"), {"index"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call(index);
        }
        ::GlobalNamespace::TreeNodeVector* GetRange(int index, int count) {
            static BNM::Method<::GlobalNamespace::TreeNodeVector*> _m = GetClass().GetMethod(O("GetRange"), {"index", "count"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call(index, count);
        }
        void Insert(int index, ::GlobalNamespace::TreeNodeDefinition* x) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("Insert"), {"index", "x"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(index, x);
        }
        void InsertRange(int index, ::GlobalNamespace::TreeNodeVector* values) {
        ...
        static ::GlobalNamespace::TreeNodeVector* Repeat(::GlobalNamespace::TreeNodeDefinition* value, int count) {
            static BNM::Method<::GlobalNamespace::TreeNodeVector*> _m = GetClass().GetMethod(O("Repeat"), {"value", "count"});
        ...
        void set_Item(int index, ::GlobalNamespace::TreeNodeDefinition* value) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("set_Item"), {"index", "value"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(index, value);
        }
        void setitem(int index, ::GlobalNamespace::TreeNodeDefinition* val) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("setitem"), {"index", "val"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(index, val);
        }
        void SetRange(int index, ::GlobalNamespace::TreeNodeVector* values) {
        ...
        static void* swigRelease(::GlobalNamespace::TreeNodeVector* obj) {
            static BNM::Method<void*> _m = GetClass().GetMethod(O("swigRelease"), {"obj"});
            return _m.Call(obj);
        }
        ::BNM::Structures::Mono::Array<::GlobalNamespace::TreeNodeDefinition*>* ToArray() {
            static BNM::Method<::BNM::Structures::Mono::Array<::GlobalNamespace::TreeNodeDefinition*>*> _m = GetClass().GetMethod(O("ToArray"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call();
        }
    };
