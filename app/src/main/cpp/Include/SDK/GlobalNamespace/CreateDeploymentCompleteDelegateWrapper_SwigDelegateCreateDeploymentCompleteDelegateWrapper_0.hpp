...
namespace GlobalNamespace {
    struct CreateDeploymentCompleteDelegateWrapper_SwigDelegateCreateDeploymentCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateDeploymentCompleteDelegateWrapper").GetInnerClass("SwigDelegateCreateDeploymentCompleteDelegateWrapper_0");
            return clazz;
        }
