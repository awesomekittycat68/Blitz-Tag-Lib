...
namespace GlobalNamespace {
    struct TransformViewTeleportSerializer : ::GlobalNamespace::NetworkComponent {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "TransformViewTeleportSerializer");
            return clazz;
        }
        ...
        ::GlobalNamespace::GorillaNetworkTransform* GetTransformView() {
            static BNM::Field<::GlobalNamespace::GorillaNetworkTransform*> _field = GetClass().GetField(O("transformView"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        bool GetWillTeleport() {
            static BNM::Field<bool> _field = GetClass().GetField(O("willTeleport"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        ...
        void SetTransformView(::GlobalNamespace::GorillaNetworkTransform* value) {
            static BNM::Field<::GlobalNamespace::GorillaNetworkTransform*> _field = GetClass().GetField(O("transformView"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
        void SetWillTeleport(bool value) {
            static BNM::Field<bool> _field = GetClass().GetField(O("willTeleport"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
