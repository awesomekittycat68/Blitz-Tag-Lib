...
namespace GlobalNamespace {
    struct ModIOManager_$ContinuePlatformLogin$d__83 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ModIOManager").GetInnerClass("<ContinuePlatformLogin>d__83");
            return clazz;
        }
