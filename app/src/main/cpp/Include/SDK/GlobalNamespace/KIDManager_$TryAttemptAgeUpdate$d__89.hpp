...
namespace GlobalNamespace {
    struct KIDManager_$TryAttemptAgeUpdate$d__89 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "KIDManager").GetInnerClass("<TryAttemptAgeUpdate>d__89");
            return clazz;
        }
