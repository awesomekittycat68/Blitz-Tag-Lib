...
namespace GlobalNamespace {
    struct UserInventoryMap_UserInventoryMapEnumerator : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UserInventoryMap").GetInnerClass("UserInventoryMapEnumerator");
            return clazz;
        }

        static BNM::MonoType* GetType() { return GetClass().GetMonoType(); }

        ::GlobalNamespace::UserInventoryMap* GetCollectionRef() {
            static BNM::Field<::GlobalNamespace::UserInventoryMap*> _field = GetClass().GetField(O("collectionRef"));
        ...
        void SetCollectionRef(::GlobalNamespace::UserInventoryMap* value) {
            static BNM::Field<::GlobalNamespace::UserInventoryMap*> _field = GetClass().GetField(O("collectionRef"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _field.Set(value);
        }
