...
namespace GlobalNamespace {
    struct CreateProgressionTrackRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "CreateProgressionTrackRequest");
            return clazz;
        }
        ...
        int GetMaximum() {
            static BNM::Method<int> _method = GetClass().GetMethod(O("get_maximum"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _method.Call();
        }
        void SetMaximum(int value) {
            static BNM::Method<void> _method = GetClass().GetMethod(O("set_maximum"));
            _method.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _method.Call(value);
        }
        ...
        int get_maximum() {
            static BNM::Method<int> _m = GetClass().GetMethod(O("get_maximum"));
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _m.Call();
        }
        ...
        static void* getCPtr(::GlobalNamespace::CreateProgressionTrackRequest* obj) {
        ...
        void set_maximum(int value) {
            static BNM::Method<void> _m = GetClass().GetMethod(O("set_maximum"), {"value"});
            _m.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            _m.Call(value);
        }
        ...
        static void* swigRelease(::GlobalNamespace::CreateProgressionTrackRequest* obj) {
