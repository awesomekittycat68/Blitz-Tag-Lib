...
namespace GlobalNamespace {
    struct KIDUI_ConfirmScreen_$ShowErrorScreen$d__19 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "KIDUI_ConfirmScreen").GetInnerClass("<ShowErrorScreen>d__19");
            return clazz;
        }
