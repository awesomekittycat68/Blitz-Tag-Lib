...
namespace GlobalNamespace {
    struct KIDAgeGate_$ProcessAgeGateConfirmation$d__35 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "KIDAgeGate").GetInnerClass("<ProcessAgeGateConfirmation>d__35");
            return clazz;
        }
