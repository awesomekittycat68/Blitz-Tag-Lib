...
namespace GlobalNamespace {
    struct UGCPermissionManager_PlayFabPermissions : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "UGCPermissionManager").GetInnerClass("PlayFabPermissions");
            return clazz;
        }
