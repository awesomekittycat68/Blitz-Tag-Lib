...
namespace GlobalNamespace {
    struct ProgressionTrack : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ProgressionTrack");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::ProgressionTrack* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::ProgressionTrack* obj) {
