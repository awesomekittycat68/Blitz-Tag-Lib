...
namespace GlobalNamespace {
    struct ListReportsCompleteDelegateWrapper_SwigDelegateListReportsCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListReportsCompleteDelegateWrapper").GetInnerClass("SwigDelegateListReportsCompleteDelegateWrapper_0");
            return clazz;
        }
