...
namespace GlobalNamespace {
    struct PlayerSteamBeginLoginResponseCompleteDelegateWrapper_SwigDelegatePlayerSteamBeginLoginResponseCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "PlayerSteamBeginLoginResponseCompleteDelegateWrapper").GetInnerClass("SwigDelegatePlayerSteamBeginLoginResponseCompleteDelegateWrapper_0");
            return clazz;
        }
