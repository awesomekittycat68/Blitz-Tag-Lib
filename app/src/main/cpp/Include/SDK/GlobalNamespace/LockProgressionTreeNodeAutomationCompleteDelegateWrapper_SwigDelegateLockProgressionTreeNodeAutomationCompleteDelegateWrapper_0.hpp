...
namespace GlobalNamespace {
    struct LockProgressionTreeNodeAutomationCompleteDelegateWrapper_SwigDelegateLockProgressionTreeNodeAutomationCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "LockProgressionTreeNodeAutomationCompleteDelegateWrapper").GetInnerClass("SwigDelegateLockProgressionTreeNodeAutomationCompleteDelegateWrapper_0");
            return clazz;
        }
