...
namespace GlobalNamespace {
    struct ProgressionManager_$PurchaseResources$d__75 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ProgressionManager").GetInnerClass("<PurchaseResources>d__75");
            return clazz;
        }
