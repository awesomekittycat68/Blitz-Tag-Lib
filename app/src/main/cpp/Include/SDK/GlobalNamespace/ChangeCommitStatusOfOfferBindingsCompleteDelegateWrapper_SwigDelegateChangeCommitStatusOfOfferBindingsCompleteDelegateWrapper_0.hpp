...
namespace GlobalNamespace {
    struct ChangeCommitStatusOfOfferBindingsCompleteDelegateWrapper_SwigDelegateChangeCommitStatusOfOfferBindingsCompleteDelegateWrapper_0 : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ChangeCommitStatusOfOfferBindingsCompleteDelegateWrapper").GetInnerClass("SwigDelegateChangeCommitStatusOfOfferBindingsCompleteDelegateWrapper_0");
            return clazz;
        }
