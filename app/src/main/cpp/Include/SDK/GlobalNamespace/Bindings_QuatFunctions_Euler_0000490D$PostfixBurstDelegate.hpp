...
namespace GlobalNamespace {
    struct Bindings_QuatFunctions_Euler_0000490D$PostfixBurstDelegate : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "Bindings").GetInnerClass("QuatFunctions").GetInnerClass("Euler_0000490D$PostfixBurstDelegate");
            return clazz;
        }
