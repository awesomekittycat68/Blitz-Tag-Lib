...
namespace GlobalNamespace {
    struct GameNoiseEvent : BNM::UnityEngine::MonoBehaviour {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "GameNoiseEvent");
            return clazz;
        }
        ...
        double GetEventTime() {
            static BNM::Field<double> _field = GetClass().GetField(O("eventTime"));
            _field.SetInstance(reinterpret_cast<::BNM::IL2CPP::Il2CppObject*>(this));
            return _field.Get();
        }
        float GetMagnitude() {
