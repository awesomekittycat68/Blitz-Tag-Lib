...
namespace GlobalNamespace {
    struct ListBansBulkRequest : ::GlobalNamespace::MothershipRequest {
    public:
        static BNM::Class GetClass() {
            static BNM::Class clazz = ::BNM::Class("", "ListBansBulkRequest");
            return clazz;
        }
        ...
        static void* getCPtr(::GlobalNamespace::ListBansBulkRequest* obj) {
        ...
        static void* swigRelease(::GlobalNamespace::ListBansBulkRequest* obj) {
