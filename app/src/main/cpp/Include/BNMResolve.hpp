...
struct Time{
    ...
    static float GetSmoothDeltaTime(){
        static auto get_smoothDeltaTime = (float(*)())GetExternMethod("UnityEngine.Time::get_smoothDeltaTime");
        if (get_smoothDeltaTime) return get_smoothDeltaTime();
        static Method<float> get_smoothDeltaTime_m = GetClass().GetMethod("get_smoothDeltaTime");
        return get_smoothDeltaTime_m();
    }
